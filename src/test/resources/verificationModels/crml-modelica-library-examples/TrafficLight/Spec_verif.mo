model Spec_verif
  ...
  Modelica.Blocks.Interfaces.BooleanOutput red annotation(
    Placement(transformation(origin = {-72, 60}, extent = {{10, -10}, {-10, 10}}, rotation = -0), iconTransformation(origin = {-68, 58}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interfaces.BooleanOutput yellow annotation(
    Placement(transformation(origin = {-72, 40}, extent = {{10, -10}, {-10, 10}}), iconTransformation(origin = {-58, 68}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interfaces.BooleanOutput green annotation(
    Placement(transformation(origin = {-72, 20}, extent = {{10, -10}, {-10, 10}}), iconTransformation(origin = {-48, 78}, extent = {{-10, -10}, {10, 10}})));
  Spec spec annotation(
    Placement(transformation(origin = {-110, 40}, extent = {{13, -10}, {-13, 10}}, rotation = -0)));
equation
  // Bindings
  spec.red = red;
  spec.green = green;
