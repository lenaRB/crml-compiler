...
model RemoveClient
  ...
  ThermoSysPro.InstrumentationAndControl.Connectors.OutputReal outputReal annotation (
    Placement(transformation(origin = {108, -2}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {108, -2}, extent = {{-10, -10}, {10, 10}})));
  ThermoSysPro.InstrumentationAndControl.Blocks.Math.Add add(k2 = -1)  annotation (
...
annotation (
    Icon(graphics={  Rectangle(extent = {{-100, 100}, {100, -100}},
          ...
          fillPattern=FillPattern.Solid),                            Text(origin = {-4, 126}, extent = {{-114, 30}, {114, -30}}, textString = "%name")}));
end RemoveClient;
