...
model change_Psf
  ...
  parameter Real delta=1e5 "différence de pression (de la source froide) à appliquer (en Pascal)";
...
equation
  ...
  connect(add.u2, rampe.y) annotation (Line(points={{-19,-14},{-34,-14},{-34,-30},
          {-49,-30}}, color={0,0,255}));
  connect(add.y, outputReal) annotation (Line(points={{3,-8},{92,-8},{92,-2},{108,
          -2}}, color={0,0,255}));
annotation (
