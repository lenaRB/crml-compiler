...
model TwoTanksDesign
  ...
  TwoTanksExample.Design.Components.Tank tank1(area = 1)  annotation(
    Placement(visible = true, transformation(origin = {-25, 21}, extent = {{-29, -29}, {29, 29}}, rotation = 0)));    TwoTanksExample.Design.Components.Tank tank2(area = 1.3)  annotation(
   Placement(visible = true, transformation(origin = {47, 21}, extent = {{-29, -29}, {29, 29}}, rotation = 0)));
  TwoTanksExample.Design.Components.PIContinuousController pIContinuousController1(K = 4, T = 10)  annotation(
    Placement(visible = true, transformation(origin = {-24, -50}, extent = {{22, -22}, {-22, 22}}, rotation = 0)));
  TwoTanksExample.Design.Components.PIContinuousController pIContinuousController2(ref = 0.8) annotation(
   Placement(visible = true, transformation(origin = {49, -51}, extent = {{25, -25}, {-25, 25}}, rotation = 0))); TwoTanksExample.Design.Components.Source source annotation(
