...
<dd>email: <a href=\"mailto:yulu.dong@edf.fr\">yulu.dong@edf.fr</a><br></dd>
    ...
    annotation (Icon(graphics={
          ...
          Ellipse(origin={1.5,56.5},
            ...
            pattern=LinePattern.None,
            fillPattern=FillPattern.Solid,
            extent={{-12.5,-12.5},{12.5,12.5}})}), DocumentationClass=true, Documentation(info="<html>
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block can be used as the mastertime  period of all <a href=\"modelica://CRML.ETL.TimeLocators.Periods\">Periods</a> blocks within a given model by just dragging and dropping the block into the model. Only one master block per model is allowed.</span></p>
      ...
      public
        ETL.Connectors.WhileOutput y "Vector of time periods" annotation (Placement(
              transformation(
              extent={{-10,-10},{10,10}},
              rotation=-90,
      ...
      public
        ...
        ETL.TimeLocators.While While(leftBoundaryIncluded=leftBoundaryIncluded,
            rightBoundaryIncluded=rightBoundaryIncluded)
      ...
      equation
        ...
        connect(u, While.u)
          annotation (Line(points={{-110,0},{-11,0}}, color={162,29,33}));
        connect(tl1, While.tl)
...
<p><span style=\"font-family: MS Shell Dlg 2;\">The <a href=\"modelica://CRML.TimeLocators.Continuous.Master\">Master</a> block can be used to specify the same master period to all time periods of the same model.</span></p>
      ...
      public
        ETL.Connectors.Boolean4Input u1 "Opening event"
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
      ...
      public
        ...
        ETL.TimeLocators.Periods periods(
          ...
          annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
        Blocks.Logical4.Boolean4Constant boolean4Constant(K=CRML.ETL.Types.Boolean4.false4)
      ...
      equation
        ...
        connect(u1, periods.u1)
          annotation (Line(points={{-110,0},{-11,0}}, color={162,29,33}));
        connect(tl1, periods.tl)
          annotation (Line(points={{0,100},{0,10}}, color={0,0,255}));
        connect(periods.y, y)
          annotation (Line(points={{0,-10},{0,-100}}, color={0,0,255}));
        connect(boolean4Constant.y, periods.u2) annotation (Line(points={{-39,-30},{-20,
                -30},{-20,-8},{-11,-8}}, color={162,29,33}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              ...
              Text(
                ...
                fillColor={215,215,215},
                fillPattern=FillPattern.Solid,
                textString="after")}),        Diagram(coordinateSystem(
                preserveAspectRatio=false)));
      end After;
      ...
      equation
        ...
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              ...
              Text(
                ...
                fillColor={215,215,215},
                fillPattern=FillPattern.Solid,
                textString="from")}),         Diagram(coordinateSystem(
                preserveAspectRatio=false)));
      end From;
      ...
      equation
        ...
        connect(periods.y, y)
          annotation (Line(points={{0,-10},{0,-100}}, color={0,0,255}));
        connect(u1, periods.u2) annotation (Line(points={{-110,0},{-40,0},{-40,-8},{-11,
                -8}}, color={162,29,33}));
        connect(boolean4Constant.y, periods.u1) annotation (Line(points={{-39,30},{-24,
                30},{-24,0},{-11,0}}, color={162,29,33}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
                fillColor={85,170,255},
              ...
              Text(
                ...
                fillColor={215,215,215},
                fillPattern=FillPattern.Solid,
                textString="before")}),       Diagram(coordinateSystem(
                preserveAspectRatio=false)));
      end Before;
      ...
      equation
        ...
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              ...
              Text(
                ...
                fillColor={215,215,215},
                fillPattern=FillPattern.Solid,
                textString="until")}),        Diagram(coordinateSystem(
                preserveAspectRatio=false)));
      end Until;
      ...
      equation
        ...
        connect(u1, periods.u1)
          annotation (Line(points={{-110,0},{-11,0}}, color={162,29,33}));
        connect(u2, periods.u2) annotation (Line(points={{-110,-80},{-60,-80},{-60,-8},
                {-11,-8}}, color={162,29,33}));
        connect(tl1, periods.tl)
          annotation (Line(points={{0,100},{0,10}}, color={0,0,255}));
        connect(periods.y, y)
          annotation (Line(points={{0,-10},{0,-100}}, color={0,0,255}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              ...
              Text(
                ...
                fillColor={215,215,215},
                fillPattern=FillPattern.Solid,
                textString="after before")}), Diagram(coordinateSystem(
                preserveAspectRatio=false)));
      end AfterBefore;
      ...
      equation
        ...
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              ...
              Text(
                ...
                fillColor={215,215,215},
                fillPattern=FillPattern.Solid,
                textString="after until")}),  Diagram(coordinateSystem(
                preserveAspectRatio=false)));
      end AfterUntil;
      ...
      public
        ETL.Connectors.Boolean4Input u "Opening event"
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
        ETL.Connectors.WhileInput tl "Master time period"
          annotation (Placement(transformation(extent={{-10,90},{10,110}})));
      ...
      equation
        ...
        connect(u, periods.u1)
          annotation (Line(points={{-110,0},{-11,0}}, color={162,29,33}));
        connect(tl1, periods.tl)
          annotation (Line(points={{0,100},{0,10}}, color={0,0,255}));
        connect(periods.y, y)
          annotation (Line(points={{0,-10},{0,-100}}, color={0,0,255}));
        connect(duration, periods.continuousDuration) annotation (Line(points={{-110,-80},
                {-60,-80},{-60,-8},{-11,-8}}, color={0,0,0}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
                fillColor={85,170,255},
              ...
              Text(
                ...
                fillColor={215,215,215},
                fillPattern=FillPattern.Solid,
                textString="after for")}),    Diagram(coordinateSystem(
                preserveAspectRatio=false)));
      end AfterFor;
      ...
      equation
        ...
        connect(periods.y, y)
          annotation (Line(points={{0,-10},{0,-100}}, color={0,0,255}));
        connect(not4_1.y, periods.u2) annotation (Line(points={{-39,-30},{-20,-30},{-20,
                -8},{-11,-8}}, color={162,29,33}));
        connect(u, not4_1.u) annotation (Line(points={{-110,0},{-80,0},{-80,-30},{-61,
                -30}}, color={162,29,33}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
      ...
      equation
        ...
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              ...
              Text(
                ...
                fillColor={215,215,215},
                fillPattern=FillPattern.Solid,
                textString="from before")}),  Diagram(coordinateSystem(
                preserveAspectRatio=false)));
      end FromBefore;
      ...
      equation
        ...
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              ...
              Text(
                ...
                fillColor={215,215,215},
                fillPattern=FillPattern.Solid,
                textString="from until")}),   Diagram(coordinateSystem(
                preserveAspectRatio=false)));
      end FromUntil;
      ...
      equation
        ...
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              ...
              Text(
                ...
                fillColor={215,215,215},
                fillPattern=FillPattern.Solid,
                textString="from for")}),     Diagram(coordinateSystem(
                preserveAspectRatio=false)));
      end FromFor;
      ...
      equation
        ...
        connect(periods.y, y)
          annotation (Line(points={{0,-10},{0,-100}}, color={0,0,255}));
        connect(u, periods.u2) annotation (Line(points={{-110,0},{-40,0},{-40,-8},{-11,
                -8}}, color={162,29,33}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
      ...
      annotation (Icon(graphics={
            ...
            Rectangle(
              ...
              extent={{-100,-100},{100,100}},
              radius=25.0),
            Line(points={{-80,0},{-50,0},{-50,46},{50,46},{50,0},{80,0}},
                color={0,0,0})}));
    end Continuous;
    ...
    package Discrete
      ...
      public
        ...
        ETL.TimeLocators.Periods periods(
          ...
          annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
        ETL.Connectors.Boolean4Input clock annotation (Placement(transformation(
                extent={{-120,70},{-100,90}}), iconTransformation(extent={{-120,70},{-100,
                  90}})));
        ETL.Connectors.IntegerInput duration annotation (Placement(transformation(
                extent={{-120,-90},{-100,-70}}), iconTransformation(extent={{-120,-90},
                  {-100,-70}})));
      equation
        if (cardinality(tl) == 0) then
          tl.timePeriod = true;
        ...
        connect(periods.y, y)
          annotation (Line(points={{0,-10},{0,-100}}, color={0,0,255}));
        connect(clock, periods.clock) annotation (Line(points={{-110,80},{-60,80},{-60,
                8},{-11,8}}, color={162,29,33}));
        connect(duration, periods.discreteDuration) annotation (Line(points={{-110,-80},
                {-60,-80},{-60,-8},{-11,-8}}, color={255,127,0}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
                fillColor={85,170,255},
      ...
      annotation (Icon(graphics={
            ...
            Rectangle(
              ...
              extent={{-100,-100},{100,100}},
              radius=25.0),
            Line(points={{-30,46},{-30,0}}, color={0,0,0}),
            Line(points={{0,46},{0,0}},   color={0,0,0}),
            Line(points={{30,46},{30,0}}, color={0,0,0}),
            Line(points={{-80,0},{-50,0},{-50,46},{50,46},{50,0},{80,0}},
                color={0,0,0})}));
    end Discrete;
    annotation (Icon(graphics={
          ...
          Rectangle(
            ...
            extent={{-100,-100},{100,100}},
            radius=25.0),
          Line(points={{-80,-66},{-50,-66},{-50,-20},{50,-20},{50,-66},{80,-66}},
              color={0,0,0}),
          Text(
            extent={{28,68},{74,6}},
            lineColor={0,0,0},
  ...
  package Requirements
    ...
    public
      ETL.Connectors.Boolean4Input u "Boolean4 condition" annotation (Placement(
            transformation(extent={{-120,-10},{-100,10}}), iconTransformation(
              extent={{-120,-10},{-100,10}})));
      ETL.Connectors.TimeLocatorInput[N] tl annotation (Placement(
            transformation(extent={{-10,90},{10,110}}), iconTransformation(
              extent={{-10,90},{10,110}})));
      ETL.Connectors.Boolean4Output y "Result of the comparison"
        annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      ETL.Requirements.Ensure ensure(checkAtEnd=false)
        annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
    equation
      connect(u, ensure.u)
        annotation (Line(points={{-110,0},{-11,0}}, color={162,29,33}));
      connect(tl, ensure.tl)
        annotation (Line(points={{0,100},{0,10}}, color={0,0,255}));
      connect(ensure.y, y)
      ...
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            ...
            Text(
              ...
              textString="Check anytime"),
            Line(points={{-78,-62},{-50,-62},{-50,-18},{60,-18},{60,-64},{82,
                  -64}},
                color={0,0,0}),
            Text(
              extent={{-24,52},{22,-10}},
...
<p><b><span style=\"font-family: MS Shell Dlg 2;\">Description</span></b> </p>
<p><span style=\"font-family: MS Shell Dlg 2;\">Each instance of this block creates a requirement that evaluates whether the condition <b>u</b> is satisfied (true) at any time instant of the time period <b>tl</b> (which can be a continuous or discrete time period). The condition is a <a href=\"modelica://ETL.Types.Boolean4\">Boolean4</a> that takes its values in the { true, false, undecided, undefined } set.</span></p>
...
<p>The condition <b>u</b> can be generated by converting Boolean signals to Boolean4 signals with the block <a href=\"modelica://ETL.Blocks.Logical.BooleanToBoolean4\">BooleanToBoolean4</a>, or by using the output y of another <a href=\"modelica://ETL.Requirements.Ensure\">Ensure</a>, <a href=\"modelica://ETL.Requirements.IntegerEnsure\">IntegerEnsure</a> or <a href=\"modelica://ETL.Requirements.RealEnsure\">RealEnsure</a> block.</p>
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
    ...
    public
      ...
      ETL.Connectors.Boolean4Output y "Result of the comparison"
        annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      ETL.Requirements.Ensure ensure
        annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
    equation
      connect(u, ensure.u)
        annotation (Line(points={{-110,0},{-11,0}}, color={162,29,33}));
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
    ...
    public
      ETL.Connectors.Boolean4Input u "Boolean4 condition" annotation (Placement(
            transformation(extent={{-120,-10},{-100,10}}), iconTransformation(
              extent={{-120,-10},{-100,10}})));
      ETL.Connectors.TimeLocatorInput[N] tl annotation (Placement(transformation(
              extent={{-10,90},{10,110}}), iconTransformation(extent={{-10,90},{10,110}})));
      ETL.Connectors.Boolean4Output y "Result of the comparison"
        annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      ETL.Requirements.IntegerEnsure ensure(redeclare model Function =
            ETL.Requirements.Functions.MathInteger.EventCounter, redeclare
          model Condition =
            ETL.Requirements.Conditions.MathInteger.IntegerGreater)
        annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
      Blocks.MathInteger.IntegerConstant integerConstant(K=threshold)
        annotation (Placement(transformation(extent={{-60,-40},{-40,-20}})));
    equation
      connect(u, ensure.u)
        annotation (Line(points={{-110,0},{-11,0}}, color={162,29,33}));
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
    ...
    public
      ...
      ETL.Connectors.Boolean4Output y "Result of the comparison"
        annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      ETL.Requirements.RealEnsure    ensure(redeclare model Function =
            ETL.Requirements.Functions.Math.Boolean4Integrator, redeclare model
          Condition = ETL.Requirements.Conditions.Math.Greater)
        annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
      Blocks.Math.Constant integerConstant(k=threshold)
        annotation (Placement(transformation(extent={{-60,-40},{-40,-20}})));
    equation
      connect(u, ensure.u)
        annotation (Line(points={{-110,0},{-11,0}}, color={162,29,33}));
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
    ...
    public
      ...
      ETL.Requirements.RealEnsure    ensure(redeclare model Function =
            ETL.Requirements.Functions.Math.Boolean4Integrator, redeclare model
          Condition = ETL.Requirements.Conditions.Math.GreaterEqual)
        annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
      Blocks.Math.Constant integerConstant(k=threshold)
        annotation (Placement(transformation(extent={{-60,-40},{-40,-20}})));
    equation
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
    ...
    public
      ...
      ETL.Requirements.RealEnsure    ensure(redeclare model Function =
            ETL.Requirements.Functions.Math.Boolean4Integrator, redeclare model
          Condition = ETL.Requirements.Conditions.Math.Lower)
        annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
      Blocks.Math.Constant integerConstant(k=threshold)
        annotation (Placement(transformation(extent={{-60,-40},{-40,-20}})));
    equation
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
    ...
    public
      ...
      ETL.Requirements.RealEnsure    ensure(redeclare model Function =
            ETL.Requirements.Functions.Math.Boolean4Integrator, redeclare model
          Condition = ETL.Requirements.Conditions.Math.LowerEqual)
        annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
      Blocks.Math.Constant integerConstant(k=threshold)
        annotation (Placement(transformation(extent={{-60,-40},{-40,-20}})));
    equation
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
    ...
    public
      ...
      ETL.Connectors.Boolean4Output y "Result of the comparison"
        annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      CheckCountEqual checkCountEqual(threshold=0)
        annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
      CheckAnytime checkAnyTime
        annotation (Placement(transformation(extent={{-50,-40},{-30,-20}})));
      Blocks.Logical4.And4 and4_1
        annotation (Placement(transformation(extent={{60,-10},{80,10}})));
    equation
      connect(tl, checkCountEqual.tl)
        annotation (Line(points={{0,100},{0,10}}, color={0,0,255}));
      connect(u, checkAnyTime.u) annotation (Line(points={{-110,0},{-80,0},{-80,
              -30},{-51,-30}}, color={162,29,33}));
      connect(tl, checkAnyTime.tl) annotation (Line(points={{0,100},{0,60},{-40,
              60},{-40,-20},{-40,-20}}, color={0,0,255}));
      connect(checkCountEqual.y, and4_1.u1) annotation (Line(points={{11,0},{40,
              0},{40,8},{59,8}}, color={162,29,33}));
      connect(checkAnyTime.y, and4_1.u2) annotation (Line(points={{-29,-30},{40,
              -30},{40,-8},{59,-8}}, color={162,29,33}));
      connect(and4_1.y, y) annotation (Line(points={{81,0},{90,0},{90,0},{110,0}},
            color={162,29,33}));
      connect(u, checkCountEqual.u) annotation (Line(points={{-110,0},{-60,0},{
              -60,0},{-11,0}}, color={162,29,33}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                             Rectangle(
              extent={{-100,100},{100,-100}},
              fillColor={162,29,33},
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
    ...
    block EnsureWithProbability

      parameter Real startTime=1 "First instant of the probability evaluation (s)";
      parameter Real period=1 "Period of the probability evaluation (s)";
      parameter Integer nb=10 "Number of evaluation points";
    ...
    public
      replaceable model Condition = Blocks.Math.Less4 annotation (Placement(transformation(extent={{0,10},{20,30}})),
        ...
        choice(redeclare model Condition =
                Blocks.Math.LessEqual4                            "<="),
        choice(redeclare model Condition =
                Blocks.Math.Greater4                           ">"),
        choice(redeclare model Condition =
                Blocks.Math.GreaterEqual4                            ">=")));
      Condition condition annotation (Placement(transformation(extent={{-30,-10},
                {-10,10}})));
      ETL.Connectors.Boolean4Input u "Boolean4 condition" annotation (Placement(
            transformation(extent={{-120,-10},{-100,10}}), iconTransformation(
              extent={{-120,-10},{-100,10}})));
      ...
      ETL.Connectors.Boolean4Output y "Result of the comparison"
        annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      Blocks.Logical4.Probability probability(
        startTime=startTime,
        period=period,
        N=nb,
        p=p,
      ...
      ETL.Connectors.RealInput threshold "Probability threshold "
    ...
    equation
      ...
      connect(ensure.y, y)
        annotation (Line(points={{41,0},{110,0}}, color={162,29,33}));
      connect(tl, ensure.tl) annotation (Line(points={{0,100},{0,40},{30,40},{30,10}},
            color={0,0,255}));
      connect(probability.y, condition.u1)
        annotation (Line(points={{-59,0},{-31,0}}, color={0,0,0}));
      connect(probability.range, condition.tolerance) annotation (Line(points={{-59,
              -8},{-48,-8},{-48,-30},{-20,-30},{-20,-11}}, color={0,0,0}));
      connect(condition.y, ensure.u)
        annotation (Line(points={{-9,0},{19,0}}, color={162,29,33}));
      connect(threshold, condition.u2) annotation (Line(points={{-110,-80},{-40,-80},
              {-40,-8},{-31,-8}}, color={0,0,0}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                             Rectangle(
              extent={{-100,100},{100,-100}},
              fillColor={162,29,33},
            ...
            Text(
              ...
              textString=""),
            Text(
              extent={{-150,110},{168,-210}},
              lineColor={0,0,0},
              textString="ℙ",
              fontName="Cambria Math")}),                         Diagram(
            coordinateSystem(preserveAspectRatio=false)),
        Documentation(info="<html>
<p><b><span style=\"font-family: MS Shell Dlg 2;\">Syntax</span></b> </p>
<blockquote><b>y</b> = <b>Ensure</b>(<b>u</b> = condition, <b>tl</b> = time_period); </blockquote>
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
  ...
  package Blocks
    ...
    package Events "Events blocks"
      ...
      public
        ETL.Connectors.BooleanInput u annotation (Placement(transformation(
                extent={{-120,-10},{-100,10}}), iconTransformation(extent={{-120,
                  -10},{-100,10}})));
        ETL.Connectors.BooleanOutput y annotation (Placement(transformation(
      ...
      equation
        y = edge(u);
            annotation (defaultComponentName="rising1", Icon(coordinateSystem(
...
<a href=\"modelica://Modelica.Blocks.Examples.BooleanNetwork1\">Modelica.Blocks.Examples.BooleanNetwork1</a>.
      ...
      public
        ETL.Connectors.Boolean4Input u annotation (Placement(transformation(
                extent={{-120,-10},{-100,10}}), iconTransformation(extent={{-120,
                  -10},{-100,10}})));
        ETL.Connectors.BooleanOutput y annotation (Placement(transformation(
                extent={{100,-10},{120,10}}), iconTransformation(extent={{100,-10},
...
<a href=\"modelica://Modelica.Blocks.Examples.BooleanNetwork1\">Modelica.Blocks.Examples.BooleanNetwork1</a>.
      ...
      equation
        y = edge(not_u);
            annotation (defaultComponentName="falling1", Icon(coordinateSystem(
                initialScale=0.04),                           graphics={
              Rectangle(
                extent={{-100,100},{100,-100}},
                lineColor={0,0,0},
...
<a href=\"modelica://Modelica.Blocks.Examples.BooleanNetwork1\">Modelica.Blocks.Examples.BooleanNetwork1</a>.
      ...
      equation
        y = change(u);
            annotation (defaultComponentName="changing1", Icon(coordinateSystem(
                initialScale=0.04),                            graphics={
              Rectangle(
                extent={{-100,100},{100,-100}},
                lineColor={0,0,0},
...
<a href=\"modelica://Modelica.Blocks.Examples.BooleanNetwork1\">Modelica.Blocks.Examples.BooleanNetwork1</a>.
      ...
      public
        ETL.Connectors.BooleanInput u1 annotation (Placement(transformation(
                extent={{-120,70},{-100,90}}), iconTransformation(extent={{-120,
                  70},{-100,90}})));
        ETL.Connectors.BooleanInput u2 annotation (Placement(transformation(
                extent={{-120,-90},{-100,-70}}), iconTransformation(extent={{-120,
                  -90},{-100,-70}})));
        ETL.Connectors.BooleanOutput y
          "y = true if event on u1 occurs before event on u2"
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        ETL.Connectors.BooleanOutput isUndecided
          "isUndecided = false if at least one  event has occurred on u1 or  u2, else true"
          annotation (Placement(transformation(extent={{100,-90},{120,-70}})));
        ETL.Connectors.BooleanInput reset annotation (Placement(transformation(
              extent={{-10,-10},{10,10}},
              rotation=90,
              origin={0,-110})));
        ETL.Connectors.BooleanInput strictlyBefore
          "If true, event on u1 should occurr strictly before event on u2"
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
      algorithm
      ...
      public
        ETL.Connectors.BooleanInput u1 annotation (Placement(transformation(
                extent={{-120,70},{-100,90}}), iconTransformation(extent={{-120,
                  70},{-100,90}})));
        ETL.Connectors.RealOutput y annotation (Placement(transformation(extent=
        ...
        ETL.Connectors.BooleanInput u2 annotation (Placement(transformation(
                extent={{-120,-90},{-100,-70}}), iconTransformation(extent={{-120,
                  -90},{-100,-70}})));
        ETL.Connectors.BooleanOutput isUndecided
          "isUndecided = false if both events have occurred on u1 and u2, else true"
          annotation (Placement(transformation(extent={{100,-90},{120,-70}})));
        ETL.Connectors.BooleanInput reset annotation (Placement(transformation(
              extent={{-10,-10},{10,10}},
              rotation=90,
      ...
      equation
        ...
        annotation (Icon(coordinateSystem(initialScale=0.04), graphics={
                                               Rectangle(
      ...
      public
        ETL.Connectors.BooleanInput u
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
        ETL.Connectors.IntegerOutput y annotation (Placement(transformation(
                extent={{100,-10},{120,10}}), iconTransformation(extent={{100,-10},
                  {120,10}})));
      ...
      algorithm
        ...
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              ...
              Text(
                ...
                fillPattern=FillPattern.Solid,
                textString="%name"),
              Line(points={{-82,12},{-62,12},{-62,32},{-22,32},{-22,52},{38,52},{38,72},
                    {68,72},{68,91.9805},{88,92}},           color={244,125,35}),
      ...
      public
        ...
        ETL.Connectors.RealInput delay "Shift delay" annotation (Placement(
      ...
      public
        ...
        ETL.Connectors.BooleanOutput y(start=false, fixed=true) annotation (
            Placement(transformation(extent={{100,-10},{120,10}}),
              iconTransformation(extent={{100,-10},{120,10}})));
        ETL.Connectors.IntegerInput delay "Shift delay" annotation (Placement(
              transformation(extent={{-120,-90},{-100,-70}})));
      public
        ETL.Connectors.BooleanInput clock(start=false, fixed=true)
        ...
        annotation (
          Icon(coordinateSystem(
              ...
              Polygon(
                ...
                fillColor={255,0,255},
                fillPattern=FillPattern.Solid),
              Line(points={{-60,-70},{-60,40}}),
              Line(points={{-20,-70},{-20,40}}),
              Line(points={{20,-70},{20,40}}),
              Line(points={{60,-70},{60,40}}),           Text(
                extent={{-172,56},{172,90}},
                lineColor={0,0,0},
                textString="%period"),
              Text(
                extent={{-60,148},{62,112}},
          ...
          Diagram(coordinateSystem(
              ...
              extent={{-100,-100},{100,100}}), graphics={
                                        Polygon(
                  points={{-70,82},{-76,60},{-64,60},{-70,82}},
                  lineColor={95,95,95},
                  fillColor={95,95,95},
                  fillPattern=FillPattern.Solid),Line(points={{-70,60},{-70,-98}},
                color={95,95,95}),Line(points={{-90,-80},{68,-80}}, color={95,95,95}),
                Polygon(
                  points={{90,-80},{68,-74},{68,-86},{90,-80}},
                  lineColor={95,95,95},
                  fillColor={95,95,95},
                  fillPattern=FillPattern.Solid),Text(
                  extent={{54,-90},{106,-102}},
                  lineColor={0,0,0},
              ...
              Line(points={{-30,37},{-30,9}},  color={95,95,95}),
              Line(points={{0,37},{0,8}},  color={95,95,95}),
              Line(points={{-30,31},{0,31}}, color={95,95,95}),
              Text(
                extent={{-37,51},{9,39}},
                lineColor={0,0,0},
                textString="period"),
              Line(points={{-73,9},{-30,9}},   color={95,95,95}),
              Polygon(
                points={{-30,31},{-21,33},{-21,29},{-30,31}},
                lineColor={95,95,95},
                fillColor={95,95,95},
                fillPattern=FillPattern.Solid),
              Polygon(
                points={{0,31},{-8,33},{-8,29},{0,31}},
                lineColor={95,95,95},
                fillColor={95,95,95},
                fillPattern=FillPattern.Solid),
              Text(
...
"));
      ...
      block Probability "Probability that an event occurs"
        import CRML.ETL.Types.Boolean4;
        import Modelica.Utilities.Files;
        import Modelica.Utilities.Streams;
        import Modelica.Utilities.Strings;

        parameter Real t[:]={1} "Time instants when the probability is evaluated (table must be sorted by increasing order)";
        parameter Real p=1.96 "Quantile of normal distribution with probability p";
        parameter String fileName "Name of the file that stores the results for the next run";
        parameter Boolean reset "Reset file for a new set of runs";
      ...
      protected
        ...
        Integer nEvents[size(t, 1)] "Number of observed events at time t";
        Real sigma[size(t, 1)](start=fill(0, size(t,1)), fixed=fill(true, size(t,1))) "Intermediate variable for the computation of the variance at time t";
        Real sigma_n[size(t, 1)] "Intermediate variable for the computation of the variance at time t";
        Real variance[size(t, 1)](start=fill(0, size(t,1)), fixed=fill(true, size(t,1))) "Variance";
        Integer i(start=1, fixed=true) "Index for the current time";
        Integer ln "Index for line number in file";

      public
        ETL.Connectors.BooleanInput  u "Probabilistic event" annotation (Placement(
              transformation(extent={{-120,-10},{-100,10}}), iconTransformation(
                extent={{-120,-10},{-100,10}})));
        ETL.Connectors.RealOutput y[size(t, 1)](start=fill(0, size(t, 1)), fixed=true) "Probability that event u occured at time t"
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        ETL.Connectors.RealOutput range[size(t, 1)](start=fill(0, size(t, 1)), fixed=true)
          "Half-width uncertainty range of the realization of u at time t"
          annotation (Placement(transformation(extent={{100,-90},{120,-70}})));
      algorithm

        when initial() then
          file_exist := Files.exist(fileName);

          if file_exist and not reset then
            ln := 1;
            (line, eof) := Streams.readLine(fileName, ln);
            nRuns := Strings.scanInteger(line) + 1;

            for j in 1:size(t,1) loop
              ln := ln + 1;
              (line, eof) := Streams.readLine(fileName, ln);

              ln := ln + 1;
              (line, eof) := Streams.readLine(fileName, ln);
              nEvents[j] := Strings.scanInteger(line);

              ln := ln + 1;
              (line, eof) := Streams.readLine(fileName, ln);
              sigma_n[j] := Strings.scanReal(line);
            end for;

            Streams.close(fileName);
          else
            nRuns := 1;
            nEvents := fill(0, size(t,1));
            sigma_n := fill(0, size(t,1));
          end if;
        end when;

        when time >= t[i] then
          if u then
            nEvents[i] := nEvents[i] + 1;
          end if;

          y[i] := nEvents[i]/nRuns;

          sigma[i] := ((if u then 1 else 0) - y[i])^2;
          sigma_n[i] := sigma_n[i] + sigma[i];
          variance[i] := if nRuns >= 2 then sigma_n[i]/(nRuns - 1) else Modelica.Constants.inf;
          range[i] := p*sqrt(variance[i]/nRuns);

          i := if i < size(t, 1) then i + 1 else i;
        end when;
        ...
        when terminal() then
          ...
          line := String(nRuns);
          Streams.print(line, fileName);

          for j in 1:size(t,1) loop
            line := "time" + String(j) + ": " + String(t[j]);
            Streams.print(line, fileName);

            line := String(nEvents[j]);
            Streams.print(line, fileName);

            line := String(sigma_n[j]);
            Streams.print(line, fileName);
          end for;
...
<a href=\"modelica://Modelica_Synchronous.Examples.Systems.ControlledMixingUnit\">Examples.Systems.ControlledMixingUnit</a>.
      ...
      block ClockToBoolean
        ...
        ETL.Connectors.ClockInput u annotation (Placement(transformation(
      ...
      equation
        ...
        annotation (Icon(coordinateSystem(
              ...
              Ellipse(
                ...
                fillPattern=FillPattern.Solid),                                    Line(points={{
                    -74,-82},{-30,-82},{-30,-38},{-30,-38},{-30,-82},{72,-82}},
                                         color={95,95,95},
              ...
              Ellipse(
                ...
                fillColor={95,95,95},
                fillPattern=FillPattern.Solid),                                    Line(points={{
                    -72,34},{-28,34},{-28,78},{-28,78},{-28,34},{74,34}},
                                         color={255,0,255},
                pattern=LinePattern.Dot),
              Ellipse(
                extent={{-38,88},{-18,68}},
      ...
      equation
        ...
        connect(u, eventClock.u) annotation (Line(points={{-110,0},{-11,0},{-11,0}},
                          color={217,67,180}));
        connect(clockToBoolean.u, eventClock.y) annotation (Line(
            points={{38,0},{24,0},{24,0},{11,0}},
            color={175,175,175},
            pattern=LinePattern.Dot,
            thickness=0.5));
        connect(clockToBoolean.y, y)
          annotation (Line(points={{62,0},{110,0}}, color={217,67,180}));
        annotation (Icon(coordinateSystem(initialScale=0.04), graphics={
              Rectangle(
                extent={{-100,100},{100,-100}},
                lineColor={0,0,0},
    ...
    annotation (Icon(graphics={
            ...
            Polygon(
              ...
              fillPattern=FillPattern.Solid),
            Line(points={{-36,0},{-36,81}},   color={255,0,255}),
            Line(points={{40,0},{40,81}},     color={255,0,255})}));
    end Events;
          ...
          Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,
              ...
              Text(
                ...
                textString="false"),    Polygon(
                  ...
                  lineColor={192,192,192},
                  fillColor={192,192,192},
                  fillPattern=FillPattern.Solid),Line(points={{-80,70},{-80,-88}},
                color={192,192,192}),Text(
                  extent={{-74,92},{-56,74}},
                  lineColor={192,192,192},
                  textString="y"),Line(points={{-100,-70},{58,-70}},color={192,192,
                    192}),
                Polygon(
                  points={{80,-70},{58,-64},{58,-76},{80,-70}},
                  lineColor={192,192,192},
                  fillColor={192,192,192},
                  fillPattern=FillPattern.Solid),Text(
                  extent={{44,-80},{96,-92}},
...
<p><b>Version 1.0</b> </p>
      ...
      algorithm
        ...
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              ...
              Ellipse(
                ...
                fillPattern=FillPattern.Solid),
                Line(points={{-80,-58},{-4,-58},{-4,-14},{38,-14},{38,-58},{66,-58}},
                    color={0,0,0}),
                Line(points={{-80,32},{-62,32},{-62,76},{-20,76},{-20,32},{66,32}},
                    color={255,0,255}),
              Text(
                extent={{-60,148},{62,112}},
                lineColor={0,0,255},
      ...
      public
        ETL.Connectors.BooleanInput reset "Reset signal" annotation (Placement(
              transformation(
              extent={{-10,-10},{10,10}},
              rotation=90,
              origin={0,-110})));
...
<img src=\"modelica://Modelica/Resources/Images/Blocks/Sources/BooleanStep.png\"
     alt=\"BooleanStep.png\">
      ...
      public
        ETL.Connectors.BooleanInput[N] u
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
        ETL.Connectors.BooleanOutput y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      ...
      block GlobalSeed "Generates a global seed for the RandomFailure block"
        ...
        parameter Integer fixedSeed = 67867967 "Fixed seed (active if useAutomaticSeed = false)" annotation(Dialog(enable=not useAutomaticSeed));
...
<p><code><b>inner</b> ETL.Blocks.Events.GlobalSeed globalSeed;</code> </p>
...
<td><p><b>useAutomaticSeed=true</b>:</p><p>An automatic global seed is computed by using the ID of the process in which the simulation takes place and the current local time. As a result, the global seed is changed automatically for every new simulation, including parallelized simulation runs. This option can be used to perform Monte Carlo Simulations with minimal effort (just performing many simulation runs) where every simulation run uses a different noise.</p></td>
      ...
      protected
        outer Logical.GlobalSeed globalSeed
      ...
      public
        ETL.Connectors.BooleanOutput             y annotation (
          Placement(transformation(extent = {{100, -10}, {120, 10}})));
        ETL.Connectors.BooleanInput failureIsPresent annotation (Placement(
              transformation(
              extent={{-10,-10},{10,10}},
              rotation=90,
              origin={0,-110})));
      ...
      public
        ETL.Connectors.BooleanInput failureIsPresent annotation (Placement(
              ...
              rotation=90,
              origin={0,-110})));
        ETL.Connectors.RealInput failureRate
          "Failure rate (nb of failures per time unit, active if perfect is false)"
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}}),
              visible=not perfect));
        ETL.Connectors.RealInput repairRate
          "Repair rate (nb of repairs per time unit, active if perfect is false)"
          annotation (Placement(transformation(extent={{-120,-90},{-100,-70}}),
              visible=not perfect));
      equation
        ...
        annotation (
          Icon(coordinateSystem(preserveAspectRatio = false), graphics={
              ...
              Ellipse(
                ...
                fillPattern=FillPattern.Solid),
              Line(points={{-80,0},{40,0}}, color={0,0,0}),
              Line(points={{-70,40},{-70,0}}, color={0,0,0}),
              Line(points={{-54,40},{-54,0}}, color={0,0,0}),
              Line(points={{-32,40},{-32,0}}, color={0,0,0}),
              Line(points={{-20,40},{-20,0}}, color={0,0,0}),
              Line(points={{-4,40},{-4,0}}, color={0,0,0}),
              Line(points={{26,40},{26,0}}, color={0,0,0}),
              Line(points={{-70,40},{-54,40}}, color={0,0,0}),
              Line(points={{-32,40},{-20,40}}, color={0,0,0}),
              Line(points={{-4,40},{26,40}}, color={0,0,0})}),
          Diagram(coordinateSystem(preserveAspectRatio = false)),
          experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-6, Interval = 0.002));
      end RandomFailure;
    annotation (Icon(graphics={
    ...
    package Logical4
      ...
      block Boolean4Constant "Generate a constant signal of type Boolean4"
        ...
        ETL.Connectors.Boolean4Output y annotation (extent=[100,-10; 120,10],
            Placement(transformation(extent={{100,-10},{120,10}})));
      equation
        y = K;
        annotation (
...
<p><b>Version 1.0</b> </p>
      ...
      block And4 "And operator on two Boolean4: u1 and u2"
        ...
        ETL.Connectors.Boolean4Input u1 annotation (Placement(transformation(
                extent={{-120,70},{-100,90}}), iconTransformation(extent={{-120,
                  70},{-100,90}})));
        ETL.Connectors.Boolean4Input u2 annotation (Placement(transformation(
                extent={{-120,-90},{-100,-70}}), iconTransformation(extent={{-120,
                  -90},{-100,-70}})));
        ETL.Connectors.Boolean4Output y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      ...
      public
        ETL.Connectors.Boolean4Input[N] u
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
        ETL.Connectors.Boolean4Output y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      ...
      block Probability "Probability that input is true"
        ...
        parameter Real startTime=1 "First instant of the probability evaluation (s)";
        parameter Real period=1 "Period of the probability evaluation (s)";
        parameter Integer N=10 "Number of evaluation points";
        parameter Real p=1.96 "Quantile of normal distribution with probability p";
        parameter String fileName "Name of the file that stores the results for the next run";
        parameter String decimalSeparator="," "Decimal separator in the result file";
        parameter Boolean reset "Reset file for a new set of runs";
      ...
      protected
        ...
        parameter String fileName_temp=fileName + "_temp" "Name of the temporary output file that stores the results for the next run";
      ...
      public
        ETL.Connectors.Boolean4Input u "Probabilistic event" annotation (Placement(
              transformation(extent={{-120,-10},{-100,10}}), iconTransformation(
                extent={{-120,-10},{-100,10}})));
        ETL.Connectors.RealOutput y(start=0, fixed=true) "Estimate of the probability that event u occurred at time t"
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        ETL.Connectors.RealOutput range(start=infRange, fixed=true)
          "Half-width uncertainty range of y"
          annotation (Placement(transformation(extent={{100,-90},{120,-70}})));
      algorithm

        /* Remove temporary output file in case previous run aborted without executing the exit handler */
        when initial() then
          Files.removeFile(fileName_temp);
        end when;

        /* Compute outputs at each time step */
        when time >= startTime + (i - 1)*period then
          /* Write header to output file */
          if not header_processed then
            if Files.exist(fileName) and not reset then
              ln := ln + 1;
            end if;

           Streams.print("Time; Number of runs; sigma_X_n; sigma_var_n; Probability; Half-width confidence range;", fileName_temp);
          ...
          if Files.exist(fileName) and not reset then
            ln := ln + 1;
            line := Streams.readLine(fileName, ln);
          ...
          /* Copy results from previous run to outputs if u is undefined or undecided */
          else
            if Files.exist(fileName) and not reset then
              p1 := p2 + 1;
              p2 := Strings.find(line, ";", p1);
              y := Strings.scanReal(Strings.replace(Strings.substring(line, p1, p2 - 1), decimalSeparator, "."));

              p1 := p2 + 1;
              p2 := Strings.find(line, ";", p1);
              range := Strings.scanReal(Strings.replace(Strings.substring(line, p1, p2 - 1), decimalSeparator, "."));
            else
              y := 0;
              range := infRange;
            end if;
          ...
          line := String(startTime + (i - 1)*period) + ";";
          line := line + String(n) + ";";
          ...
          Streams.print(line, fileName_temp);

          i := if i < N then i + 1 else i;
        end when;

        /* After the last time step, reinitialize the outputs */
        when time >= startTime + N*period then
          y := 0;
          range := infRange;
        end when;
        ...
        when terminal() then
          Streams.close(fileName);
          Files.move(oldName=fileName_temp, newName=fileName, replace=true);
        end when;
...
<a href=\"modelica://Modelica.Blocks.Examples.IntegerNetwork1\">Modelica.Blocks.Examples.IntegerNetwork1</a>.
      ...
      annotation (Icon(graphics={
            ...
            Rectangle(
              ...
              extent={{-100.0,-100.0},{100.0,100.0}},
              radius=25.0),
            Line(points={{-80,-60},{-40,-60},{-40,-20},{0,-20},{0,60},{40,60},{
                  40,20},{80,20}}, color={162,29,33})}));
    end Logical4;
...
<img src=\"modelica://Modelica/Resources/Images/Blocks/Sources/Constant.png\"
     alt=\"Constant.png\">
      ...
      equation
        ...
        y = offset + (if time < t0 then 0 else if time < (t0 +
          duration) then (time - t0)*height/duration else height);
        annotation (
          Icon(coordinateSystem(
              preserveAspectRatio=true,
              extent={{-100,-100},{100,100}}), graphics={
              Rectangle(extent={{-100,100},{100,-100}}, lineColor={0,0,0},
                fillColor={255,255,255},
                fillPattern=FillPattern.Solid),          Text(
                extent={{-158,54},{186,88}},
                lineColor={0,0,0},
                textString="%height% / %duration"),
...
If parameter duration is set to 0.0, the limiting case of a Step signal is achieved.
      ...
      public
        ETL.Connectors.RealInput u1
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
        ETL.Connectors.RealInput u2 annotation (Placement(transformation(extent=
                 {{-120,-90},{-100,-70}})));
        ETL.Connectors.Boolean4Output y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      ...
      public
        ...
        ETL.Connectors.Boolean4Output y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        ETL.Connectors.RealInput tolerance "Half-width uncertainty range"
      ...
      protected
        Real insidePolygon=CRML.ETL.Utilities.isInsidePolygon(
                  {x1,x2},
                  polygon,
                  tolerance);
      public
        ETL.Connectors.Boolean4Output y "True if point is inside polygon"
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        ETL.Connectors.RealInput x2 "Second coordinate of the point"
          ...
          Icon(coordinateSystem(
              ...
              Text(
                ...
                fillPattern=FillPattern.Solid),                      Polygon(points={{
                    -60,40},{-30,54},{60,54},{52,-8},{12,-54},{-52,-30},{-60,40}},
                  lineColor={0,0,0}),
              Polygon(
                points={{-80,90},{-86,68},{-74,68},{-80,90}},
                lineColor={95,95,95},
...
<p> </p>
      ...
      public
        ETL.Connectors.RealOutput y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        ETL.Connectors.RealInput start "Clock start instant (in seconds)"
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}}),
              iconTransformation(extent={{-120,-10},{-100,10}})));
...
<a href=\"modelica://Modelica_Synchronous.Examples.Systems.ControlledMixingUnit\">Examples.Systems.ControlledMixingUnit</a>.
    ...
    package MathInteger "Mathematical blocks"
      ...
      block IntegerConstant "Generate a constant signal of type Integer"
        ...
        ETL.Connectors.IntegerOutput y annotation (extent=[100,-10; 120,10],
            Placement(transformation(extent={{100,-10},{120,10}})));
      equation
        y = K;
        annotation (
          ...
          Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,
              ...
              Text(
                ...
                color={192,192,192}),Text(
                  extent={{-74,92},{-56,74}},
                  lineColor={192,192,192},
                  textString="y"),Line(points={{-100,-70},{58,-70}},color={192,192,192}),
                Polygon(
                  points={{80,-70},{58,-64},{58,-76},{80,-70}},
                  lineColor={192,192,192},
                  fillColor={192,192,192},
...
<h4>Version 1.0 </h4>
      ...
      block IntegerAdd "Output the sum of the two inputs"
        ...
        ETL.Connectors.IntegerInput u1 annotation (Placement(transformation(
                extent={{-120,50},{-100,70}}), iconTransformation(extent={{-120,
                  50},{-100,70}})));
        ETL.Connectors.IntegerInput u2 annotation (Placement(transformation(
  ...
  results in the following equations:
     ...
     y = 2 * u1 - 3 * u2
              ...
              Text(
                ...
                textString="%name"),
              Line(points={{-100,60},{-74,24},{-44,24}}, color={244,125,35}),
              Line(points={{-100,-60},{-74,-28},{-42,-28}}, color={244,125,35}),
              Ellipse(lineColor={244,125,35},
                                           extent={{-50,-50},{50,50}}),
              Line(points={{50,0},{100,0}}, color={244,125,35}),
          ...
          Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{
                ...
                color={0,0,255}),Line(points={{-100,60},{-74,24},{-44,24}}, color={244,
                    125,35}),
                          Line(points={{-100,-60},{-74,-28},{-42,-28}}, color={244,
                    125,35}),
      ...
      public
        ETL.Connectors.IntegerOutput y(start=offset, fixed=true)
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        ETL.Connectors.BooleanInput reset annotation (Placement(transformation(
              extent={{-10,-10},{10,10}},
              rotation=90,
        ...
        annotation (
          Icon(coordinateSystem(
              ...
              Line(points={{-80,-40},{-40,-40},{-40,-20}},
                ...
                fillPattern=FillPattern.Solid,
                textString="%offset% / %step% "),
              Line(points={{-40,-20},{0,-20}}, color={244,125,35}),
              Line(points={{0,-20},{0,0},{30,0}}, color={244,125,35}),
              Line(points={{30,0},{30,20},{60,20}}, color={244,125,35}),
              Text(
                extent={{-51,150},{51,114}},
                lineColor={0,0,255},
                lineThickness=0.5,
          ...
          Diagram(coordinateSystem(
              ...
              Line(
                ...
                color={95,95,95}),
              Polygon(
                points={{-12,20},{-14,10},{-10,10},{-12,20}},
                lineColor={95,95,95},
                fillColor={95,95,95},
                fillPattern=FillPattern.Solid),
              Polygon(
                points={{-12,-20},{-14,-10},{-10,-10},{-12,-20},{-12,-20}},
                lineColor={95,95,95},
                fillColor={95,95,95},
                fillPattern=FillPattern.Solid),
              Text(
              ...
              Line(
                ...
                thickness=0.5),
              Polygon(
                points={{28,60},{26,50},{30,50},{28,60}},
                lineColor={95,95,95},
                fillColor={95,95,95},
                fillPattern=FillPattern.Solid),
              Line(
                ...
                color={95,95,95}),
              Polygon(
                points={{28,20},{26,30},{30,30},{28,20},{28,20}},
                lineColor={95,95,95},
                fillColor={95,95,95},
                fillPattern=FillPattern.Solid),
              Text(
              ...
              Text(
                ...
                textString="event"),
              Polygon(
                points={{-20,-70},{-22,-80},{-18,-80},{-20,-70}},
                lineColor={95,95,95},
                fillColor={95,95,95},
                fillPattern=FillPattern.Solid),
              Line(
              ...
              Text(
                ...
                textString="event"),
              Polygon(
                points={{20,-70},{18,-80},{22,-80},{20,-70}},
                lineColor={95,95,95},
                fillColor={95,95,95},
                fillPattern=FillPattern.Solid),
              Line(
...
u1, else it is set equal to u3.</p>
      ...
      public
        ETL.Connectors.IntegerOutput y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        ETL.Connectors.IntegerInput start
          "Clock start instant (in clock ticks)" annotation (Placement(
              transformation(extent={{-120,-10},{-100,10}}), iconTransformation(
                extent={{-120,-10},{-100,10}})));
        ETL.Connectors.BooleanInput reset "Clock reset to zero" annotation (
            Placement(transformation(
...
<a href=\"modelica://Modelica_Synchronous.Examples.Systems.ControlledMixingUnit\">Examples.Systems.ControlledMixingUnit</a>.
    ...
    package Routing
      block Boolean4Replicator "Boolean4 signal replicator"
        ...
        ETL.Connectors.Boolean4Input u "Connector of Boolean input signal"
          annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));
        ETL.Connectors.Boolean4Output y[nout]
...
This block replicates the Boolean input signal to an array of <code>nout</code> identical Boolean output signals.
      ...
      block IntegerReplicator "Integer signal replicator"
        parameter Integer nout=1 "Number of outputs";
        ETL.Connectors.IntegerInput u "Connector of Boolean input signal"
          annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));
        ETL.Connectors.IntegerOutput y[nout]
          "Connector of Boolean output signals"
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      equation
        y = fill(u, nout);
...
This block replicates the Boolean input signal to an array of <code>nout</code> identical Boolean output signals.
      ...
      block RealReplicator "Real signal replicator"
        parameter Integer nout=1 "Number of outputs";
        ETL.Connectors.RealInput u "Connector of Boolean input signal"
          annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));
        ETL.Connectors.RealOutput y[nout] "Connector of Boolean output signals"
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      equation
        y = fill(u, nout);
        annotation (
...
<p><span style=\"font-family: MS Shell Dlg 2;\">An event occurs when a <a href=\"modelica://ETL.Types.Boolean4\">Boolean4</a> becomes true.</span></p>
...
<p><br><span style=\"font-family: MS Shell Dlg 2;\">Therefore, the type of <b>u2</b> is <a href=\"modelica://ETL.Types.Boolean4\">Boolean4</a> if </span><span style=\"font-family: Courier New;\">durationSpecified=</span><span style=\"font-family: MS Shell Dlg 2;\">false, Real if </span><span style=\"font-family: Courier New;\">durationSpecified=</span><span style=\"font-family: MS Shell Dlg 2;\">true and </span><span style=\"font-family: Courier New;\">clockSpecified=</span><span style=\"font-family: MS Shell Dlg 2;\">false, and Integer if </span><span style=\"font-family: Courier New;\">durationSpecified=</span><span style=\"font-family: MS Shell Dlg 2;\">true and </span><span style=\"font-family: Courier New;\">discreteClockSpecified=</span><span style=\"font-family: MS Shell Dlg 2;\">true.</span></p>
...
<p><span style=\"font-family: MS Shell Dlg 2;\">The maximum number of overlapping time periods is set by the parameter<b> </b></span><span style=\"font-family: Courier New;\"><a href=\"modelica://ETL.Type.nMaxOverlap\">nMaxOverlap</a></span><span style=\"font-family: MS Shell Dlg 2;\">. If the number of overlapping time periods exceeds </span><span style=\"font-family: Courier New;\"><a href=\"modelica://ETL.Type.nMaxOverlap\">nMaxOverlap</a></span><span style=\"font-family: MS Shell Dlg 2;\">, an error is raised.</span></p>
...
<p><span style=\"font-family: MS Shell Dlg 2;\">The master time period can be created using the <a href=\"modelica://ETL.TimeLocators.ContinuousTimeWhile\">ContinuousTimeWhile</a> block.</span></p>
<p><span style=\"font-family: MS Shell Dlg 2;\">The events <b>u1</b> and <b>u2</b> can be generated by converting Boolean signals to <a href=\"modelica://ETL.Types.Boolean4\">Boolean4</a> signals with the block <a href=\"modelica://ETL.Blocks.Logical.BooleanToBoolean4\">BooleanToBoolean4</a>.</span></p>
<p><br><b><span style=\"font-family: MS Shell Dlg 2;\">Example</span></b> </p>
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
</html>"));
      end Periods;
...
<p><b><span style=\"font-family: MS Shell Dlg 2;\">While</span></b> is a special case of a continuous time locator with no overlapping time periods.</p>
<p><span style=\"font-family: MS Shell Dlg 2;\">Opening and closing events are respectively delivered on input <b>u</b> when <b>u</b> becomes respectively true and false.</span></p>
<p><span style=\"font-family: MS Shell Dlg 2;\">For more information, refer to the <a href=\"modelica://ETL.TimeLocators.TimeLocator\">TimeLocator</a> block.</span></p>
<p><span style=\"font-family: MS Shell Dlg 2;\">While can only be used as the master time locator of a <a href=\"modelica://ETL.TimeLocators.TimeLocator\">TimeLocator</a> block.</span></p>
</html>"));
      end While;
      ...
      public
        ...
        Connectors.BooleanOutput[N] y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        Attributes.PeriodTimePeriod[N] timePeriod
      ...
      equation
        ...
        connect(clockToBoolean.y, y)
          annotation (Line(points={{62,0},{110,0}},         color={217,67,180}));
        connect(tl, timePeriod.tl) annotation (Line(points={{0,100},{0,40},{-50,40},{-50,
                10}}, color={0,0,255}));
        connect(timePeriod.y, eventClock.u)
          annotation (Line(points={{-39,0},{-11,0}},         color={217,67,180}));
        annotation (Icon(coordinateSystem(initialScale=0.04), graphics={
              Rectangle(
                extent={{-100,100},{100,-100}},
                lineColor={0,0,0},
...
<p>Displays the time periods of a <span style=\"font-family: MS Shell Dlg 2;\"><a href=\"modelica://ETL.TimeLocators.DiscreteTimeLocator\">DiscreteTimeLocator</a> block in the form of clock ticks inside the time periods of the time locator.</span></p>
      ...
      public
        ...
        Connectors.BooleanOutput y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        Attributes.WhileTimePeriod timePeriod
          annotation (Placement(transformation(extent={{-60,-10},{-40,10}})));
      equation
...
<p><b><span style=\"font-family: MS Shell Dlg 2;\">Description</span></b> </p>
<p>Displays the time periods of a <span style=\"font-family: MS Shell Dlg 2;\"><a href=\"modelica://ETL.TimeLocators.DiscreteTimeWhile\">DiscreteTimeWhile</a> block in the form of clock ticks inside the time periods of the time locator.</span></p>
</html>"));
      end ShowDiscreteWhile;

      package Attributes
        block PeriodsStart
          "Returns the starting events of a multiple time period"
          parameter Integer N=CRML.ETL.Types.nMaxOverlap;
        ...
        public
          ...
          Connectors.BooleanOutput y
            annotation (Placement(transformation(extent={{100,-10},{120,10}})));
          Attributes.PeriodStart[N] timePeriodStartingEvents
            annotation (Placement(transformation(extent={{-4,-4},{4,4}})));
          Blocks.Logical.Or_n or_n
            annotation (Placement(transformation(extent={{40,-10},{60,10}})));

        equation
          connect(tl, timePeriodStartingEvents.tl)
            annotation (Line(points={{0,100},{0,4}}, color={0,0,255}));
          connect(timePeriodStartingEvents.y, or_n.u)
            annotation (Line(points={{4.4,0},{39,0}}, color={217,67,180}));
          connect(or_n.y, y)
            annotation (Line(points={{61,0},{110,0}}, color={217,67,180}));
          annotation (Icon(coordinateSystem(initialScale=0.04), graphics={
                Rectangle(
                  extent={{-100,100},{100,-100}},
                  lineColor={0,0,0},
...
<p>Displays the time periods of a <span style=\"font-family: MS Shell Dlg 2;\"><a href=\"modelica://ETL.TimeLocators.DiscreteTimeLocator\">DiscreteTimeLocator</a> block in the form of clock ticks inside the time periods of the time locator.</span></p>
        ...
        public
          ...
          Blocks.Logical.Or_n or_n
            annotation (Placement(transformation(extent={{40,-10},{60,10}})));
          Attributes.PeriodEnd[N] timePeriodClosingEvents
            annotation (Placement(transformation(extent={{-4,-4},{4,4}})));

        equation
          connect(tl, timePeriodClosingEvents.tl)
            annotation (Line(points={{0,100},{0,4}}, color={0,0,255}));
          connect(timePeriodClosingEvents.y, or_n.u)
            annotation (Line(points={{4.4,0},{39,0}}, color={217,67,180}));
          connect(or_n.y, y)
            annotation (Line(points={{61,0},{110,0}}, color={217,67,180}));
          annotation (Icon(coordinateSystem(initialScale=0.04), graphics={
...
<p>Displays the time periods of a <span style=\"font-family: MS Shell Dlg 2;\"><a href=\"modelica://ETL.TimeLocators.DiscreteTimeLocator\">DiscreteTimeLocator</a> block in the form of clock ticks inside the time periods of the time locator.</span></p>
        ...
        public
          ...
          ETL.Connectors.TimeLocatorInput tl annotation (Placement(transformation(
                  extent={{-10,90},{10,110}}), iconTransformation(extent={{-10,90},
                    {10,110}})));
        equation
          y = tl.timePeriod;
          annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                  ...
                  fillColor={255,255,255},
                  fillPattern=FillPattern.Solid),
                Line(points={{-86,-24},{-50,-24},{-50,20},{60,20},{60,-26},{88,-26}},
                    color={0,0,0}),
                Rectangle(
                  extent={{-66,-46},{0,-62}},
                  lineColor={0,0,0},
    ...
    package Requirements
      block Ensure
        parameter Boolean checkAtEnd=true "true: check at end of the time period - false: check at any time instant within the time period";

      protected
        parameter Boolean K=not checkAtEnd;
        parameter Integer N=CRML.ETL.Types.nMaxOverlap;
      ...
      public
        Connectors.Boolean4Input u "Boolean4 condition"
            ...
            Placement(transformation(extent={{-120,-10},{-100,10}}),
              iconTransformation(extent={{-120,-10},{-100,10}})));
        Connectors.TimeLocatorInput[N] tl annotation (Placement(transformation(extent=
        ...
        Blocks.Logical.BooleanConstant[N] booleanConstant(each K=K)
          annotation (Placement(transformation(extent={{-10,10},{10,30}})));
      equation
        connect(tl, eval.tl) annotation (Line(points={{0,100},{0,60},{40,60},{40,
                10}},
              color={0,0,255}));
        connect(u, boolean4Replicator.u)
        ...
        connect(booleanConstant.y, eval.a) annotation (Line(points={{11,20},{20,20},{20,
                8},{29,8}}, color={217,67,180}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
                fillColor={162,29,33},
              ...
              Text(
                extent={{-68,72},{72,44}},
                lineColor={28,108,200},
                textString="Ensure")}),                             Diagram(
              coordinateSystem(preserveAspectRatio=false)),
          Documentation(info="<html>
<p><b><span style=\"font-family: MS Shell Dlg 2;\">Syntax</span></b> </p>
<blockquote><b>y</b> = <b>Ensure</b>(<b>u</b> = condition, <b>tl</b> = time_period, <b>checkAtEnd</b>); </blockquote>
<p><b><span style=\"font-family: MS Shell Dlg 2;\">Description</span></b> </p>
<p><span style=\"font-family: MS Shell Dlg 2;\">Each instance of this block creates a requirement that evaluates whether the condition <b>u</b> is satisfied (true) at the end of the time period <b>tl</b> if <b>checkAtEnd</b>=true or at any time instant within the time period <b>tl</b> if <b>checkAtEnd</b>=false (which can be a continuous or discrete time period). The condition is a <a href=\"modelica://ETL.Types.Boolean4\">Boolean4</a> that takes its values in the { true, false, undecided, undefined } set.</span></p>
<p><span style=\"font-family: MS Shell Dlg 2;\">To create continuous time locators, refer to the <a href=\"modelica://ETL.TimeLocators.ContinuousTimeLocator\">ContinuousTimeLocator</a> block. To create discrete time locators, refer to the <a href=\"modelica://ETL.TimeLocators.DiscreteTimeLocator\">DiscreteTimeLocator</a> block.</span></p>
<p><span style=\"font-family: MS Shell Dlg 2;\">The value of a requirement is a <a href=\"modelica://ETL.Types.Boolean4\">Boolean4</a> that can be used as input of another Ensure block. It is therefore possible to express requirements on requirements.</span></p>
<p><span style=\"font-family: MS Shell Dlg 2;\">Requirements can be combined using <a href=\"modelica://ETL.Types.Boolean4\">Boolean4</a> operators, refer to the <a href=\"modelica://ETL.Blocks.Logical4\">Logical4</a> package.</span></p>
<p>The condition <b>u</b> can be generated by converting Boolean signals to Boolean4 signals with the block <a href=\"modelica://ETL.Blocks.Logical.BooleanToBoolean4\">BooleanToBoolean4</a>, or by using the output y of another <a href=\"modelica://ETL.Requirements.Ensure\">Ensure</a>, <a href=\"modelica://ETL.Requirements.IntegerEnsure\">IntegerEnsure</a> or <a href=\"modelica://ETL.Requirements.RealEnsure\">RealEnsure</a> block.</p>
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
      ...
      public
        Connectors.Boolean4Input u "Boolean4 condition"
            ...
            Placement(transformation(extent={{-120,-10},{-100,10}}),
              iconTransformation(extent={{-120,-10},{-100,10}})));
        Connectors.TimeLocatorInput[N] tl annotation (Placement(transformation(
                extent={{-10,90},{10,110}}), iconTransformation(extent={{-10,90},
                  {10,110}})));
        Connectors.Boolean4Output y "Result of the comparison"
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        ...
        replaceable model Function = Functions.MathInteger.EventCounter
          ...
          choices(choice(redeclare model Function =
                  ETL.Requirements.Functions.MathInteger.EventCounter                       "Event counter")));
        Function[N] genericFunction annotation (Placement(transformation(extent={{-50,-10},
                  {-30,10}})));
        replaceable model Condition = Conditions.MathInteger.IntegerGreater annotation (Placement(transformation(extent={{0,10},{20,30}})),
          choices(choice(redeclare model Condition =
                  ETL.Requirements.Conditions.MathInteger.IntegerGreater                                    ">"),
          choice(redeclare model Condition =
                  ETL.Requirements.Conditions.MathInteger.IntegerGreaterEqual                            ">="),
      ...
      equation
        ...
        connect(and4.y, y)
          annotation (Line(points={{91,0},{110,0}}, color={162,29,33}));
        connect(threshold, integerReplicator.u)
          annotation (Line(points={{-110,-80},{-92,-80}}, color={255,127,0}));
        connect(boolean4Replicator.y, genericFunction.u)
          annotation (Line(points={{-69,0},{-51,0}}, color={162,29,33}));
        connect(tl, genericFunction.tl) annotation (Line(points={{0,100},{0,60},{
                -40,60},{-40,10}},
                           color={0,0,255}));
        connect(genericFunction.y, condition.u) annotation (Line(points={{-29,0},
                {-20,0},{-20,8},{-11,8}}, color={255,127,0}));
        connect(integerReplicator.y, condition.threshold) annotation (Line(points=
               {{-69,-80},{-20,-80},{-20,-8},{-11,-8}}, color={255,127,0}));
        connect(condition.y, eval.u)
          annotation (Line(points={{11,0},{29,0}}, color={162,29,33}));
        connect(condition.decisionEvent, eval.a) annotation (Line(points={{11,8},{
                29,8}},                color={217,67,180}));
        connect(genericFunction.ft, condition.ft) annotation (Line(points={{-40,
                -11},{-40,-20},{0,-20},{0,-11}}, color={102,44,145}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
                fillColor={244,125,35},
          ...
          Documentation(info="<html>
<p><b><span style=\"font-family: MS Shell Dlg 2;\">Syntax</span></b> </p>
<blockquote><b>y</b> = <b>IntegerEnsure</b>(<b>u</b> = condition, <b>tl</b> = time_period, <b>func</b> = IntegerFunction(<b>threshold</b> = integer_threshold, <b>tl </b>= tl)); </blockquote>
<p><b><span style=\"font-family: MS Shell Dlg 2;\">Description</span></b> </p>
<p>The purpose of this block is to generalize the <a href=\"modelica://ETL.Requirements.Ensure\">Ensure</a> block in order to evaluate requirements that take integer functions as arguments such as:</p>
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Function <b>func</b> can be chosen from the dialog box among predefined integer functions of the <a href=\"modelica://ETL.Requirements.Functions.MathInteger\">Functions</a> package. Currently, the only implemented integer function is the <a href=\"modelica://ETL.Requirements.Functions.MathInteger.EventCounter\">EventCounter</a>.</span></p>
<p><span style=\"font-family: MS Shell Dlg 2;\">The comparator to the <b>threshold</b> (e.g. &gt;, &lt;, etc.) can be chosen from the dialog box among the predefined integer comparators of the <a href=\"modelica://ETL.Requirements.Conditions.MathInteger\">Conditions</a> package.</span></p>
<p><br><b><span style=\"font-family: MS Shell Dlg 2;\">Example</span></b> </p>
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
</html>"));
      end IntegerEnsure;
      ...
      public
        ...
        replaceable model Function = Functions.Math.Boolean4Integrator
                                                                  annotation (Placement(transformation(extent={{-40,10},{-20,30}})),
          choices(choice(redeclare model Function =
                  ETL.Requirements.Functions.Math.Boolean4Integrator                              "Boolean4 integrator")));
        Function[N] genericFunction annotation (Placement(transformation(extent={{-50,-10}, {-30,10}})));
        replaceable model Condition = Conditions.Math.Greater annotation (Placement(transformation(extent={{0,10},{20,30}})),
          choices(choice(redeclare model Condition =
                  ETL.Requirements.Conditions.Math.Greater                                    ">"),
          choice(redeclare model Condition =
                  ETL.Requirements.Conditions.Math.GreaterEqual                            ">="),
          choice(redeclare model Condition =
                  ETL.Requirements.Conditions.Math.Lower                           "<"),
          choice(redeclare model Condition =
      ...
      equation
        ...
        connect(condition.decisionEvent, eval.a) annotation (Line(points={{11,8},{
                29,8}},                color={217,67,180}));
        connect(integerReplicator.y, condition.threshold) annotation (Line(points={{-69,
                -80},{-20,-80},{-20,-8},{-11,-8}}, color={0,0,0}));
        connect(genericFunction.y, condition.u)
          annotation (Line(points={{-29,0},{-20,0},{-20,8},{-11,8}}, color={0,0,0}));
        connect(threshold, integerReplicator.u)
          annotation (Line(points={{-110,-80},{-92,-80}}, color={0,0,0}));
        connect(genericFunction.ft, condition.ft) annotation (Line(points={{-40,
                -11},{-40,-20},{0,-20},{0,-11}}, color={102,44,145}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
          ...
          Documentation(info="<html>
<p><b><span style=\"font-family: MS Shell Dlg 2;\">Syntax</span></b> </p>
<blockquote><b>y</b> = <b>RealEnsure</b>(<b>u</b> = condition, <b>tl</b> = time_period, <b>func</b> = RealFunction(<b>threshold</b> = real_threshold, <b>tl </b>= tl)); </blockquote>
<p><b><span style=\"font-family: MS Shell Dlg 2;\">Description</span></b> </p>
<p>The purpose of this block is to generalize the <a href=\"modelica://ETL.Requirements.Ensure\">Ensure</a> block in order to evaluate requirements that take real functions as arguments such as:</p>
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Function <b>func</b> can be chosen from the dialog box among predefined real functions of the <a href=\"modelica://ETL.Requirements.Functions.Math\">Functions</a> package. Currently, the only implemented integer function is the <a href=\"modelica://ETL.Requirements.Functions.Math.Boolean4Integrator\">Boolean4Integrator</a>.</span></p>
<p><span style=\"font-family: MS Shell Dlg 2;\">The comparator to the <b>threshold</b> (e.g. &gt;, &lt;, etc.) can be chosen from the dialog box among the predefined integer comparators of the <a href=\"modelica://ETL.Requirements.Conditions.Math\">Conditions</a> package.</span></p>
<p><br><b><span style=\"font-family: MS Shell Dlg 2;\">Example</span></b> </p>
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
</html>"));
      end RealEnsure;
      ...
      package Functions
        ...
        package Math
          ...
          public
            ...
            Connectors.TimeLocatorInput tl
              annotation (Placement(transformation(extent={{-10,90},{10,110}})));
            Connectors.FunctionTypeOutput ft
              "Function type (monotonic increasing, monotonic decreasing, non monotonic)"
              annotation (Placement(transformation(
                  extent={{-10,-10},{10,10}},
                  rotation=-90,
                  origin={0,-110})));
          initial equation
            ...
            annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                    ...
                    lineColor={0,0,0},
                    textString="f",
                    textStyle={TextStyle.Italic})}),                       Diagram(
                  coordinateSystem(preserveAspectRatio=false)));
          end RealFunction;
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
        ...
        package MathInteger
          ...
          block EventCounter "Event counter"
            ...
            ETL.TimeLocators.Attributes.IsLeftBoundaryIncluded
              timePeriodIsLeftBoundaryIncluded annotation (Placement(
                  transformation(extent={{-64,26},{-56,34}})));
            ETL.TimeLocators.Attributes.IsRightBoundaryIncluded
              timePeriodIsRightBoundaryIncluded annotation (Placement(
                  transformation(extent={{-64,-34},{-56,-26}})));
          ...
          equation
            ft = FunctionType.monotonicIncreasing;
            connect(u, event4ToEvent.u)
              annotation (Line(points={{-110,0},{-94.4,0}}, color={162,29,33}));
            connect(tl, timePeriodStartingEvents.tl) annotation (Line(points={{0,100},
                    {0,50},{-88,50},{-88,42}},
                                        color={0,0,255}));
            connect(tl, timePeriodClosingEvents.tl) annotation (Line(points={{0,100},
                    {0,76},{0,76},{0,50},{-80,50},{-80,-12},{-88,-12},{-88,-34}},
                                          color={0,0,255}));
            connect(timePeriodStartingEvents.y, before1.u1) annotation (Line(points={{-83.6,
                    38},{-41,38}},                   color={217,67,180}));
            connect(event4ToEvent.y, before1.u2) annotation (Line(points={{-85.6,0},{-50,0},
                    {-50,22},{-41,22}}, color={217,67,180}));
            connect(event4ToEvent.y, before2.u1) annotation (Line(points={{-85.6,0},{-50,0},
                    {-50,-22},{-41,-22}}, color={217,67,180}));
            connect(timePeriodClosingEvents.y, before2.u2) annotation (Line(points={{-83.6,
                    -38},{-41,-38}},                     color={217,67,180}));
            connect(before1.y, and1.u1) annotation (Line(points={{-19,30},{-10,30},
                    {-10,8},{-4.8,8}},
                               color={217,67,180}));
            connect(before2.y, and1.u2) annotation (Line(points={{-19,-30},{-10,
                    -30},{-10,4.8},{-4.8,4.8}},
                                      color={217,67,180}));
            connect(timePeriodStartingEvents.y, before1.reset) annotation (Line(points={{-83.6,
                    38},{-70,38},{-70,10},{-30,10},{-30,19}}, color={217,67,180}));
            connect(timePeriodStartingEvents.y, before2.reset) annotation (Line(points={{-83.6,
                    38},{-70,38},{-70,-50},{-30,-50},{-30,-41}}, color={217,67,180}));
            connect(tl, timePeriodIsLeftBoundaryIncluded.tl) annotation (Line(points={{0,100},
                    {0,50},{-60,50},{-60,34}}, color={0,0,255}));
            connect(tl, timePeriodIsRightBoundaryIncluded.tl) annotation (Line(points={{0,100},
                    {0,50},{-80,50},{-80,-12},{-60,-12},{-60,-26}},
                                                       color={0,0,255}));
            connect(timePeriodIsLeftBoundaryIncluded.y, not1.u)
              annotation (Line(points={{-55.6,30},{-50.4,30}}, color={217,67,180}));
            connect(not1.y, before1.strictlyBefore)
              annotation (Line(points={{-45.8,30},{-41,30}}, color={255,0,255}));
            connect(timePeriodIsRightBoundaryIncluded.y, not2.u)
              annotation (Line(points={{-55.6,-30},{-50.4,-30}}, color={217,67,180}));
            connect(not2.y, before2.strictlyBefore)
              annotation (Line(points={{-45.8,-30},{-41,-30}}, color={255,0,255}));
            connect(eventFilter.y, eventCounter.u)
              annotation (Line(points={{41,0},{59,0}}, color={217,67,180}));
            connect(timePeriodStartingEvents.y, eventCounter.reset) annotation (
                Line(points={{-83.6,38},{-70,38},{-70,-50},{70,-50},{70,-11}},
                  color={217,67,180}));
            connect(and1.y, eventFilter.cond)
              annotation (Line(points={{4.4,8},{19,8}}, color={255,0,255}));
            connect(event4ToEvent.y, eventFilter.u)
              annotation (Line(points={{-85.6,0},{19,0}}, color={217,67,180}));
            connect(eventCounter.y, y)
            ...
            annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                    ...
                    fillColor={255,255,255},
                    fillPattern=FillPattern.Solid),
                  Line(points={{-94,0},{66,0}}, color={238,46,47}),
                  Line(points={{-74,26},{-74,0}}, color={238,46,47}),
                  Line(points={{-34,26},{-34,0}},  color={238,46,47}),
                  Line(points={{26,26},{26,0}},  color={238,46,47}),
                  Line(points={{56,26},{56,0}}, color={238,46,47}),
                  Line(points={{-94,-90},{-74,-90},{-74,-70},{-34,-70},{-34,-50},{26,-50},
                        {26,-30},{56,-30},{56,-10.0195},{76,-10}},
                                                                 color={244,125,35})}),
                                                                           Diagram(
                  coordinateSystem(preserveAspectRatio=false)),
              Documentation(info="<html>
      ...
      package Conditions
        ...
        package Math
          partial block RealCondition
            ...
            Connectors.FunctionTypeInput ft
              "Function type (monotonic increasing, monotonic decreasing, non monotonic)"
              annotation (Placement(transformation(
                  extent={{-10,-10},{10,10}},
                  rotation=90,
...
Real input u2, otherwise the output is <b>false</b>.
        ...
        package MathInteger
          partial block IntegerCondition
            ...
            Connectors.IntegerInput u
              annotation (Placement(transformation(extent={{-120,70},{-100,90}})));
            Connectors.IntegerInput threshold annotation (Placement(transformation(
                    extent={{-120,-90},{-100,-70}})));
            Connectors.Boolean4Output y
              annotation (Placement(transformation(extent={{100,-10},{120,10}})));
            Connectors.BooleanOutput decisionEvent
          ...
          equation
            ...
            annotation (Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,
                  ...
                  Text(
                    ...
                    fillPattern=FillPattern.Solid,
                    textString="%name"),
                  Line(points={{-50,10},{-2,10}}, color={244,125,35}),
                  Line(points={{-50,-10},{-2,-10}}, color={244,125,35})}),
                                      Documentation(info="<html>
<p>
The output is <b>true</b> if Real input u1 is greater than
Real input u2, otherwise the output is <b>false</b>.
          ...
          equation
            ...
            annotation (Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,
                  ...
                  Line(points={{-50,10},{-2,10}}, color={244,125,35}),
                  Line(points={{-50,-10},{-2,-10}}, color={244,125,35}),
                  Line(points={{-44,-22},{-8,22}},color={244,125,35})}),
                                      Documentation(info="<html>
<p>
The output is <b>true</b> if Real input u1 is greater than
Real input u2, otherwise the output is <b>false</b>.
    ...
    package Evaluator
      ...
      block Eval
        ...
        Connectors.Boolean4Input u
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
        Connectors.TimeLocatorInput tl
          annotation (Placement(transformation(extent={{-10,90},{10,110}})));
        Connectors.Boolean4Output y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        Connectors.BooleanInput a
          annotation (Placement(transformation(extent={{-120,70},{-100,90}})));
        Decide decide
          annotation (Placement(transformation(extent={{-60,20},{-40,40}})));
        Integrate integrate
          annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
      equation
        connect(a, decide.u) annotation (Line(points={{-110,80},{-90,80},{-90,30},
                {-61,30}}, color={217,67,180}));
        connect(tl, decide.tl) annotation (Line(points={{0,100},{0,60},{-50,60},{
                -50,40}}, color={0,0,255}));
        connect(decide.y, integrate.a) annotation (Line(points={{-39,30},{-30,30},
                {-30,8},{-11,8}}, color={217,67,180}));
      ...
      block Integrate
        ...
        Diff diff
          annotation (Placement(transformation(extent={{-60,-10},{-40,10}})));
        Mul mul annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
        Connectors.BooleanInput a
          annotation (Placement(transformation(extent={{-120,70},{-100,90}})));
        Trim trim
          annotation (Placement(transformation(extent={{-84,-4},{-76,4}})));
      equation
        connect(accumulate.y, y)
          annotation (Line(points={{61,0},{110,0}},         color={162,29,33}));
        connect(tl, accumulate.tl) annotation (Line(points={{0,100},{0,60},{50,60},
                {50,10}},color={0,0,255}));
        connect(diff.y, mul.u2) annotation (Line(points={{-39,0},{-20,0},{-20,-8},
                {-11,-8}}, color={162,29,33}));
        connect(mul.y, accumulate.u)
          annotation (Line(points={{11,0},{39,0}}, color={162,29,33}));
        connect(u, trim.u)
          annotation (Line(points={{-110,0},{-84.4,0}}, color={162,29,33}));
        connect(trim.y, diff.u)
          annotation (Line(points={{-75.6,0},{-61,0}}, color={162,29,33}));
        connect(tl, trim.tl) annotation (Line(points={{0,100},{0,60},{-80,60},{-80,
                4}}, color={0,0,255}));
        connect(a, mul.u1) annotation (Line(points={{-110,80},{-20,80},{-20,8},{
                -11,8}}, color={217,67,180}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
                fillColor={255,213,170},
      ...
      public
        ...
        Connectors.TimeLocatorInput tl
          annotation (Placement(transformation(extent={{-10,90},{10,110}})));
      equation
        y = if tl.timePeriod then u else Boolean4.undefined;
        annotation (Icon(coordinateSystem(initialScale=0.04),         graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
                fillColor={255,213,170},
                ...
                borderPattern=BorderPattern.Raised,
                lineColor={0,0,0}),
              Line(points={{-86,20},{-50,20},{-50,64},{60,64},{60,18},{88,18}},
                  color={0,0,0}),
              Line(points={{-82,-60},{-46,-60},{-46,-16},{64,-16},{64,-62},{92,
                    -62}},
                  color={162,29,33})}),                             Diagram(
              coordinateSystem(initialScale=0.04)));
      end Trim;
      ...
      block Diff
        ...
        Connectors.Boolean4Output y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        Connectors.Boolean4Input u(start=Boolean4.undefined, fixed=true)
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
      equation
        y = TemporalOperators.diff4(u, pre(u));
        annotation (Placement(transformation(extent={{-120,-10},{-100,10}})),
                    Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
      ...
      block Mul "Multiplication operator "

        Connectors.BooleanInput  u1 annotation (Placement(transformation(
                extent={{-120,70},{-100,90}}), iconTransformation(extent={{-120,70},{-100,
                  90}})));
        Connectors.Boolean4Input u2 annotation (Placement(transformation(
                extent={{-120,-90},{-100,-70}}), iconTransformation(extent={{-120,-90},
                  {-100,-70}})));
        Connectors.Boolean4Output y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      equation
        y = TemporalOperators.mul2x4(u1, u2);
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
                fillColor={255,213,170},
      ...
      equation
        x = if edge(tl.timePeriod) then Blocks.Logical4.and4(pre(x), u) else
          TemporalOperators.add4(pre(x), u);
        y = x;
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
      ...
      public
        ...
        Modelica.Blocks.Logical.Or and1
          annotation (Placement(transformation(extent={{40,-10},{60,10}})));
        ETL.TimeLocators.Attributes.PeriodEnd End
          annotation (Placement(transformation(extent={{-4,-4},{4,4}})));
      equation
        connect(u, and1.u2) annotation (Line(points={{-110,0},{-66,0},{-66,-8},{
                38,-8}}, color={217,67,180}));
        connect(and1.y, y)
          annotation (Line(points={{61,0},{110,0}}, color={255,0,255}));
        connect(End.y, and1.u1) annotation (Line(points={{4.4,0},{38,0}},
                         color={217,67,180}));
        connect(tl, End.tl)
          annotation (Line(points={{0,100},{0,4}}, color={0,0,255}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
    ...
    package Connectors
      connector Boolean4Input = input CRML.ETL.Types.Boolean4
                                                         "'Boolean4' as input" annotation (
        ...
        "'Boolean4' as output"                                                          annotation (
          Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
            graphics={Polygon(
              ...
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid)}));
      connector TimeLocatorInput = input CRML.ETL.Types.TimeLocator
                                                               "'Time Locator' as input"
                                                                                        annotation (
          Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,
                100}}), graphics={Rectangle(
              extent={{-100,100},{100,-100}},
      ...
      connector TimeLocatorOutput = output CRML.ETL.Types.TimeLocator
                                                                 "'Time Locator' as output"
                                                                                           annotation (
         Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
            graphics={Rectangle(
              extent={{-100,100},{100,-100}},
              ...
              fillColor={170,213,255},
              fillPattern=FillPattern.Forward)}));
      connector WhileInput = input CRML.ETL.Types.WhileLocator
                                                          "'While'' as input"
                                                                             annotation (
          Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,
                100}}), graphics={Rectangle(
              ...
              fillColor={0,255,0},
              fillPattern=FillPattern.Forward)}));
      connector WhileOutput = output CRML.ETL.Types.WhileLocator
                                                            "'While' as output"
                                                                               annotation (
         Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
            graphics={Rectangle(
      ...
      connector RealOutput = output Real "'Real' as output" annotation (
          ...
          Polygon(
              ...
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid)}));
      connector ClockInput = input Clock "'input Clock' as connector" annotation (defaultComponentName="u",
...
Connector with one input signal of type Boolean.
      ...
      connector ClockOutput = output Clock "'output Clock' as connector" annotation (defaultComponentName="y",
        Icon(coordinateSystem(
              preserveAspectRatio=true,
              extent={{-100,-100},{100,100}},
              grid={2,2},
...
Connector with one output signal of type Boolean.
      ...
      connector FunctionTypeInput =  input CRML.ETL.Types.FunctionType
                                                                  "Function type input"                                                                  annotation (
          Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
            graphics={Polygon(
              points={{-100,100},{-100,-100},{100,0},{-100,100}},
...
I = { 1, 2, 7, 6, 4, 3, 5, 8, 9, 10 };</pre>
      ...
      algorithm
        ...
        while true loop
          while true loop
            ...
            if B[j] <= x then break; end if;
          end while;

          while true loop
            i := i + 1;
            if i == size(B,1) + 1 then break; end if;
            if B[i] >= x then break; end if;
          end while;
      ...
      a = cos(alpha) and b = sin(alpha) where alpha is the edge angle from the x-axis */
        ...
        if (r == -1) then insidePolygon := -1; return; end if;
  ...
  Ray direction is the bissector of the largest polygon angle */
        ...
        if (n == -1) then insidePolygon := -1; return; end if;
  ...
  point is odd */
        ...
        annotation (Diagram(graphics={     Ellipse(
                ...
                fillPattern=FillPattern.Solid),
              Polygon(
                points={{-92,-4},{-64,24},{-60,-14},{-42,24},{-24,-34},{60,-44},{2,8},
                    {44,18},{8,84},{-74,82},{-92,-4}},
                lineColor={238,46,47},
                fillColor={28,108,200},
                fillPattern=FillPattern.None),
              Text(
              ...
              Text(
                extent={{-50,-10},{4,-16}},
                lineColor={28,108,200},
                textString="Point")}), Documentation(info="<html>
<h4>Syntax</h4>
...
<pre>returns z &gt; 0.5; (cf. graphics in diagram layer)</pre>
  ...
  polygon vertices. The consecutive point of the last point is the first point*/
        for i in 1:size(polygon,1) loop
         ...
         if d < tolerance then n := -1; return; end if;
      ...
      function intersectionsPolygonLine
    ...
    Otherwise, it is undecided whether the ray intersects the edge or not */
          if abs(t) < tolerance or abs(1 - t) < tolerance then n := -1; return; end if;
    ...
    package Tests
      ...
      equation
        ...
        connect(eventTable1.y, booleanToBoolean4_3.u) annotation (Line(points={{-59,30},
                {-50,30},{-50,42},{-44.4,42}},         color={217,67,180}));
      ...
      model EnsureAllAlong
        ...
        Blocks.Events.EventTable eventTable1(option_width=false, instant={10})
          annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
        Requirements.IntegerEnsure ensure(                          redeclare
            model
            Function = ETL.Requirements.Functions.MathInteger.EventCounter,
            redeclare model Condition =
              ETL.Requirements.Conditions.MathInteger.IntegerEqual)
      ...
      equation
        ...
        connect(eventTable.y, booleanToBoolean4_2.u) annotation (Line(points={{-59,60},
                {-50,60},{-50,50},{-44.4,50}},         color={217,67,180}));
        connect(booleanToBoolean4_2.y, timePeriod.u1)
          annotation (Line(points={{-35.6,50},{-1,50}},  color={162,29,33}));
        connect(eventTable1.y, booleanToBoolean4_3.u) annotation (Line(points={{-59,30},
                {-50,30},{-50,42},{-44.4,42}},         color={217,67,180}));
        connect(booleanToBoolean4_3.y, timePeriod.u2)
          annotation (Line(points={{-35.6,42},{-1,42}},  color={162,29,33}));
        connect(integerConstant.y, ensure.threshold) annotation (Line(points={{
                -59,-70},{-40,-70},{-40,-38},{-1,-38}}, color={255,127,0}));
        connect(booleanToBoolean4_1.y, not4_1.u)
          annotation (Line(points={{-35.6,-30},{-26.6,-30}}, color={162,29,33}));
        connect(not4_1.y, ensure.u)
          annotation (Line(points={{-13.4,-30},{-1,-30}}, color={162,29,33}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      model IntegerEnsure
        ...
        Requirements.IntegerEnsure ensure(redeclare model Function =
              ETL.Requirements.Functions.MathInteger.EventCounter, redeclare
            model
            Condition =
              ETL.Requirements.Conditions.MathInteger.IntegerGreaterEqual)
      ...
      equation
        ...
        connect(booleanToBoolean4_2.y, timePeriod.u1)
          annotation (Line(points={{-35.6,10},{-21,10}}, color={162,29,33}));
        connect(eventTable1.y, booleanToBoolean4_3.u) annotation (Line(points={{-59,-10},
                {-50,-10},{-50,2},{-44.4,2}},          color={217,67,180}));
        ...
        connect(While.y, timePeriod.tl) annotation (Line(points={{-10,40},{-10,20}},
                           color={0,0,255}));
        connect(booleanToBoolean4_3.y, timePeriod.u2)
          annotation (Line(points={{-35.6,2},{-21,2}},   color={162,29,33}));
        connect(booleanToBoolean4_5.y, While1.u)
          annotation (Line(points={{-35.6,90},{-21,90}}, color={162,29,33}));
        connect(booleanPulse1.y, booleanToBoolean4_5.u)
          annotation (Line(points={{-59,90},{-44.4,90}}, color={217,67,180}));
        connect(booleanToBoolean4_1.y, ensure.u)
          annotation (Line(points={{-35.6,-40},{-21,-40}}, color={162,29,33}));
        connect(timePeriod.y, ensure.tl)
          annotation (Line(points={{-10,0},{-10,-30},{-10,-30}}, color={0,0,255}));
        connect(integerConstant.y, ensure.threshold) annotation (Line(points={{-59,-70},
                {-30,-70},{-30,-48},{-21,-48}}, color={255,127,0}));
        connect(eventPeriodic.y, showEvent.u) annotation (Line(points={{-59,-40},
                {-52,-40},{-52,-28},{-46.4,-28}}, color={217,67,180}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      model RealEnsure
        ...
        Blocks.Math.Constant               integerConstant
          annotation (Placement(transformation(extent={{-80,-80},{-60,-60}})));
        Requirements.RealEnsure ensure(redeclare model Function =
      ...
      model DiscreteTimeLocator
        TimeLocators.Periods timePeriod(durationSpecified=true,
            discreteClockSpecified=true)
      ...
      equation
        connect(eventPeriodic.y, booleanToBoolean4_1.u)
          annotation (Line(points={{-59,-90},{-52,-90},{-52,-70},{-44.4,-70}},
                                                           color={217,67,180}));
        connect(booleanToBoolean4_1.y, ensure.u)
        ...
        connect(booleanToBoolean4_2.y, timePeriod.u1)
          annotation (Line(points={{-35.6,0},{-1,0}},    color={162,29,33}));
        connect(eventTable1.y, booleanToBoolean4_3.u) annotation (Line(points={{-59,-60},
                {-44.4,-60}},                          color={217,67,180}));
        connect(booleanPulse.y, booleanToBoolean4_5.u)
          annotation (Line(points={{-59,40},{-44.4,40}},
                                                     color={217,67,180}));
        connect(booleanToBoolean4_5.y, While1.u)
          annotation (Line(points={{-35.6,40},{-1,40}}, color={162,29,33}));
        connect(timePeriod.y, showDiscreteTimePeriods.tl) annotation (Line(points={{10,-10},
                {10,-20},{30,-20},{30,-28}},      color={0,0,255}));
        connect(eventPeriodic1.y, showEvent.u) annotation (Line(points={{-59,80},
                {-52,80},{-52,68},{-42.4,68}}, color={217,67,180}));
        connect(eventPeriodic1.y, booleanToBoolean4_4.u) annotation (Line(points={{-59,80},
                {-44.4,80}},                             color={217,67,180}));
        connect(booleanToBoolean4_4.y, timePeriod.clock) annotation (Line(points={{-35.6,
                80},{-20,80},{-20,8},{-1,8}},       color={162,29,33}));
        connect(booleanPulse1.y, booleanToBoolean4_6.u)
          annotation (Line(points={{21,80},{35.6,80}}, color={217,67,180}));
        connect(booleanToBoolean4_6.y, While.u)
      ...
      model AfterFor
        ...
        Blocks.MathInteger.IntegerConstant integerConstant(K=5)
          annotation (Placement(transformation(extent={{-80,-80},{-60,-60}})));
        Requirements.IntegerEnsure ensure(redeclare model Function =
              ETL.Requirements.Functions.MathInteger.EventCounter,
            redeclare model Condition =
              ETL.Requirements.Conditions.MathInteger.IntegerGreaterEqual)
          annotation (Placement(transformation(extent={{-20,-40},{0,-20}})));
        ReqSysPro.Conditions.CheckInPCount check(criteria=">=")
      ...
      model When1
        ...
        TimeLocators.ShowDiscreteWhile showDiscreteTimeWhile
          annotation (Placement(transformation(extent={{44,-96},{52,-88}})));
      equation
        connect(eventPeriodic.y, booleanToBoolean4_1.u)
          annotation (Line(points={{-59,-30},{-44.4,-30}}, color={217,67,180}));
        connect(booleanToBoolean4_1.y, ensure.u)
        ...
        connect(continuousTimeWhile.y, showDiscreteTimeWhile.tl) annotation (Line(
              points={{10,-90},{10,-94},{34,-94},{34,-84},{48,-84},{48,-88}},
              color={0,0,255}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
      ...
      equation
        ...
        connect(booleanToBoolean4_1.y, While1.u) annotation (Line(points={{-35.6,
                -30},{-30,-30},{-30,-80},{-1,-80}}, color={162,29,33}));
        connect(While1.y, showDiscreteTimeWhile.tl) annotation (Line(points={{
                10,-90},{10,-94},{34,-94},{34,-84},{48,-84},{48,-88}}, color={0,
                0,255}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
      ...
      equation
        ...
        connect(booleanToBoolean4_1.y, ensure.u)
          annotation (Line(points={{-15.6,-50},{19,-50}},  color={162,29,33}));
        connect(timePeriod.y, ensure.tl)
          annotation (Line(points={{30,-20},{30,-40}},            color={0,0,255}));
        connect(booleanToBoolean4_4.y, While.u)
          annotation (Line(points={{4.4,70},{19,70}},    color={162,29,33}));
        connect(integerConstant.y, ensure.threshold) annotation (Line(points={{
                -59,-90},{0,-90},{0,-58},{19,-58}}, color={255,127,0}));
        connect(booleanPulse.y, or1.u1) annotation (Line(points={{-59,70},{-50,70},
                {-50,30},{-42,30}}, color={217,67,180}));
        connect(eventPeriodic.y, or1.u2) annotation (Line(points={{-59,-50},{-50,
                -50},{-50,22},{-42,22}}, color={217,67,180}));
        connect(or1.y, booleanToBoolean4_2.u)
        ...
        connect(eventPeriodic.y, showEvent.u) annotation (Line(points={{-59,-50},
                {-30,-50},{-30,-32},{-24.4,-32}}, color={217,67,180}));
        connect(const.y, timePeriod.continuousDuration) annotation (Line(points=
               {{-59,-10},{-20,-10},{-20,-18},{19,-18}}, color={0,0,0}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      equation
        connect(eventPeriodic.y, booleanToBoolean4_1.u)
          annotation (Line(points={{-59,-40},{-52,-40},{-52,-30},{-44.4,-30}},
                                                           color={217,67,180}));
        connect(booleanToBoolean4_1.y, ensure.u)
          annotation (Line(points={{-35.6,-30},{39,-30}},  color={162,29,33}));
        connect(timePeriod.y, ensure.tl)
        ...
        connect(booleanToBoolean4_2.y, timePeriod.u1)
          annotation (Line(points={{30.4,50},{39,50}},   color={162,29,33}));
        connect(booleanPulse.y, booleanToBoolean4_4.u)
          annotation (Line(points={{-59,90},{-44.4,90}}, color={217,67,180}));
        connect(booleanToBoolean4_4.y, While.u)
        ...
        connect(eventTable.y, showEvent.u) annotation (Line(points={{-59,50},{-50,
                50},{-50,60},{-44.4,60}}, color={217,67,180}));
        connect(eventDelay.y, showEvent1.u) annotation (Line(points={{-9,50},{-4,
                50},{-4,22},{7.6,22}}, color={217,67,180}));
        connect(eventTable.y, eventDelay.u)
      ...
      equation
        connect(const1.y, eventDelay.delay) annotation (Line(points={{-79,20},{
                -60,20},{-60,42},{-51,42}},
                                        color={0,0,0}));
        connect(eventTable.y, showEvent.u) annotation (Line(points={{-79,50},{-70,
                50},{-70,60},{-64.4,60}}, color={217,67,180}));
        connect(eventDelay.y, showEvent1.u) annotation (Line(points={{-29,50},{
                -24,50},{-24,30},{-14.4,30}},
                                       color={217,67,180}));
        connect(eventTable.y, eventDelay.u)
          annotation (Line(points={{-79,50},{-51,50}}, color={217,67,180}));
        connect(booleanTable.y, booleanDelay.u) annotation (Line(points={{-79,-40},
                {-49,-40}},                     color={217,67,180}));
        connect(const1.y, booleanDelay.delay) annotation (Line(points={{-79,20},{
                -60,20},{-60,-48},{-49,-48}}, color={0,0,0}));
        connect(integerConstant.y, booleanClockedDelay.delay) annotation (Line(
              points={{21,-90},{30,-90},{30,-78},{59,-78}}, color={255,127,0}));
        connect(booleanTable.y, booleanClockedDelay.u) annotation (Line(points={{-79,-40},
                {-70,-40},{-70,-70},{59,-70}},          color={217,67,180}));
        connect(eventPeriodic.y, booleanClockedDelay.clock) annotation (Line(
              points={{21,-50},{30,-50},{30,-62},{59,-62}}, color={217,67,180}));
        connect(eventPeriodic.y, showEvent2.u) annotation (Line(points={{21,-50},
                {30,-50},{30,-40},{35.6,-40}}, color={217,67,180}));
        connect(integerConstant.y, eventClockedDelay.delay) annotation (Line(
              points={{21,-90},{48,-90},{48,2},{59,2}}, color={255,127,0}));
        connect(eventTable.y, eventClockedDelay.u) annotation (Line(points={{-79,
                50},{-70,50},{-70,10},{59,10}}, color={217,67,180}));
        connect(eventPeriodic1.y, eventClockedDelay.clock) annotation (Line(
              points={{41,30},{50,30},{50,18},{59,18}}, color={217,67,180}));
        connect(eventPeriodic1.y, showEvent3.u) annotation (Line(points={{41,30},
                {50,30},{50,40},{67.6,40}}, color={217,67,180}));
        connect(eventClockedDelay.y, showEvent4.u)
          annotation (Line(points={{81,10},{87.6,10}}, color={217,67,180}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      model SlidingRandom
        ...
        inner Blocks.Logical.GlobalSeed globalSeed(fixedSeed=111111,
          ...
          annotation (Placement(transformation(extent={{-80,-20},{-60,0}})));
      equation
        connect(failure.y, booleanToBoolean4_1.u)
          annotation (Line(points={{-19,-50},{27.6,-50}}, color={217,67,180}));
        connect(booleanToBoolean4_1.y, ensure.u)
          annotation (Line(points={{36.4,-50},{59,-50}},   color={162,29,33}));
        connect(timePeriod.y, ensure.tl)
          annotation (Line(points={{70,-20},{70,-40}},            color={0,0,255}));
        connect(integerConstant.y, ensure.threshold) annotation (Line(points={{41,-70},
                {50,-70},{50,-58},{59,-58}},        color={255,127,0}));
        connect(or1.y,booleanToBoolean4_3. u)
          annotation (Line(points={{21,30},{35.6,30}},  color={255,0,255}));
        connect(booleanPulse.y, or1.u1) annotation (Line(points={{-39,30},{-2,30}},
                                    color={217,67,180}));
        connect(failure.y, or1.u2) annotation (Line(points={{-19,-50},{-10,-50},{
                -10,22},{-2,22}},  color={255,0,255}));
        connect(booleanToBoolean4_3.y, timePeriod.u1) annotation (Line(points={{44.4,30},
                {50,30},{50,-10},{59,-10}},          color={162,29,33}));
        connect(or1.y, showEvent.u) annotation (Line(points={{21,30},{28,30},{28,
                50},{35.6,50}}, color={255,0,255}));
        connect(booleanPulse1.y, booleanToBoolean4_2.u)
          annotation (Line(points={{-39,70},{-4.4,70}}, color={217,67,180}));
        connect(booleanToBoolean4_2.y, While.u)
          annotation (Line(points={{4.4,70},{59,70}}, color={162,29,33}));
        connect(While.y, timePeriod.tl)
          annotation (Line(points={{70,60},{70,0}}, color={0,0,255}));
        connect(integerConstant1.y, failure.failureRate)
          annotation (Line(points={{-59,-50},{-41,-50}}, color={0,0,0}));
        connect(integerConstant1.y, failure.repairRate) annotation (Line(points={
                {-59,-50},{-50,-50},{-50,-58},{-41,-58}}, color={0,0,0}));
        connect(const.y, timePeriod.continuousDuration) annotation (Line(points=
               {{31,-10},{44,-10},{44,-18},{59,-18}}, color={0,0,0}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      equation
        connect(clock1.y, showClock1.u) annotation (Line(points={{-79,70},{-70,70},
                {-70,80},{-64.4,80}}, color={217,67,180}));
        connect(event1.y, showEvent1.u) annotation (Line(points={{-79,40},{-70,40},
                {-70,50},{-64.4,50}}, color={217,67,180}));
        connect(event1.y, eventProjection.u) annotation (Line(points={{-79,40},{
                -50,40},{-50,50},{-41,50}}, color={217,67,180}));
        connect(clock1.y, eventProjection.clock) annotation (Line(points={{-79,70},
                {-50,70},{-50,58},{-41,58}}, color={217,67,180}));
        connect(eventProjection.y, showEvent1ProjClock1.u)
          annotation (Line(points={{-19,50},{43.6,50}}, color={217,67,180}));
        connect(booleanToBoolean4_2.y, afterBefore.u1)
          annotation (Line(points={{24.4,10},{39,10}},    color={162,29,33}));
        connect(booleanToBoolean4_1.y, afterBefore.u2)
          annotation (Line(points={{24.4,2},{39,2}},      color={162,29,33}));
        connect(booleanToBoolean4_4.y, afterFor.u1)
          annotation (Line(points={{24.4,-30},{39,-30}}, color={162,29,33}));
        connect(event2.y, booleanToBoolean4_1.u) annotation (Line(points={{-77,
                -10},{8,-10},{8,2},{15.6,2}}, color={217,67,180}));
        connect(eventProjection.y, booleanToBoolean4_2.u) annotation (Line(points=
               {{-19,50},{0,50},{0,10},{15.6,10}}, color={217,67,180}));
        connect(event2.y, showEvent2.u) annotation (Line(points={{-77,-10},{-60,
                -10},{-60,0},{-54.4,0}}, color={217,67,180}));
        connect(eventProjection.y, booleanToBoolean4_4.u) annotation (Line(points=
               {{-19,50},{0,50},{0,-30},{15.6,-30}}, color={217,67,180}));
        connect(const.y, afterFor.continuousDuration) annotation (Line(points={
                {-39,-50},{0,-50},{0,-38},{39,-38}}, color={0,0,0}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      model TimeLocator
        ...
        TimeLocators.Attributes.PeriodsEnd timeLocatorStartingEvents
          annotation (Placement(transformation(extent={{66,-56},{74,-48}})));
        Blocks.Events.ShowEvent showEvent4
          annotation (Placement(transformation(extent={{86,-56},{94,-48}})));
        Evaluator.Decide decide
          annotation (Placement(transformation(extent={{40,-80},{60,-60}})));
        Blocks.Events.ShowEvent showEvent3
          annotation (Placement(transformation(extent={{86,-74},{94,-66}})));
      equation
        connect(clock1.y, showClock1.u) annotation (Line(points={{-79,70},{-70,70},
                {-70,80},{-64.4,80}}, color={217,67,180}));
        connect(event1.y, showEvent1.u) annotation (Line(points={{-79,40},{-70,40},
        ...
        connect(booleanToBoolean4_4.y, afterFor.u1)
          annotation (Line(points={{24.4,-30},{39,-30}}, color={162,29,33}));
        connect(event2.y, booleanToBoolean4_1.u) annotation (Line(points={{-79,0},
                {8,0},{8,2},{15.6,2}}, color={217,67,180}));
        connect(eventProjection.y, booleanToBoolean4_2.u) annotation (Line(points=
               {{-19,50},{0,50},{0,10},{15.6,10}}, color={217,67,180}));
        connect(event2.y, showEvent2.u) annotation (Line(points={{-79,0},{-60,0},
                {-60,8},{-54.4,8}}, color={217,67,180}));
        connect(eventProjection.y, booleanToBoolean4_4.u) annotation (Line(points=
               {{-19,50},{0,50},{0,-30},{15.6,-30}}, color={217,67,180}));
        connect(booleanToBoolean4_3.y, afterFor.clock)
          annotation (Line(points={{24.4,-22},{39,-22}}, color={162,29,33}));
        connect(eventPeriodic.y, booleanToBoolean4_3.u) annotation (Line(points={
                {-19,-20},{8,-20},{8,-22},{15.6,-22}}, color={217,67,180}));
        connect(integerConstant.y, afterFor.discreteDuration) annotation (Line(
              points={{-19,-50},{10,-50},{10,-38},{39,-38}}, color={255,127,0}));
        connect(afterFor.y, timeLocatorStartingEvents.tl) annotation (Line(points=
               {{50,-40},{50,-44},{70,-44},{70,-48}}, color={0,0,255}));
        connect(timeLocatorStartingEvents.y, showEvent4.u) annotation (Line(
              points={{74.4,-52},{80,-52},{80,-52},{85.6,-52}}, color={217,67,180}));
        connect(booleanStep.y, decide.u)
          annotation (Line(points={{21,-70},{39,-70}}, color={217,67,180}));
        connect(afterFor.y[1], decide.tl)
          annotation (Line(points={{50,-40},{50,-60}}, color={0,0,255}));
        connect(decide.y, showEvent3.u)
          annotation (Line(points={{61,-70},{85.6,-70}}, color={217,67,180}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      equation
        connect(event1.y, showEvent1.u) annotation (Line(points={{-79,40},{-60,40},
                {-60,48},{-54.4,48}}, color={217,67,180}));
        connect(event2.y, showEvent2.u) annotation (Line(points={{-79,0},{-60,0},
                {-60,10},{-54.4,10}},
                                    color={217,67,180}));
        connect(event1.y, elapsedTime.u1) annotation (Line(points={{-79,40},{-30,
                40},{-30,28},{-21,28}}, color={217,67,180}));
        connect(event2.y, elapsedTime.u2) annotation (Line(points={{-79,0},{-30,0},
                {-30,12},{-21,12}}, color={217,67,180}));
        connect(event1.y, elapsedTime.reset) annotation (Line(points={{-79,40},{
                -40,40},{-40,-10},{-10,-10},{-10,9}}, color={217,67,180}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      model EventCounter
        ...
        Blocks.Logical.BooleanPulse eventPeriodic
          annotation (Placement(transformation(extent={{-100,-50},{-80,-30}})));
        Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_1
          annotation (Placement(transformation(extent={{-64,-44},{-56,-36}})));
        Blocks.Events.ShowEvent showEvent2
          annotation (Placement(transformation(extent={{-54,-64},{-46,-56}})));
        Requirements.Functions.MathInteger.EventCounter eventCounter
        ...
        Blocks.Events.EventCounter eventCounter1_1
          annotation (Placement(transformation(extent={{60,-50},{80,-30}})));
      equation
        connect(eventTable.y,booleanToBoolean4_2. u) annotation (Line(points={{-79,30},
                {-70,30},{-70,20},{-64.4,20}},         color={217,67,180}));
        connect(booleanToBoolean4_2.y,timePeriod. u1)
          annotation (Line(points={{-55.6,20},{-41,20}}, color={162,29,33}));
        connect(eventTable1.y,booleanToBoolean4_3. u) annotation (Line(points={{-79,0},
                {-70,0},{-70,12},{-64.4,12}},          color={217,67,180}));
        connect(booleanToBoolean4_3.y,timePeriod. u2)
          annotation (Line(points={{-55.6,12},{-41,12}}, color={162,29,33}));
        connect(booleanToBoolean4_1.y, eventCounter.u)
          annotation (Line(points={{-55.6,-40},{-41,-40}}, color={162,29,33}));
        connect(timePeriod.y[1], eventCounter.tl)
          annotation (Line(points={{-30,10},{-30,-30}},  color={0,0,255}));
        connect(eventPeriodic.y, booleanToBoolean4_1.u)
          annotation (Line(points={{-79,-40},{-64.4,-40}}, color={217,67,180}));
        connect(eventPeriodic.y, showEvent2.u) annotation (Line(points={{-79,-40},
                {-72,-40},{-72,-60},{-54.4,-60}}, color={217,67,180}));
        connect(eventPeriodic.y, eventFilter.u) annotation (Line(points={{-79,-40},
                {-72,-40},{-72,-20},{29,-20}}, color={217,67,180}));
        connect(eventFilter.cond, booleanPulse1.y) annotation (Line(points={{29,
                -12},{20,-12},{20,0},{11,0}}, color={217,67,180}));
        connect(eventFilter.y, showEvent3.u)
          annotation (Line(points={{51,-20},{67.6,-20}}, color={217,67,180}));
        connect(eventFilter.y, eventCounter1_1.u) annotation (Line(points={{51,
                -20},{56,-20},{56,-40},{59,-40}}, color={217,67,180}));
        connect(booleanPulse1.y, eventCounter1_1.reset) annotation (Line(points={
                {11,0},{20,0},{20,-60},{70,-60},{70,-51}}, color={217,67,180}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      model CheckCount
        ...
        Requirements.IntegerEnsure ensure1(redeclare model Function =
              ETL.Requirements.Functions.MathInteger.EventCounter,
            redeclare model Condition =
              ETL.Requirements.Conditions.MathInteger.IntegerGreaterEqual)
          annotation (Placement(transformation(extent={{-20,-20},{0,0}})));
        Requirements.IntegerEnsure ensure2(redeclare model Function =
              ETL.Requirements.Functions.MathInteger.EventCounter,
            redeclare model Condition =
              ETL.Requirements.Conditions.MathInteger.IntegerLowerEqual)
      ...
      equation
        ...
        connect(integerConstant.y,ensure. threshold) annotation (Line(points={{-59,0},
                {-40,0},{-40,22},{-21,22}},     color={255,127,0}));
        connect(eventTable.y,booleanToBoolean4_2. u) annotation (Line(points={{-59,90},
                {-50,90},{-50,80},{-44.4,80}},         color={217,67,180}));
        connect(booleanToBoolean4_2.y,timePeriod. u1)
          annotation (Line(points={{-35.6,80},{-21,80}}, color={162,29,33}));
        connect(eventTable1.y,booleanToBoolean4_3. u) annotation (Line(points={{-59,60},
                {-50,60},{-50,72},{-44.4,72}},         color={217,67,180}));
        connect(booleanToBoolean4_3.y,timePeriod. u2)
          annotation (Line(points={{-35.6,72},{-21,72}}, color={162,29,33}));
        connect(integerConstant.y, ensure1.threshold) annotation (Line(points={{
                -59,0},{-40,0},{-40,-18},{-21,-18}}, color={255,127,0}));
        connect(integerConstant.y, ensure2.threshold) annotation (Line(points={{
                -59,0},{-40,0},{-40,-58},{-21,-58}}, color={255,127,0}));
        connect(booleanToBoolean4_1.y, ensure1.u) annotation (Line(points={{-35.6,
                30},{-30,30},{-30,-10},{-21,-10}}, color={162,29,33}));
        connect(booleanToBoolean4_1.y, ensure2.u) annotation (Line(points={{-35.6,
                30},{-30,30},{-30,-50},{-21,-50}}, color={162,29,33}));
        connect(timePeriod.y, ensure1.tl) annotation (Line(points={{-10,70},{-10,
                50},{10,50},{10,10},{-10,10},{-10,0}}, color={0,0,255}));
        connect(timePeriod.y, ensure2.tl) annotation (Line(points={{-10,70},{-10,
                50},{10,50},{10,-30},{-10,-30},{-10,-40}}, color={0,0,255}));
        connect(ensure1.y, and4.u1) annotation (Line(points={{1,-10},{20,-10},{20,
                -22},{39,-22}}, color={162,29,33}));
        connect(ensure2.y, and4.u2) annotation (Line(points={{1,-50},{20,-50},{20,
                -38},{39,-38}}, color={162,29,33}));
        connect(eventPeriodic.y, showEvent.u) annotation (Line(points={{-59,30},{
                -50,30},{-50,50},{-34.4,50}}, color={217,67,180}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      model Master
        ...
        Requirements.IntegerEnsure ensure1(                         redeclare
            model Function =
                       ETL.Requirements.Functions.MathInteger.EventCounter,
            redeclare model Condition =
              ETL.Requirements.Conditions.MathInteger.IntegerEqual)
        ...
        CRML.Blocks.Events.TimeFrom timeFrom
      ...
      equation
        ...
        connect(eventTable.y, booleanToBoolean4_2.u) annotation (Line(points={{-79,50},
                {-70,50},{-70,40},{-64.4,40}},         color={217,67,180}));
        connect(booleanToBoolean4_2.y, timePeriod.u1)
          annotation (Line(points={{-55.6,40},{-41,40}}, color={162,29,33}));
        connect(eventTable1.y, booleanToBoolean4_3.u) annotation (Line(points={{-79,20},
                {-70,20},{-70,32},{-64.4,32}},         color={217,67,180}));
        connect(booleanToBoolean4_3.y, timePeriod.u2)
          annotation (Line(points={{-55.6,32},{-41,32}}, color={162,29,33}));
        connect(eventPeriodic1.y, booleanToBoolean4_4.u)
          annotation (Line(points={{21,-40},{35.6,-40}}, color={217,67,180}));
        connect(timePeriod1.y, ensure1.tl)
          annotation (Line(points={{90,30},{90,-30}}, color={0,0,255}));
        connect(eventTable2.y, booleanToBoolean4_5.u) annotation (Line(points={{41,50},
                {50,50},{50,40},{55.6,40}},         color={217,67,180}));
        connect(booleanToBoolean4_5.y, timePeriod1.u1)
          annotation (Line(points={{64.4,40},{79,40}}, color={162,29,33}));
        connect(eventTable3.y,booleanToBoolean4_6. u) annotation (Line(points={{41,20},
                {50,20},{50,32},{55.6,32}},            color={217,67,180}));
        connect(booleanToBoolean4_6.y, timePeriod1.u2)
          annotation (Line(points={{64.4,32},{79,32}}, color={162,29,33}));
        connect(integerConstant.y, ensure1.threshold) annotation (Line(points={{21,-70},
                {40,-70},{40,-48},{79,-48}},          color={255,127,0}));
        connect(booleanToBoolean4_4.y,not4_1. u)
          annotation (Line(points={{44.4,-40},{53.4,-40}},   color={162,29,33}));
        connect(not4_1.y, ensure1.u)
          annotation (Line(points={{66.6,-40},{79,-40}}, color={162,29,33}));
        connect(booleanPulse.y, booleanToBoolean4_7.u)
          annotation (Line(points={{21,90},{35.6,90}}, color={217,67,180}));
        connect(booleanToBoolean4_7.y, master.u)
          annotation (Line(points={{44.4,90},{59,90}}, color={162,29,33}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      equation
        ...
        connect(booleanToBoolean4_7.y, master.u)
          annotation (Line(points={{44.4,90},{59,90}}, color={162,29,33}));
        connect(booleanToBoolean4_4.y, checkAnytime.u)
          annotation (Line(points={{44.4,-70},{59,-70}}, color={162,29,33}));
        connect(booleanPulse1.y, booleanToBoolean4_4.u)
          annotation (Line(points={{-79,-70},{35.6,-70}}, color={217,67,180}));
        connect(during.y, checkAnytime.tl)
          annotation (Line(points={{70,-20},{70,-60}}, color={0,0,255}));
        connect(booleanToBoolean4_5.y, during.u)
          annotation (Line(points={{44.4,-10},{59,-10}}, color={162,29,33}));
        connect(eventPeriodic1.y, booleanToBoolean4_5.u)
          annotation (Line(points={{21,-10},{35.6,-10}}, color={217,67,180}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
  ...
  package Examples
    ...
    package TrafficLight
      ...
      model Verif
        Spec spec
          annotation (Placement(transformation(extent={{-92,26},{-130,54}})));
        Modelica.Blocks.Sources.RealExpression greenObserver(y=phys.greenLamp.i)
          annotation (Placement(transformation(extent={{56,10},{30,30}})));
        Modelica.Blocks.Logical.GreaterEqualThreshold oGreen(threshold=9)
          annotation (Placement(transformation(extent={{12,16},{4,24}})));
        Modelica.Blocks.Sources.RealExpression yellowObservor(y=phys.yellowLamp.i)
          annotation (Placement(transformation(extent={{56,30},{30,50}})));
        Modelica.Blocks.Logical.GreaterEqualThreshold oYellow(threshold=9)
          annotation (Placement(transformation(extent={{12,36},{4,44}})));
        Modelica.Blocks.Sources.RealExpression redObserver(y=phys.redLamp.i)
          annotation (Placement(transformation(extent={{56,50},{30,70}})));
        Modelica.Blocks.Logical.GreaterEqualThreshold oRed(threshold=9)
          annotation (Placement(transformation(extent={{12,56},{4,64}})));
        Phys1 phys annotation (Placement(transformation(extent={{108,30},{88,50}})));
        Log1 log annotation (Placement(transformation(extent={{148,30},{128,50}})));
        Modelica.Blocks.Sources.BooleanExpression green_active(y=oGreen.y)
          annotation (Placement(transformation(extent={{-30,10},{-50,30}})));
        Modelica.Blocks.Sources.BooleanExpression yellow_active(y=oYellow.y)
          annotation (Placement(transformation(extent={{-30,30},{-50,50}})));
        Modelica.Blocks.Sources.BooleanExpression red_active(y=oRed.y)
          annotation (Placement(transformation(extent={{-30,50},{-50,70}})));
      equation
        connect(spec.green, green_active.y) annotation (Line(points={{-90.5385,
                28.8},{-80,28.8},{-80,20},{-51,20}},
                                        color={217,67,180}));
        connect(spec.yellow, yellow_active.y)
          annotation (Line(points={{-90.5385,40},{-51,40}},
                                                       color={217,67,180}));
        connect(spec.red, red_active.y) annotation (Line(points={{-90.5385,51.2},
                {-80,51.2},{-80,60},{-51,60}},
                                    color={217,67,180}));
        connect(greenObserver.y, oGreen.u)
          annotation (Line(points={{28.7,20},{12.8,20}}, color={0,0,127}));
        connect(yellowObservor.y, oYellow.u)
          annotation (Line(points={{28.7,40},{12.8,40}}, color={0,0,127}));
        connect(redObserver.y, oRed.u)
          annotation (Line(points={{28.7,60},{12.8,60}}, color={0,0,127}));
        connect(phys.green, log.y_green)
          annotation (Line(points={{109,32},{114,32},{114,32},{118,32},{118,32},{
                127,32}},                              color={217,67,180}));
        connect(phys.yellow, log.y_yellow)
          annotation (Line(points={{109,40},{127,40}}, color={217,67,180}));
        connect(phys.red, log.y_red)
          annotation (Line(points={{109,48},{114,48},{114,48},{118,48},{118,48},{
                127,48}},                              color={217,67,180}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-160,
                  -40},{180,100}}), graphics={
                                 Rectangle(extent={{-160,100},{180,-40}}, lineColor=
                   {28,108,200}),
                Line(
                  points={{-40,28},{0,-30},{62,96}},
                  color={0,127,0},
                  smooth=Smooth.None,
                  thickness=1)}),                                      Diagram(
              coordinateSystem(preserveAspectRatio=false, extent={{-160,-40},{180,
                  100}}), graphics={
              Rectangle(
                extent={{-150,90},{172,-30}},
                lineColor={28,108,200},
                fillColor={215,215,215},
                fillPattern=FillPattern.Solid),
              Rectangle(
              ...
              Text(
                extent={{-10,12},{64,4}},
                lineColor={28,108,200},
                textString="Observation model"),
              Text(
                extent={{116,64},{156,56}},
                lineColor={28,108,200},
                fillColor={255,213,170},
                fillPattern=FillPattern.Solid,
                textString="I&C"),
              ...
              Text(
                extent={{-142,12},{-68,4}},
                lineColor={28,108,200},
                textString="Requirements model"),
              Text(
                extent={{-66,-8},{78,-26}},
                lineColor={28,108,200},
                fillColor={255,170,255},
                fillPattern=FillPattern.Solid,
                textString="Verification model")}),
          experiment(StopTime=100));
      end Verif;

      model Spec
        TimeLocators.Continuous.AfterBefore           afterBefore
          annotation (Placement(transformation(extent={{-40,64},{-20,84}})));
        Requirements.CheckCountEqual       checkInPCount(threshold=0)
          annotation (Placement(transformation(extent={{-40,24},{-20,44}})));
        TimeLocators.Continuous.AfterFor           afterFor
          annotation (Placement(transformation(extent={{-40,-40},{-20,-20}})));
        Blocks.Math.Constant           const(k=30)
          annotation (Placement(transformation(extent={{-80,-60},{-60,-40}})));
        Requirements.Ensure         checkBoolean
          annotation (Placement(transformation(extent={{-40,-80},{-20,-60}})));
        TimeLocators.Continuous.AfterFor           When
          annotation (Placement(transformation(extent={{100,70},{120,90}})));
        Blocks.Math.Constant           const1(k=0.2)
          annotation (Placement(transformation(extent={{20,14},{40,34}})));
        Requirements.CheckAtEnd           checkInPCount1
          annotation (Placement(transformation(extent={{100,0},{120,20}})));
        Blocks.Math.Constant           const2(k=30)
          annotation (Placement(transformation(extent={{22,50},{42,70}})));
        ETL.Connectors.BooleanInput       red "External Boolean variable"
          annotation (Placement(transformation(extent={{-120,70},{-100,90}})));
        ETL.Connectors.BooleanInput       green
          annotation (Placement(transformation(extent={{-120,-90},{-100,-70}})));
        ETL.Connectors.BooleanInput       yellow "Boolean condition"
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
        Blocks.Logical4.ShowBoolean4                req1
          annotation (Placement(transformation(extent={{-8,20},{14,48}})));
        Blocks.Logical4.ShowBoolean4                req2
          annotation (Placement(transformation(extent={{-10,-82},{14,-58}})));
        Blocks.Logical4.ShowBoolean4                req3
          annotation (Placement(transformation(extent={{140,-2},{162,22}})));
        Blocks.Logical4.And4                and4_1
          annotation (Placement(transformation(extent={{20,-58},{40,-38}})));
        Blocks.Logical4.And4                and4_2
          annotation (Placement(transformation(extent={{112,-50},{132,-30}})));
        Blocks.Logical4.ShowBoolean4                req
          annotation (Placement(transformation(extent={{138,-52},{160,-28}})));
        Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_1
        ...
        Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_4
          annotation (Placement(transformation(extent={{-84,-4},{-76,4}})));
        Blocks.Events.EventDelay booleanDelay
          annotation (Placement(transformation(extent={{58,70},{78,90}})));
        Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_5
          annotation (Placement(transformation(extent={{84,76},{92,84}})));
        Blocks.Events.Event4ToEvent event4ToEvent
          annotation (Placement(transformation(extent={{42,76},{50,84}})));
      equation
        connect(afterBefore.y, checkInPCount.tl)
          annotation (Line(points={{-30,64},{-30,44}}, color={0,0,255}));
        connect(const.y, afterFor.duration) annotation (Line(points={{-59,-50},{-50,
                -50},{-50,-38},{-41,-38}}, color={0,0,0}));
        connect(afterFor.y, checkBoolean.tl)
          annotation (Line(points={{-30,-40},{-30,-60}}, color={0,0,255}));
        connect(const1.y, When.duration) annotation (Line(points={{41,24},{90,
                24},{90,72},{99,72}},
                                 color={0,0,0}));
        connect(checkInPCount.y, req1.u)
          annotation (Line(points={{-19,34},{-8.55,34}},
                                                       color={162,29,33}));
        connect(checkBoolean.y, req2.u)
          annotation (Line(points={{-19,-70},{-10.6,-70}},
                                                         color={162,29,33}));
        connect(checkBoolean.y, and4_1.u2) annotation (Line(points={{-19,-70},{
                -16,-70},{-16,-56},{19,-56}},
                                          color={162,29,33}));
        connect(checkInPCount.y, and4_1.u1) annotation (Line(points={{-19,34},{
                -16,34},{-16,-40},{19,-40}},
                                         color={162,29,33}));
        connect(and4_2.y, req.u)
          annotation (Line(points={{133,-40},{137.45,-40}},color={162,29,33}));
        connect(and4_1.y, and4_2.u2) annotation (Line(points={{41,-48},{111,-48}},
                                color={162,29,33}));
        connect(checkInPCount.u, booleanToBoolean4_1.y) annotation (Line(points=
               {{-41,34},{-72,34},{-72,80},{-75.6,80}}, color={162,29,33}));
        connect(booleanToBoolean4_1.u, red)
          annotation (Line(points={{-84.4,80},{-110,80}}, color={217,67,180}));
        connect(yellow, booleanToBoolean4_2.u) annotation (Line(points={{-110,0},
                {-94,0},{-94,66},{-84.4,66}}, color={217,67,180}));
        connect(booleanToBoolean4_2.y, afterBefore.u2)
          annotation (Line(points={{-75.6,66},{-41,66}}, color={162,29,33}));
        connect(green, booleanToBoolean4_3.u) annotation (Line(points={{-110,
                -80},{-84.4,-80}}, color={217,67,180}));
        connect(booleanToBoolean4_3.y, checkBoolean.u) annotation (Line(points=
                {{-75.6,-80},{-52,-80},{-52,-70},{-41,-70}}, color={162,29,33}));
        connect(booleanToBoolean4_3.y, afterFor.u) annotation (Line(points={{
                -75.6,-80},{-52,-80},{-52,-30},{-41,-30}}, color={162,29,33}));
        connect(booleanToBoolean4_3.y, afterBefore.u1) annotation (Line(points=
                {{-75.6,-80},{-52,-80},{-52,74},{-41,74}}, color={162,29,33}));
        connect(checkInPCount1.u, booleanToBoolean4_4.y) annotation (Line(
              points={{99,10},{90,10},{90,0},{-75.6,0}}, color={162,29,33}));
        connect(booleanToBoolean4_4.u, yellow)
          annotation (Line(points={{-84.4,0},{-110,0}}, color={217,67,180}));
        connect(When.y, checkInPCount1.tl)
          annotation (Line(points={{110,70},{110,20}}, color={0,0,255}));
        connect(const2.y, booleanDelay.delay) annotation (Line(points={{43,60},
                {50,60},{50,72},{57,72}}, color={0,0,0}));
        connect(checkInPCount1.y, req3.u)
          annotation (Line(points={{121,10},{139.45,10}},color={162,29,33}));
        connect(checkInPCount1.y, and4_2.u1) annotation (Line(points={{121,10},
                {128,10},{128,-22},{98,-22},{98,-32},{111,-32}}, color={162,29,
                33}));
        connect(booleanDelay.y, booleanToBoolean4_5.u)
          annotation (Line(points={{79,80},{83.6,80}}, color={217,67,180}));
        connect(booleanToBoolean4_5.y, When.u)
          annotation (Line(points={{92.4,80},{99,80}}, color={162,29,33}));
        connect(event4ToEvent.y, booleanDelay.u)
          annotation (Line(points={{50.4,80},{57,80}}, color={217,67,180}));
        connect(booleanToBoolean4_3.y, event4ToEvent.u) annotation (Line(points=
               {{-75.6,-80},{-52,-80},{-52,88},{28,88},{28,80},{41.6,80}},
              color={162,29,33}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,
              ...
              Text(
                ...
                textString="%name")}), Diagram(coordinateSystem(preserveAspectRatio=
                 false, extent={{-100,-100},{160,100}}),
                         graphics={
              Rectangle(extent={{-86,-16},{-14,-94}}, lineColor={28,108,200},
                fillColor={255,255,170},
                fillPattern=FillPattern.Solid),
              Rectangle(extent={{-86,96},{-14,-10}}, lineColor={28,108,200},
                fillColor={255,255,170},
                fillPattern=FillPattern.Solid),
              Text(
                extent={{-72,-2},{-30,-6}},
                lineColor={28,108,200},
                textString="After green, next step is yellow"),
              Text(
                extent={{-82,-82},{-16,-94}},
                lineColor={28,108,200},
                textString="Step green should stay active for at least 30 seconds"),
              Rectangle(extent={{16,96},{134,-16}},lineColor={28,108,200},
                fillColor={255,255,170},
                fillPattern=FillPattern.Solid),
              Text(
                extent={{24,-4},{76,-8}},
                lineColor={28,108,200},
                textString="After green becomes active + 30 seconds,"),
              Text(
                extent={{25,-8},{81,-14}},
                lineColor={28,108,200},
                textString="next step should turn yellow within 0.2 seconds"),
              Text(
                extent={{-126,100},{-96,92}},
                lineColor={28,108,200},
                textString="red"),
              Text(
                extent={{-126,-58},{-96,-66}},
      ...
      public
        ...
        Green green annotation (Placement(transformation(extent={{-70,50},{-50,70}})));
        Yellow yellow annotation (Placement(transformation(extent={{-12,50},{12,70}})));
        Red red annotation (Placement(transformation(extent={{50,50},{70,70}})));
        Modelica.Blocks.Sources.BooleanExpression green_active(y=hold(activeState(
              green)))
          annotation (Placement(transformation(extent={{40,-90},{80,-70}})));
        Modelica.Blocks.Sources.BooleanExpression yellow_active(y=hold(activeState(
              yellow)))
          annotation (Placement(transformation(extent={{40,-10},{80,10}})));
        Modelica.Blocks.Sources.BooleanExpression red_active(y=hold(activeState(red)))
          annotation (Placement(transformation(extent={{40,70},{80,90}})));
        ...
        Modelica.Blocks.Interfaces.BooleanOutput y_red "Value of Boolean output"
          annotation (Placement(transformation(extent={{100,70},{120,90}})));
        Init init annotation (Placement(transformation(extent={{-80,-20},{-60,0}})));
      equation
        transition(
          green,
          yellow,timeInState() > 30,
          immediate=true,
          reset=true,
          synchronize=false,
        ...
        transition(
          yellow,
          red,timeInState() > 4,immediate=true,reset=true,synchronize=false,priority=1)
                           annotation (Line(
            points={{14,60},{48,60}},
            color={175,175,175},
            thickness=0.25,
        ...
        transition(
          red,
          green,timeInState() > 30,immediate=true,reset=true,synchronize=false,
          priority=1)         annotation (Line(
            points={{60,48},{60,34},{60,20},{-60,20},{-60,48}},
            color={175,175,175},
            thickness=0.25,
            smooth=Smooth.Bezier), Text(
            string="%condition",
        ...
        connect(green_active.y, y_green)
          annotation (Line(points={{82,-80},{110,-80}},
                                                      color={255,0,255}));
        connect(yellow_active.y, y_yellow)
          annotation (Line(points={{82,0},{110,0}}, color={255,0,255}));
        connect(red_active.y, y_red)
          annotation (Line(points={{82,80},{110,80}},   color={255,0,255}));
        transition(
          init,
          green,
          timeInState() > 1) annotation (Line(
            points={{-82,-10},{-92,-10},{-92,48},{-92,60},{-72,60}},
            color={175,175,175},
            thickness=0.25,
            smooth=Smooth.Bezier), Text(
            string="%condition",
            ...
            textStyle={TextStyle.Bold},
            horizontalAlignment=TextAlignment.Right));
        initialState(init) annotation (Line(
            points={{-58,-10},{-40,-10}},
            color={175,175,175},
            thickness=0.25,
            smooth=Smooth.Bezier,
        ...
        annotation (Icon(coordinateSystem(extent={{-100,-100},{100,100}}),
              ...
              Text(
                ...
                fillColor={255,255,255},
                fillPattern=FillPattern.None,
                textString="%name")}), Diagram(coordinateSystem(extent={{-100,-100},
                  {100,100}})));
      end Log1;
      ...
      model Log2
        ...
        Modelica.Blocks.Logical.Timer timer2
                                            annotation (Placement(transformation(
                  extent={{26,-4},{34,4}})));
        Modelica.Blocks.Logical.GreaterEqualThreshold greaterEqual2(threshold=4)
        ...
        Modelica.Blocks.Logical.Timer timer1
          annotation (Placement(transformation(extent={{-54,-4},{-46,4}})));
        Modelica.Blocks.Logical.GreaterEqualThreshold greaterEqual1(threshold=30)
          annotation (Placement(transformation(extent={{-34,-4},{-26,4}})));
        Modelica.Blocks.Logical.Timer timer3
                                            annotation (Placement(transformation(
                  extent={{14,-64},{6,-56}})));
        Modelica.Blocks.Logical.GreaterEqualThreshold greaterEqual3(threshold=30)
          annotation (Placement(transformation(extent={{-6,-64},{-14,-56}})));
        ...
        Modelica.Blocks.Logical.Timer timer0
                                            annotation (Placement(transformation(
                  extent={{-54,56},{-46,64}})));
        Modelica.Blocks.Logical.GreaterEqualThreshold greaterEqual0(threshold=1)
      ...
      equation
        ...
        connect(T3.outPort, green.inPort[1]) annotation (Line(points={{-21.5,-30},{
                -80,-30},{-80,30.5},{-71,30.5}}, color={0,0,0}));
        ...
        connect(yellow.active,timer2. u)
          annotation (Line(points={{20,19},{20,0},{25.2,0}}, color={255,0,255}));
        connect(greaterEqual2.y, T2.condition)
          annotation (Line(points={{54.4,0},{60,0},{60,18}}, color={255,0,255}));
        connect(timer1.y, greaterEqual1.u)
          annotation (Line(points={{-45.6,0},{-34.8,0}}, color={0,0,127}));
        connect(green.active, timer1.u) annotation (Line(points={{-60,19},{-60,0},{
                -54.8,0}}, color={255,0,255}));
        connect(greaterEqual1.y, T1.condition) annotation (Line(points={{-25.6,0},{
                -20,0},{-20,18}}, color={255,0,255}));
        connect(red.active, timer3.u) annotation (Line(points={{20,-41},{20,-60},{
                14.8,-60}}, color={255,0,255}));
        connect(timer3.y, greaterEqual3.u)
          annotation (Line(points={{5.6,-60},{-5.2,-60}}, color={0,0,127}));
        connect(greaterEqual3.y, T3.condition) annotation (Line(points={{-14.4,-60},
                {-20,-60},{-20,-42}}, color={255,0,255}));
        connect(green_active.y, y_green)
        ...
        connect(T0.outPort, green.inPort[2]) annotation (Line(points={{-18.5,90},{
                -8,90},{-8,48},{-80,48},{-80,29.5},{-71,29.5}}, color={0,0,0}));
        connect(timer0.y,greaterEqual0. u)
          annotation (Line(points={{-45.6,60},{-34.8,60}},
                                                         color={0,0,127}));
        connect(greaterEqual0.y, T0.condition) annotation (Line(points={{-25.6,60},
      ...
      model Phys1
        ...
        Modelica.Electrical.Analog.Ideal.IdealClosingSwitch greenSwitch annotation (
           Placement(transformation(
              ...
              rotation=90,
              origin={-30,20})));
        Modelica.Electrical.Analog.Ideal.IdealClosingSwitch yellowSwitch
          annotation (Placement(transformation(
              extent={{10,-10},{-10,10}},
              rotation=90,
              origin={10,20})));
        ...
        Modelica.Blocks.Sources.BooleanExpression greenCom(y=green)
          annotation (Placement(transformation(extent={{-54,10},{-46,30}})));
        Modelica.Blocks.Sources.BooleanExpression yellowCom(y=yellow)
          annotation (Placement(transformation(extent={{-14,10},{-6,30}})));
        Modelica.Blocks.Sources.BooleanExpression redCom(y=red)
          annotation (Placement(transformation(extent={{26,10},{34,30}})));
      equation
        connect(mainPowerVoltage.p, greenLamp.p) annotation (Line(points={{-70,50},
                {-70,80},{-30,80},{-30,70}}, color={0,0,255}));
        connect(greenLamp.p, yellowLamp.p) annotation (Line(points={{-30,70},{-30,
                80},{10,80},{10,70}}, color={0,0,255}));
        connect(yellowLamp.p, redLamp.p) annotation (Line(points={{10,70},{10,80},{
                50,80},{50,70}}, color={0,0,255}));
        connect(redLamp.p, R.p) annotation (Line(points={{50,70},{50,80},{80,80},{
                80,50}}, color={0,0,255}));
        connect(R.n, redSwitch.n) annotation (Line(points={{80,30},{80,0},{50,0},{
                50,10}},  color={0,0,255}));
        connect(redSwitch.n, yellowSwitch.n) annotation (Line(points={{50,10},{50,0},
                {10,0},{10,10}},      color={0,0,255}));
        connect(yellowSwitch.n, greenSwitch.n) annotation (Line(points={{10,10},{10,
                0},{-30,0},{-30,10}},   color={0,0,255}));
        connect(greenSwitch.n, mainPowerVoltage.n) annotation (Line(points={{-30,10},
                {-30,0},{-70,0},{-70,30}},   color={0,0,255}));
        connect(mainPowerVoltage.n, ground.p)
        ...
        connect(yellowLamp.n, yellowSwitch.p)
          annotation (Line(points={{10,50},{10,30}}, color={0,0,255}));
        connect(redLamp.n, redSwitch.p)
  ...
  package Tests
    model Pump
      TimeLocators.Continuous.FromFor
                               delayToNominalSpeed
        annotation (Placement(transformation(extent={{40,-32},{60,-12}})));
      Requirements.CheckAtEnd Req2
        annotation (Placement(transformation(extent={{40,-100},{60,-80}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_2
        annotation (Placement(transformation(extent={{6,-26},{14,-18}})));
      Blocks.Logical.BooleanPulse pulse(width=40, period=60)
        annotation (Placement(transformation(extent={{-100,-10},{-80,10}})));
      Blocks.Logical.BooleanPulse plantStarted(
        width=200,
        startTime=10,
        period=230)
        annotation (Placement(transformation(extent={{-100,50},{-80,70}})));
      TimeLocators.Continuous.FromUntil
                               plantInOperation
        annotation (Placement(transformation(extent={{40,50},{60,70}})));
      Modelica.Blocks.Logical.Not not2
        annotation (Placement(transformation(extent={{-64,48},{-56,56}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_4
        annotation (Placement(transformation(extent={{16,56},{24,64}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_5
        annotation (Placement(transformation(extent={{16,48},{24,56}})));
      Blocks.Math.Ramp pumpSpeed(
        height=100,
        startTime=2,
        duration=30)
        annotation (Placement(transformation(extent={{-100,-70},{-80,-50}})));
      Blocks.Math.Constant nominalSpeedLimit(k=90)
        annotation (Placement(transformation(extent={{-100,-100},{-80,-80}})));
      Blocks.Math.GreaterEqual4 greater4_1
        annotation (Placement(transformation(extent={{0,-100},{20,-80}})));
      Blocks.Math.Constant startupDelay(k=30)
        annotation (Placement(transformation(extent={{-100,-40},{-80,-20}})));
      Requirements.CheckCountLowerEqual
                                     Req1(threshold=3)
        annotation (Placement(transformation(extent={{40,20},{60,40}})));
      Blocks.Logical4.And4 and4_1
        annotation (Placement(transformation(extent={{80,-10},{100,10}})));
      Modelica.Blocks.Logical.And pumpStarted
        annotation (Placement(transformation(extent={{-40,-20},{-20,0}})));
      TimeLocators.Continuous.While
                             While
        annotation (Placement(transformation(extent={{40,80},{60,100}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_1
        annotation (Placement(transformation(extent={{16,86},{24,94}})));
    equation
      connect(delayToNominalSpeed.y, Req2.tl)
        annotation (Line(points={{50,-32},{50,-80}}, color={0,0,255}));
      connect(plantStarted.y, not2.u) annotation (Line(points={{-79,60},{-70,60},
              {-70,52},{-64.8,52}}, color={217,67,180}));
      connect(plantStarted.y, booleanToBoolean4_4.u)
        annotation (Line(points={{-79,60},{15.6,60}}, color={217,67,180}));
      connect(booleanToBoolean4_4.y, plantInOperation.u1)
        annotation (Line(points={{24.4,60},{39,60}}, color={162,29,33}));
      connect(not2.y, booleanToBoolean4_5.u)
        annotation (Line(points={{-55.6,52},{15.6,52}}, color={255,0,255}));
      connect(pumpSpeed.y, greater4_1.u1) annotation (Line(points={{-79,-60},{
              -40,-60},{-40,-90},{-1,-90}}, color={0,0,0}));
      connect(nominalSpeedLimit.y, greater4_1.u2) annotation (Line(points={{-79,-90},
              {-60,-90},{-60,-98},{-1,-98}},      color={0,0,0}));
      connect(greater4_1.y, Req2.u)
        annotation (Line(points={{21,-90},{39,-90}}, color={162,29,33}));
      connect(booleanToBoolean4_5.y, plantInOperation.u2)
        annotation (Line(points={{24.4,52},{39,52}}, color={162,29,33}));
      connect(booleanToBoolean4_2.y, Req1.u) annotation (Line(points={{14.4,-22},
              {30,-22},{30,30},{39,30}}, color={162,29,33}));
      connect(plantInOperation.y, Req1.tl)
        annotation (Line(points={{50,50},{50,40}}, color={0,0,255}));
      connect(Req1.y, and4_1.u1) annotation (Line(points={{61,30},{70,30},{70,8},
              {79,8}}, color={162,29,33}));
      connect(Req2.y, and4_1.u2) annotation (Line(points={{61,-90},{70,-90},{70,
              -8},{79,-8}}, color={162,29,33}));
      connect(plantStarted.y, pulse.reset) annotation (Line(points={{-79,60},{
              -70,60},{-70,-14},{-90,-14},{-90,-11}}, color={217,67,180}));
      connect(pulse.y, pumpStarted.u2) annotation (Line(points={{-79,0},{-60,0},
              {-60,-18},{-42,-18}}, color={217,67,180}));
      connect(pumpStarted.y, booleanToBoolean4_2.u) annotation (Line(points={{-19,-10},
              {-10,-10},{-10,-22},{5.6,-22}},         color={255,0,255}));
      connect(pumpStarted.y, pumpSpeed.reset) annotation (Line(points={{-19,-10},
              {-10,-10},{-10,-74},{-90,-74},{-90,-71}}, color={255,0,255}));
      connect(plantStarted.y, pumpStarted.u1) annotation (Line(points={{-79,60},
              {-70,60},{-70,10},{-48,10},{-48,-10},{-42,-10}}, color={217,67,
              180}));
      connect(While.y, plantInOperation.tl)
        annotation (Line(points={{50,80},{50,70}}, color={0,0,255}));
      connect(plantStarted.y, booleanToBoolean4_1.u) annotation (Line(points={{
              -79,60},{-70,60},{-70,90},{15.6,90}}, color={217,67,180}));
      connect(booleanToBoolean4_1.y, While.u)
        annotation (Line(points={{24.4,90},{39,90}}, color={162,29,33}));
      connect(While.y, delayToNominalSpeed.tl) annotation (Line(points={{50,80},
              {50,74},{76,74},{76,12},{50,12},{50,-12}}, color={0,0,255}));
      connect(startupDelay.y, delayToNominalSpeed.duration)
        annotation (Line(points={{-79,-30},{39,-30}}, color={0,0,0}));
      connect(booleanToBoolean4_2.y, delayToNominalSpeed.u)
        annotation (Line(points={{14.4,-22},{39,-22}}, color={162,29,33}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            Ellipse(lineColor = {75,138,73},
                    fillColor={255,255,255},
                    fillPattern = FillPattern.Solid,
    ...
    model Pump1
      "While system is in operation, pump must not be started more than twice"
      Blocks.Logical.BooleanPulse pumpIsStarted(width=40, period=60)
        annotation (Placement(transformation(extent={{-60,-10},{-40,10}})));
      Blocks.Logical.BooleanPulse systemInOperation(
        width=200,
        startTime=10,
        period=230)
        annotation (Placement(transformation(extent={{-60,20},{-40,40}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_4
        annotation (Placement(transformation(extent={{-4,26},{4,34}})));
      Requirements.CheckCountLowerEqual checkCountLowerEqual(threshold=2)
        annotation (Placement(transformation(extent={{20,-10},{40,10}})));
      TimeLocators.Continuous.During during
        annotation (Placement(transformation(extent={{20,20},{40,40}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_1
        annotation (Placement(transformation(extent={{-4,-4},{4,4}})));
    equation
      connect(systemInOperation.y, booleanToBoolean4_4.u)
        annotation (Line(points={{-39,30},{-4.4,30}}, color={217,67,180}));
      connect(systemInOperation.y, pumpIsStarted.reset) annotation (Line(points=
             {{-39,30},{-28,30},{-28,-20},{-50,-20},{-50,-11}}, color={217,67,
              180}));
      connect(during.y, checkCountLowerEqual.tl)
        annotation (Line(points={{30,20},{30,10}}, color={0,0,255}));
      connect(booleanToBoolean4_4.y, during.u)
        annotation (Line(points={{4.4,30},{19,30}}, color={162,29,33}));
      connect(pumpIsStarted.y, booleanToBoolean4_1.u)
        annotation (Line(points={{-39,0},{-4.4,0}}, color={217,67,180}));
      connect(booleanToBoolean4_1.y, checkCountLowerEqual.u)
        annotation (Line(points={{4.4,0},{19,0}}, color={162,29,33}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            Ellipse(lineColor = {75,138,73},
                    fillColor={255,255,255},
                    fillPattern = FillPattern.Solid,
    ...
    model Probability
      ...
      Blocks.Events.Probability unavailability(
        reset=reset,
        fileName="C:/Users/I51238/Documents/Dymola/probatest1.txt",
        t={1,5,9,13})
        annotation (Placement(transformation(extent={{20,-20},{40,0}})));
      Blocks.Logical.RandomFailure randomFailure
        annotation (Placement(transformation(extent={{-60,-30},{-40,-10}})));
      inner Blocks.Logical.GlobalSeed globalSeed
        annotation (Placement(transformation(extent={{-60,0},{-40,20}})));
      Blocks.Math.Constant const1(k=0.3)
        annotation (Placement(transformation(extent={{-100,-20},{-80,0}})));
      Blocks.Math.Constant const2(k=3)
        annotation (Placement(transformation(extent={{-100,-50},{-80,-30}})));
      Blocks.Events.Probability unreliability(
        reset=reset,
        fileName="C:/Users/I51238/Documents/Dymola/probatest2.txt",
        t={1,5,9,13})
        annotation (Placement(transformation(extent={{40,-80},{60,-60}})));
      Blocks.Logical.Heaviside heaviside
        annotation (Placement(transformation(extent={{0,-80},{20,-60}})));
      Blocks.Logical4.Probability unavailability1(
        reset=reset,
        fileName="C:/Users/I51238/Documents/Dymola/probatest1.csv",
        startTime=1,
        period=4,
        N=4)
      ...
      Blocks.Logical4.Probability unreliability1(
        reset=reset,
        startTime=1,
        period=4,
        N=4,
        fileName="C:/Users/I51238/Documents/Dymola/probatest2.csv")
        annotation (Placement(transformation(extent={{60,-50},{80,-30}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_3
        annotation (Placement(transformation(extent={{36,-44},{44,-36}})));
      Blocks.Math.Less4 less4_1
        annotation (Placement(transformation(extent={{60,50},{80,70}})));
      Blocks.Math.Constant const3(k=0.1)
        annotation (Placement(transformation(extent={{20,20},{40,40}})));
      inner TimeLocators.Continuous.Master master
        annotation (Placement(transformation(extent={{-60,40},{-40,60}})));
      Blocks.Logical4.Probability unavailability2(
        reset=reset,
        period=0.1,
        fileName="C:/Users/I51238/Documents/Dymola/probatest3.csv",
        N=200,
        startTime=1)
        annotation (Placement(transformation(extent={{40,80},{60,100}})));
    equation
      connect(const1.y, randomFailure.failureRate) annotation (Line(points={{-79,-10},
              {-70,-10},{-70,-20},{-61,-20}},
                                           color={0,0,0}));
      connect(const2.y, randomFailure.repairRate) annotation (Line(points={{-79,-40},
              {-70,-40},{-70,-28},{-61,-28}},
                                           color={0,0,0}));
      connect(randomFailure.y, unavailability.u)
        annotation (Line(points={{-39,-20},{-10,-20},{-10,-10},{19,-10}},
                                                    color={217,67,180}));
      connect(randomFailure.y, heaviside.u) annotation (Line(points={{-39,-20},
              {-10,-20},{-10,-70},{-1,-70}},
                                           color={217,67,180}));
      connect(heaviside.y, unreliability.u)
        annotation (Line(points={{21,-70},{39,-70}}, color={217,67,180}));
      connect(randomFailure.y, booleanToBoolean4_1.u) annotation (Line(points={{-39,-20},
              {-30,-20},{-30,60},{-24.4,60}},          color={217,67,180}));
      connect(booleanToBoolean4_1.y, trim.u)
        annotation (Line(points={{-15.6,60},{-4.4,60}},
                                                      color={162,29,33}));
      connect(trim.y, unavailability1.u)
        annotation (Line(points={{4.4,60},{11,60}},  color={162,29,33}));
      connect(during.y[1], trim.tl)
        annotation (Line(points={{0,80},{0,64}},   color={0,0,255}));
      connect(booleanPulse.y, booleanToBoolean4_2.u)
        annotation (Line(points={{-59,90},{-24.4,90}}, color={217,67,180}));
      connect(booleanToBoolean4_2.y, during.u)
        annotation (Line(points={{-15.6,90},{-11,90}},color={162,29,33}));
      connect(booleanToBoolean4_3.y, unreliability1.u)
        annotation (Line(points={{44.4,-40},{59,-40}}, color={162,29,33}));
      connect(heaviside.y, booleanToBoolean4_3.u) annotation (Line(points={{21,-70},
              {30,-70},{30,-40},{35.6,-40}},      color={217,67,180}));
      connect(unavailability1.y, less4_1.u1)
        annotation (Line(points={{33,60},{59,60}}, color={0,0,0}));
      connect(const3.y, less4_1.u2) annotation (Line(points={{41,30},{54,30},{
              54,52},{59,52}}, color={0,0,0}));
      connect(unavailability1.range, less4_1.tolerance) annotation (Line(points=
             {{33,52},{48,52},{48,40},{70,40},{70,49}}, color={0,0,0}));
      connect(booleanToBoolean4_1.y, unavailability2.u) annotation (Line(points=
             {{-15.6,60},{-10,60},{-10,76},{20,76},{20,90},{39,90}}, color={162,
              29,33}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            Ellipse(lineColor = {75,138,73},
                    fillColor={255,255,255},
            ...
            coordinateSystem(preserveAspectRatio=false), graphics={Text(
              ...
              fillColor={210,210,210},
              fillPattern=FillPattern.Solid,
              textString="Unavailability"), Text(
              extent={{30,-88},{72,-96}},
              lineColor={0,0,0},
              pattern=LinePattern.Dash,
              fillColor={210,210,210},
              fillPattern=FillPattern.Solid,
              textString="Unreliability")}),
    ...
    model Probability1
      ...
      Blocks.Math.Constant const2(k=3)
        annotation (Placement(transformation(extent={{-100,-20},{-80,0}})));
      Blocks.Logical4.Probability unavailability(
        reset=reset,
        fileName="C:/Users/I51238/Documents/Dymola/probatest1.csv",
        startTime=1,
        period=0.1,
        N=200) annotation (Placement(transformation(extent={{-10,0},{10,20}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_1
      ...
      Blocks.Logical.BooleanPulse booleanPulse(
        ...
        annotation (Placement(transformation(extent={{0,40},{20,60}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_2
        annotation (Placement(transformation(extent={{46,46},{54,54}})));
      Blocks.Math.Less4 less4_1
        annotation (Placement(transformation(extent={{40,10},{60,30}})));
      Blocks.Math.Constant const3(k=0.5)
        annotation (Placement(transformation(extent={{24,8},{32,16}})));
      inner TimeLocators.Continuous.Master master
        annotation (Placement(transformation(extent={{-40,60},{-20,80}})));
      Requirements.Ensure ensure
        annotation (Placement(transformation(extent={{70,10},{90,30}})));
      Blocks.Logical4.Boolean4Constant boolean4Constant(K=CRML.ETL.Types.Boolean4.undefined)
        annotation (Placement(transformation(extent={{0,-80},{20,-60}})));
      ETL.Evaluator.Trim trim
        annotation (Placement(transformation(extent={{46,-74},{54,-66}})));
      TimeLocators.Continuous.During during1
        annotation (Placement(transformation(extent={{40,-60},{60,-40}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_3
        annotation (Placement(transformation(extent={{26,-54},{34,-46}})));
      Blocks.Logical.BooleanPulse booleanPulse1(
        period=100,
        width=21,
        startTime=1)
        annotation (Placement(transformation(extent={{-40,-60},{-20,-40}})));
    equation
      connect(const1.y, randomFailure.failureRate) annotation (Line(points={{-79,20},
              {-70,20},{-70,10},{-61,10}}, color={0,0,0}));
      connect(const2.y, randomFailure.repairRate) annotation (Line(points={{-79,-10},
              {-70,-10},{-70,2},{-61,2}},  color={0,0,0}));
      connect(randomFailure.y, booleanToBoolean4_1.u) annotation (Line(points={{-39,10},
              {-32.4,10}},                             color={217,67,180}));
      connect(booleanPulse.y, booleanToBoolean4_2.u)
        annotation (Line(points={{21,50},{45.6,50}},   color={217,67,180}));
      connect(booleanToBoolean4_2.y, during.u)
        annotation (Line(points={{54.4,50},{69,50}},  color={162,29,33}));
      connect(unavailability.y, less4_1.u1) annotation (Line(points={{11,10},{
              20,10},{20,20},{39,20}}, color={0,0,0}));
      connect(unavailability.range, less4_1.tolerance)
        annotation (Line(points={{11,2},{50,2},{50,9}}, color={0,0,0}));
      connect(booleanToBoolean4_1.y, unavailability.u)
        annotation (Line(points={{-23.6,10},{-11,10}}, color={162,29,33}));
      connect(const3.y, less4_1.u2)
        annotation (Line(points={{32.4,12},{39,12}}, color={0,0,0}));
      connect(during.y, ensure.tl)
        annotation (Line(points={{80,40},{80,30}}, color={0,0,255}));
      connect(boolean4Constant.y, trim.u)
        annotation (Line(points={{21,-70},{45.6,-70}}, color={162,29,33}));
      connect(booleanToBoolean4_3.y, during1.u)
        annotation (Line(points={{34.4,-50},{39,-50}}, color={162,29,33}));
      connect(during1.y[1], trim.tl)
        annotation (Line(points={{50,-60},{50,-66}}, color={0,0,255}));
      connect(booleanPulse1.y, booleanToBoolean4_3.u)
        annotation (Line(points={{-19,-50},{25.6,-50}}, color={217,67,180}));
      connect(less4_1.y, ensure.u)
        annotation (Line(points={{61,20},{69,20}}, color={162,29,33}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            Ellipse(lineColor = {75,138,73},
                    fillColor={255,255,255},
                    fillPattern = FillPattern.Solid,
    ...
    model Probability2
      ...
      Blocks.Math.Constant const2(k=3)
        annotation (Placement(transformation(extent={{-100,-40},{-80,-20}})));
      Blocks.Logical4.Probability unreliability(
        reset=reset,
        fileName="C:/Users/I51238/Documents/Dymola/probatest1.csv",
        startTime=1,
        period=0.1,
        N=200) annotation (Placement(transformation(extent={{-10,30},{10,50}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_1
        annotation (Placement(transformation(extent={{-32,36},{-24,44}})));
      TimeLocators.Continuous.When   during
      ...
      Blocks.Math.Less4 less4_1
        annotation (Placement(transformation(extent={{40,40},{60,60}})));
      Blocks.Math.Constant const3(k=0.5)
        annotation (Placement(transformation(extent={{24,38},{32,46}})));
      inner TimeLocators.Continuous.Master master
      ...
      Blocks.Logical.Heaviside heaviside
        annotation (Placement(transformation(extent={{-20,-20},{0,0}})));
      Blocks.Events.EventPeriodic eventPeriodic(period=100, startTime=2)
        annotation (Placement(transformation(extent={{0,80},{20,100}})));
      Requirements.Ensure ensure1
        annotation (Placement(transformation(extent={{-20,-80},{0,-60}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_3
        annotation (Placement(transformation(extent={{-64,-74},{-56,-66}})));
      Blocks.Logical4.Not4 not4_1
        annotation (Placement(transformation(extent={{-44,-74},{-36,-66}})));
      Blocks.Logical4.Probability reliability1(
        reset=reset,
        startTime=1,
        period=0.1,
        N=200,
        fileName="C:/Users/I51238/Documents/Dymola/probatest2.csv")
        annotation (Placement(transformation(extent={{20,-80},{40,-60}})));
      Blocks.Math.GreaterEqual4 greater4_2
        annotation (Placement(transformation(extent={{70,-70},{90,-50}})));
      Blocks.Math.Constant const4(k=0.5)
        annotation (Placement(transformation(extent={{56,-70},{64,-62}})));
      Requirements.EnsureWithProbability ensureWithProbability(
        fileName="C:/Users/I51238/Documents/Dymola/probatest3.csv",
        period=0.1,
        nb=200,
        reset=reset,
        redeclare model Condition = Blocks.Math.Less4)
        annotation (Placement(transformation(extent={{70,0},{90,20}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_4
        annotation (Placement(transformation(extent={{48,6},{56,14}})));
      Blocks.Math.Constant const5(k=0.5)
        annotation (Placement(transformation(extent={{46,-14},{54,-6}})));
    equation
      connect(const1.y, randomFailure.failureRate) annotation (Line(points={{-79,0},
              {-70,0},{-70,-10},{-61,-10}},color={0,0,0}));
      connect(const2.y, randomFailure.repairRate) annotation (Line(points={{-79,-30},
              {-70,-30},{-70,-18},{-61,-18}},
                                           color={0,0,0}));
      connect(booleanToBoolean4_2.y, during.u)
        annotation (Line(points={{54.4,90},{69,90}},  color={162,29,33}));
      connect(unreliability.y, less4_1.u1) annotation (Line(points={{11,40},{20,
              40},{20,50},{39,50}}, color={0,0,0}));
      connect(unreliability.range, less4_1.tolerance)
        annotation (Line(points={{11,32},{50,32},{50,39}}, color={0,0,0}));
      connect(booleanToBoolean4_1.y, unreliability.u)
        annotation (Line(points={{-23.6,40},{-11,40}}, color={162,29,33}));
      connect(const3.y, less4_1.u2)
        annotation (Line(points={{32.4,42},{39,42}}, color={0,0,0}));
      connect(during.y, ensure.tl)
        annotation (Line(points={{80,80},{80,60}}, color={0,0,255}));
      connect(less4_1.y, ensure.u)
        annotation (Line(points={{61,50},{69,50}}, color={162,29,33}));
      connect(randomFailure.y, heaviside.u)
        annotation (Line(points={{-39,-10},{-21,-10}}, color={217,67,180}));
      connect(heaviside.y, booleanToBoolean4_1.u) annotation (Line(points={{1,
              -10},{10,-10},{10,16},{-46,16},{-46,40},{-32.4,40}}, color={217,
              67,180}));
      connect(eventPeriodic.y, booleanToBoolean4_2.u)
        annotation (Line(points={{21,90},{45.6,90}}, color={217,67,180}));
      connect(booleanToBoolean4_3.y, not4_1.u)
        annotation (Line(points={{-55.6,-70},{-44.4,-70}}, color={162,29,33}));
      connect(not4_1.y, ensure1.u)
        annotation (Line(points={{-35.6,-70},{-21,-70}}, color={162,29,33}));
      connect(ensure1.y, reliability1.u)
        annotation (Line(points={{1,-70},{19,-70}}, color={162,29,33}));
      connect(during.y, ensure1.tl) annotation (Line(points={{80,80},{80,70},{
              100,70},{100,-48},{-10,-48},{-10,-60}}, color={0,0,255}));
      connect(heaviside.y, booleanToBoolean4_3.u) annotation (Line(points={{1,
              -10},{10,-10},{10,-40},{-74,-40},{-74,-70},{-64.4,-70}}, color={
              217,67,180}));
      connect(const4.y, greater4_2.u2) annotation (Line(points={{64.4,-66},{68,
              -66},{68,-68},{69,-68}}, color={0,0,0}));
      connect(reliability1.y, greater4_2.u1) annotation (Line(points={{41,-70},
              {52,-70},{52,-60},{69,-60}}, color={0,0,0}));
      connect(reliability1.range, greater4_2.tolerance)
        annotation (Line(points={{41,-78},{80,-78},{80,-71}}, color={0,0,0}));
      connect(during.y, ensureWithProbability.tl) annotation (Line(points={{80,
              80},{80,70},{100,70},{100,30},{80,30},{80,20}}, color={0,0,255}));
      connect(heaviside.y, booleanToBoolean4_4.u) annotation (Line(points={{1,
              -10},{40,-10},{40,10},{47.6,10}}, color={217,67,180}));
      connect(booleanToBoolean4_4.y, ensureWithProbability.u)
        annotation (Line(points={{56.4,10},{69,10}}, color={162,29,33}));
      connect(const5.y, ensureWithProbability.threshold) annotation (Line(
            points={{54.4,-10},{60,-10},{60,2},{69,2}}, color={0,0,0}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            Ellipse(lineColor = {75,138,73},
                    fillColor={255,255,255},
                    fillPattern = FillPattern.Solid,
