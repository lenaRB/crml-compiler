...
<p><span style=\"font-family: MS Shell Dlg 2;\">The <a href=\"modelica://CRML.TimeLocators.Continuous.Master\">Master</a> block can be used to specify the same master period to all time periods of the same model.</span></p>
      ...
      public
        ...
        ETL.TimeLocators.Periods periods(
          durationSpecified=false,
          leftBoundaryIncluded=leftBoundaryIncluded,
          rightBoundaryIncluded=rightBoundaryIncluded)
          annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
...
<p><span style=\"font-family: MS Shell Dlg 2;\">The <a href=\"modelica://CRML.TimeLocators.Continuous.Master\">Master</a> block can be used to specify the same master period to all time periods of the same model.</span></p>
    ...
    package Attributes
      ...
      public
        ETL.Connectors.TimeLocatorInput[N] tl
          annotation (Placement(transformation(extent={{-10,90},{10,110}})));
        ETL.Connectors.BooleanOutput y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        ETL.TimeLocators.Attributes.PeriodStart[N] timePeriodStartingEvents
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Returns the opening events of the time period <b>tl</b>.</span></p>
      ...
      public
        ...
        Blocks.Logical.Or_n or_n
          annotation (Placement(transformation(extent={{40,-10},{60,10}})));
        ETL.TimeLocators.Attributes.PeriodEnd[N] timePeriodClosingEvents
          annotation (Placement(transformation(extent={{-4,-4},{4,4}})));
  ...
  package Requirements
    ...
    public
      ...
      ETL.Connectors.Boolean4Output y "Result of the comparison"
        annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      ETL.Requirements.CheckAnytime check
        annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
    equation
      connect(u, check.u)
        annotation (Line(points={{-110,0},{-11,0}}, color={162,29,33}));
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
    ...
    public
      ...
      ETL.Connectors.Boolean4Output y "Result of the comparison"
        annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      ETL.Requirements.CheckAtEnd check
        annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
    equation
      connect(u, check.u)
        annotation (Line(points={{-110,0},{-11,0}}, color={162,29,33}));
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
    ...
    public
      ...
      ETL.Connectors.Boolean4Output y "Result of the comparison"
        annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      ETL.Requirements.CheckInteger check(redeclare model Function =
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
    ...
    public
      ...
      ETL.Connectors.Boolean4Output y "Result of the comparison"
        annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      ETL.Requirements.CheckReal check(redeclare model Function =
...
<a href=\"modelica://Modelica.Blocks.Examples.BooleanNetwork1\">Modelica.Blocks.Examples.BooleanNetwork1</a>.
      ...
      public
        ...
        ETL.Connectors.BooleanOutput y
          ...
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        ETL.Connectors.BooleanOutput isUndecided( start=true, fixed=true)
      ...
      public
        ETL.Connectors.Boolean3Input u
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
...
<td><p><b>useAutomaticSeed=true</b>:</p><p>An automatic global seed is computed by using the ID of the process in which the simulation takes place and the current local time. As a result, the global seed is changed automatically for every new simulation, including parallelized simulation runs. This option can be used to perform Monte Carlo Simulations with minimal effort (just performing many simulation runs) where every simulation run uses a different noise.</p></td>
    ...
    package Logical3
      ...
      public
        ETL.Connectors.BooleanInput u
          annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
        ETL.Connectors.Boolean3Output y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      equation
      ...
      block And3 "And operator on two Boolean3: u1 or u2"
        ETL.Connectors.Boolean3Input u1 annotation (Placement(transformation(
                extent={{-120,70},{-100,90}}), iconTransformation(extent={{-120,
                  70},{-100,90}})));
        ETL.Connectors.Boolean3Input u2 annotation (Placement(transformation(
                extent={{-120,-90},{-100,-70}}), iconTransformation(extent={{-120,
                  -90},{-100,-70}})));
        ETL.Connectors.Boolean3Output y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      ...
      block Not3 "Not operator on a Boolean3: u"
        ETL.Connectors.Boolean3Input u annotation (Placement(transformation(extent={{-120,
      ...
      package TruthTables
        ...
        constant Boolean3 and3[3,3]=
        [ Boolean3.undecided, Boolean3.false3, Boolean3.undecided;
          Boolean3.false3, Boolean3.false3, Boolean3.false3;
          Boolean3.undecided, Boolean3.false3, Boolean3.true3];

        constant Boolean3 not3[3]=
        { Boolean3.undecided, Boolean3.true3, Boolean3.false3};
      ...
      annotation (Icon(graphics={
            ...
            Rectangle(
              ...
              extent={{-100.0,-100.0},{100.0,100.0}},
              radius=25.0),
            Line(points={{-60,-40},{-20,-40},{-20,0},{20,0},{20,40},{60,40},{60,
                  40},{60,40}},    color={127,127,0})}));
    end Logical3;
...
<p><b>Version 1.0</b> </p>
      ...
      public
        ETL.Connectors.Boolean4Input u "Random Boolean input"
              ...
              transformation(extent={{-120,-10},{-100,10}}), iconTransformation(
                extent={{-120,-10},{-100,10}})));
        ETL.Connectors.RealOutput y(start=0, fixed=true)
          "Estimate of the probability that input is true at the current time"
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        ETL.Connectors.RealOutput range(start=infRange, fixed=true)
          "Half-width uncertainty range of y"
          annotation (Placement(transformation(extent={{100,-90},{120,-70}})));
        ETL.Connectors.BooleanInput event annotation (Placement(transformation(extent=
                 {{-120,-90},{-100,-70}}), iconTransformation(extent={{-120,-90},{-100,
                  -70}})));
      algorithm
...
<p>Displays the time periods of a <span style=\"font-family: MS Shell Dlg 2;\"><a href=\"modelica://ETL.TimeLocators.DiscreteTimeLocator\">DiscreteTimeLocator</a> block in the form of clock ticks inside the time periods of the time locator.</span></p>
    ...
    package Requirements
      ...
      equation
        ...
        connect(not4_1.y, or4_1.u1) annotation (Line(points={{-29,30},{-20,30},
                {-20,28},{-11,28}}, color={162,29,33}));
        connect(boolean4Replicator.y, or4_1.u2) annotation (Line(points={{-69,0},
                {-20,0},{-20,12},{-11,12}}, color={162,29,33}));
        connect(boolean4Replicator.y, not4_1.u) annotation (Line(points={{-69,0},
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
      ...
      equation
        ...
        connect(condition.decisionEvent, booleanToBoolean3_1.u)
          annotation (Line(points={{11,8},{15.6,8}}, color={217,67,180}));
        connect(booleanToBoolean3_1.y, eval.a)
          annotation (Line(points={{24.4,8},{29,8}}, color={162,29,33}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
                fillColor={244,125,35},
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
      ...
      public
        Connectors.Boolean4Input u "Boolean4 condition" annotation (Placement(
              transformation(extent={{-120,-10},{-100,10}}), iconTransformation(
                extent={{-120,-10},{-100,10}})));
        Connectors.TimeLocatorInput[N] tl annotation (Placement(transformation(extent=
                 {{-10,90},{10,110}}), iconTransformation(extent={{-10,90},{10,110}})));
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
      ...
      public
        Connectors.Boolean4Input u "Boolean4 condition" annotation (Placement(
              transformation(extent={{-120,-10},{-100,10}}), iconTransformation(
                extent={{-120,-10},{-100,10}})));
        Connectors.TimeLocatorInput              tl annotation (Placement(
              transformation(extent={{-10,90},{10,110}}), iconTransformation(extent={{
                  -10,90},{10,110}})));
        CRML.ETL.Connectors.Boolean4Output y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        TimeLocators.Attributes.PeriodEnd       periodEnd
      ...
      equation
        connect(periodEnd.y, booleanToBoolean4.u)
      ...
      //           fillPattern=FillPattern.Solid,
      //           textString=boxName),
        connect(or4_n.u1, u) annotation (Line(points={{39,8},{-40,8},{-40,0},{-110,0}},
              color={162,29,33}));
        connect(periodEnd.tl, tl)
          annotation (Line(points={{0,-4},{0,100}}, color={0,0,255}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
                fillColor={162,29,33},
...
<p><span style=\"font-family: MS Shell Dlg 2;\">This block is demonstrated with the following <a href=\"modelica://ReqSysPro.Examples.TimeLocators.Continuous.After\">example</a>:</span></p>
      ...
      public
        Connectors.Boolean4Input u "Boolean4 condition" annotation (Placement(
              transformation(extent={{-120,-10},{-100,10}}), iconTransformation(
                extent={{-120,-10},{-100,10}})));
        Connectors.TimeLocatorInput tl annotation (Placement(transformation(extent={{-10,
                  90},{10,110}}), iconTransformation(extent={{-10,90},{10,110}})));
        CRML.ETL.Connectors.Boolean4Output y
          annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        CRML_test.ETL.EvaluateOver.IntegrateUndefined integrateUndefined
          annotation (Placement(transformation(extent={{40,-10},{60,10}})));
      ...
      //           textString=boxName),
        ...
        connect(event4ToEvent1.u, u) annotation (Line(points={{-44.4,-20},{-90,-20},{-90,
        ...
        connect(decideOver.tl,tl)  annotation (Line(points={{-70,10},{-70,80},{0,80},
                {0,100}}, color={0,0,255}));
        connect(integrateUndefined.tl,tl)  annotation (Line(points={{50,10},{50,80},{
        ...
        connect(integrateUndefined.y, y)
          annotation (Line(points={{61,0},{110,0}}, color={162,29,33}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                               Rectangle(
                extent={{-100,100},{100,-100}},
    ...
    package Blocks
      ...
      package Clocks
        ...
        public
          ...
          Connectors.ClockInput u
            annotation (Placement(transformation(extent={{-120,40},{-100,20}})));
          CRML.ETL.Connectors.IntegerOutput y
            annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        ...
        equation
          ...
          connect(clockToBoolean.y, eventCounter.u)
            annotation (Line(points={{4.4,0},{39,0}}, color={217,67,180}));
          connect(inside.u, u) annotation (Line(
              points={{-61,3},{-80,3},{-80,30},{-110,30}},
              color={175,175,175},
              pattern=LinePattern.Dot,
              thickness=0.5));
          connect(inside.tl, tl) annotation (Line(points={{-61,-3},{-80,-3},{-80,-30},{-110,
                  -30}}, color={0,0,255}));
          ...
          annotation (Icon(coordinateSystem(preserveAspectRatio=false),
                ...
                Ellipse(
                  ...
                  fillColor={0,140,72},
                  fillPattern=FillPattern.Solid),
                Line(points={{-86,-32},{-50,-32},{-50,12},{60,12},{60,-34},{88,
                      -34}},
                    color={28,108,200}),
                Ellipse(
                  extent={{4,88},{24,68}},
                ...
                Ellipse(
                  ...
                  fillPattern=FillPattern.Solid,
                  fillColor={255,255,255}),
                Line(points={{-86,-80},{-30,-80},{-30,-66},{12,-66},{12,-54},{
                      76,-54},{76,-54}}, color={244,125,35})}),          Diagram(
                coordinateSystem(preserveAspectRatio=false)));
        end CountInside;
        annotation (Icon(graphics={
              Rectangle(
      ...
      package Events
        ...
        model BecomesTrue "Events generated when a Boolean becomes true"
          Connectors.Boolean4Input              b1
            annotation (Placement(transformation(extent={{-120,10},{-100,-10}})));
          Connectors.ClockOutput y
            annotation (Placement(transformation(extent={{100,10},{120,-10}})));
        ...
        equation
          connect(clockEvent.y, y) annotation (Line(
              points={{6.6,0},{110,0}},
              color={175,175,175},
              pattern=LinePattern.Dot,
              thickness=0.5));
        ...
        equation
          connect(u, becomesTrue.b1) annotation (Line(points={{-110,50},{-80,50},{-80,0},
                  {-61,0}}, color={0,0,0}));
          connect(inside.u, becomesTrue.y) annotation (Line(
              ...
              pattern=LinePattern.Dot,
              thickness=0.5));
          connect(tl, inside.tl) annotation (Line(points={{-110,-50},{-80,-50},{-80,-40},
                  {-20,-40},{-20,-3},{-1,-3}}, color={0,0,0}));
          connect(inside.y, y) annotation (Line(
              points={{21,0},{110,0}},
              color={175,175,175},
              pattern=LinePattern.Dot,
              thickness=0.5));
        ...
        model BecomesFalseInside "Events generated when a Boolean becomes false inside a time period"
          ...
          CRML.ETL.Connectors.ClockOutput y
            annotation (Placement(transformation(extent={{100,10},{120,-10}})));
          Connectors.TimeLocatorInput P1
            annotation (Placement(transformation(extent={{-120,-60},{-100,-40}})));
        ...
        "'Boolean4' as output"                                                          annotation (
          Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
            graphics={Polygon(
              ...
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid)}));
      connector Boolean3Input = input CRML.ETL.Types.Boolean3 "'Boolean3' as input"
                                                                               annotation (
          Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,
                100}}), graphics={
                      Polygon(
  ...
  polygon vertices. The consecutive point of the last point is the first point*/
    ...
    package Tests
      ...
      equation
        ...
        connect(timePeriod.y, checkRequirement.tl) annotation (Line(points={{
                -10,0},{-10,-24},{70,-24},{70,-30}}, color={0,0,255}));
        connect(ensure.y, checkRequirement.u)
          annotation (Line(points={{1,-40},{59,-40}}, color={162,29,33}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      equation
        ...
        connect(eventPeriodic.y, showEvent.u) annotation (Line(points={{-59,-30},
                {-52,-30},{-52,-14},{-40.4,-14}}, color={217,67,180}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      equation
        ...
        connect(continuousTimeWhile.y, showDiscreteTimeWhile.tl) annotation (Line(
              ...
              color={0,0,255}));
        connect(const.y, timePeriod.continuousDuration) annotation (Line(points=
               {{-59,0},{-28,0},{-28,42},{-21,42}}, color={0,0,0}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      equation
        connect(start.y, showEventStart.u) annotation (Line(points={{-79,50},{
                -60,50},{-60,68},{-54.4,68}}, color={217,67,180}));
        connect(eventPeriodic1.y, showEvent.u) annotation (Line(points={{-79,0},
                {-70,0},{-70,-20},{-54.4,-20}}, color={217,67,180}));
        connect(finish.y, showEventFinish.u) annotation (Line(points={{-79,-50},
                {-54.4,-50}}, color={217,67,180}));
        connect(start.y, booleanToBoolean4_1.u)
          annotation (Line(points={{-79,50},{-24.4,50}}, color={217,67,180}));
        connect(booleanToBoolean4_1.y, timePeriod.u1)
          annotation (Line(points={{-15.6,50},{19,50}}, color={162,29,33}));
        connect(finish.y, booleanToBoolean4_2.u) annotation (Line(points={{-79,
                -50},{-60,-50},{-60,42},{-24.4,42}}, color={217,67,180}));
        connect(booleanToBoolean4_2.y, timePeriod.u2)
          annotation (Line(points={{-15.6,42},{19,42}}, color={162,29,33}));
        connect(timePeriod.y[1], eventCounter1.tl)
          annotation (Line(points={{30,40},{30,10}}, color={0,0,255}));
        connect(eventPeriodic1.y, booleanToBoolean4_3.u)
          annotation (Line(points={{-79,0},{-24.4,0}}, color={217,67,180}));
        connect(booleanToBoolean4_3.y, eventCounter1.u)
          annotation (Line(points={{-15.6,0},{19,0}}, color={162,29,33}));
        connect(booleanToBoolean4_3.y, checkInteger.u) annotation (Line(points=
                {{-15.6,0},{0,0},{0,-30},{59,-30}}, color={162,29,33}));
        connect(timePeriod.y, checkInteger.tl) annotation (Line(points={{30,40},
                {30,28},{70,28},{70,-20}}, color={0,0,255}));
        connect(integerConstant.y, checkInteger.threshold) annotation (Line(
              points={{21,-50},{40,-50},{40,-38},{59,-38}}, color={255,127,0}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      model CheckCount
        ...
        Requirements.CheckInteger ensure2(redeclare model Function =
              ETL.Requirements.Functions.MathInteger.EventCounter, redeclare
            model Condition =
              ETL.Requirements.Conditions.MathInteger.IntegerLowerEqual)
      ...
      model Master1
        ...
        CRML.TimeLocators.Continuous.During during
          annotation (Placement(transformation(extent={{60,-20},{80,0}})));
        CRML.Blocks.Logical.BooleanConstant booleanConstant
          annotation (Placement(transformation(extent={{-100,0},{-80,20}})));
        Modelica.Blocks.Logical.And and1
          annotation (Placement(transformation(extent={{-40,20},{-20,40}})));
      equation
        connect(booleanToBoolean4_7.y, master.u)
          annotation (Line(points={{24.4,90},{79,90}}, color={162,29,33}));
        connect(booleanToBoolean4_7.y, during.u) annotation (Line(points={{24.4,
                90},{40,90},{40,-10},{59,-10}}, color={162,29,33}));
        connect(booleanConstant.y, and1.u2) annotation (Line(points={{-79,10},{
                -60,10},{-60,22},{-42,22}}, color={217,67,180}));
        connect(booleanPulse.y, and1.u1) annotation (Line(points={{-79,90},{-60,
                90},{-60,30},{-42,30}}, color={217,67,180}));
        connect(and1.y, booleanToBoolean4_7.u) annotation (Line(points={{-19,30},
                {0,30},{0,90},{15.6,90}}, color={255,0,255}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      equation
        ...
        connect(booleanToBoolean4_4.y, checkAnytime.u)
          annotation (Line(points={{-25.6,-70},{59,-70}},color={162,29,33}));
        connect(booleanPulse1.y, booleanToBoolean4_4.u)
          annotation (Line(points={{-79,-70},{-34.4,-70}},color={217,67,180}));
        ...
        connect(booleanToBoolean4_4.y, check.u) annotation (Line(points={{-25.6,
                -70},{-10,-70},{-10,-50},{-1,-50}}, color={162,29,33}));
        connect(during.y, check.tl) annotation (Line(points={{70,-20},{70,-28},
                {10,-28},{10,-40}}, color={0,0,255}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      model TimePeriods
        ...
        CRML.ETL.Requirements.CheckAtEnd checkAtEnd
          annotation (Placement(transformation(extent={{40,20},{60,40}})));
        CRML.ETL.Requirements.CheckAnytime checkAnytime
        ...
        CRML.Blocks.Logical.BooleanPulse booleanPulse2(
          period=5,
          startTime=1,
          width=4)
          annotation (Placement(transformation(extent={{-80,50},{-60,70}})));
      ...
      equation
        connect(timePeriod.y, checkAtEnd.tl)
          annotation (Line(points={{50,60},{50,40}}, color={0,0,255}));
        connect(timePeriod.y, checkAnytime.tl) annotation (Line(points={{50,60},
                {50,50},{80,50},{80,0}}, color={0,0,255}));
        connect(booleanToBoolean4_4.y, checkAnytime.u) annotation (Line(points=
                {{4.4,10},{20,10},{20,-10},{69,-10}}, color={162,29,33}));
        connect(booleanToBoolean4_4.y, checkAtEnd.u) annotation (Line(points={{
                4.4,10},{20,10},{20,30},{39,30}}, color={162,29,33}));
        connect(booleanPulse1.y, booleanToBoolean4_4.u) annotation (Line(points={{-59,10},
                {-4.4,10}},                                              color=
                {217,67,180}));
        connect(timePeriod.y, checkInteger.tl) annotation (Line(points={{50,60},
                {50,50},{100,50},{100,-30},{80,-30},{80,-40}}, color={0,0,255}));
        connect(booleanToBoolean4_1.y, checkInteger.u)
          annotation (Line(points={{44.4,-50},{69,-50}}, color={162,29,33}));
        connect(integerConstant.y, checkInteger.threshold) annotation (Line(
              points={{-19,-70},{20,-70},{20,-58},{69,-58}}, color={255,127,0}));
        connect(booleanToBoolean4_2.y, timePeriod.u1)
        ...
        connect(not1.y, booleanToBoolean4_3.u)
          annotation (Line(points={{-15.6,62},{-4.4,62}}, color={255,0,255}));
        connect(eventPeriodic.y, showEvent.u) annotation (Line(points={{-59,-50},
                {-40,-50},{-40,-30},{-24.4,-30}}, color={217,67,180}));
        connect(eventPeriodic.y, booleanToBoolean4_1.u)
          annotation (Line(points={{-59,-50},{35.6,-50}}, color={217,67,180}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
      ...
      model Before
        ...
        CRML.Blocks.Events.Before after
          annotation (Placement(transformation(extent={{-10,20},{10,40}})));
        CRML.Blocks.Events.EventPeriodic eventPeriodic1(startTime=1)
          annotation (Placement(transformation(extent={{-100,-20},{-80,0}})));
        CRML.Blocks.Events.ShowEvent showEvent
          annotation (Placement(transformation(extent={{-54,-34},{-46,-26}})));
        CRML.Blocks.Events.Before before
          annotation (Placement(transformation(extent={{-10,-60},{10,-40}})));
        CRML.Blocks.Events.EventPeriodic finish(period=11, startTime=10)
          annotation (Placement(transformation(extent={{-100,-100},{-80,-80}})));
        CRML.Blocks.Events.ShowEvent showEventFinish
          annotation (Placement(transformation(extent={{-12,-94},{-4,-86}})));
        Modelica.Blocks.Logical.And and1
          annotation (Placement(transformation(extent={{26,-6},{34,2}})));
        CRML.Blocks.Events.ShowEvent showEventReset
          annotation (Placement(transformation(extent={{28,-74},{36,-66}})));
        CRML.Blocks.Events.EventFilter eventFilter
          annotation (Placement(transformation(extent={{40,-20},{60,0}})));
        CRML.Blocks.Events.ShowEvent showEventFilter
          annotation (Placement(transformation(extent={{76,-44},{84,-36}})));
        CRML.Blocks.Events.EventCounter eventCounter
          annotation (Placement(transformation(extent={{80,-20},{100,0}})));
        CRML.ETL.TimeLocators.Periods
                             timePeriod(leftBoundaryIncluded=true,
            rightBoundaryIncluded=false)
          annotation (Placement(transformation(extent={{40,70},{60,90}})));
        CRML.ETL.TimeLocators.Attributes.IsLeftBoundaryIncluded
          isLeftBoundaryIncluded
          annotation (Placement(transformation(extent={{-54,26},{-46,34}})));
        Modelica.Blocks.Logical.Not not1
          annotation (Placement(transformation(extent={{-34,26},{-26,34}})));
        CRML.Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_1
          annotation (Placement(transformation(extent={{6,76},{14,84}})));
        CRML.Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_2
          annotation (Placement(transformation(extent={{6,68},{14,76}})));
        CRML.ETL.TimeLocators.Attributes.IsRightBoundaryIncluded
          isRightBoundaryIncluded
          annotation (Placement(transformation(extent={{-54,-54},{-46,-46}})));
        Modelica.Blocks.Logical.Not not2
        ...
        CRML.ETL.TimeLocators.Attributes.PeriodEnd periodEnd
          annotation (Placement(transformation(extent={{-84,-62},{-76,-54}})));
      equation
        connect(start.y, showEventStart.u) annotation (Line(points={{-79,70},{
                -60,70},{-60,90},{-54.4,90}}, color={217,67,180}));
        connect(eventPeriodic1.y, showEvent.u) annotation (Line(points={{-79,
                -10},{-70,-10},{-70,-30},{-54.4,-30}}, color={217,67,180}));
        connect(eventPeriodic1.y, after.u2) annotation (Line(points={{-79,-10},
                {-20,-10},{-20,22},{-11,22}}, color={217,67,180}));
        connect(start.y, after.reset) annotation (Line(points={{-79,70},{-40,70},
                {-40,10},{0,10},{0,19}}, color={217,67,180}));
        connect(eventPeriodic1.y, before.u1) annotation (Line(points={{-79,-10},
                {-20,-10},{-20,-42},{-11,-42}}, color={217,67,180}));
        connect(finish.y, showEventFinish.u) annotation (Line(points={{-79,-90},
                {-12.4,-90}}, color={217,67,180}));
        connect(after.y, and1.u1) annotation (Line(points={{11,30},{20,30},{20,
                -2},{25.2,-2}}, color={217,67,180}));
        connect(before.y, and1.u2) annotation (Line(points={{11,-50},{20,-50},{
                20,-5.2},{25.2,-5.2}}, color={217,67,180}));
        connect(start.y, before.reset) annotation (Line(points={{-79,70},{-40,
                70},{-40,-70},{0,-70},{0,-61}}, color={217,67,180}));
        connect(start.y, showEventReset.u) annotation (Line(points={{-79,70},{
                -40,70},{-40,-70},{27.6,-70}}, color={217,67,180}));
        connect(and1.y, eventFilter.cond)
          annotation (Line(points={{34.4,-2},{39,-2}}, color={255,0,255}));
        connect(eventPeriodic1.y, eventFilter.u)
          annotation (Line(points={{-79,-10},{39,-10}}, color={217,67,180}));
        connect(eventFilter.y, showEventFilter.u) annotation (Line(points={{61,
                -10},{68,-10},{68,-40},{75.6,-40}}, color={217,67,180}));
        connect(eventFilter.y, eventCounter.u)
          annotation (Line(points={{61,-10},{79,-10}}, color={217,67,180}));
        connect(start.y, eventCounter.reset) annotation (Line(points={{-79,70},
                {-40,70},{-40,-80},{90,-80},{90,-21}}, color={217,67,180}));
        connect(timePeriod.y[1], isLeftBoundaryIncluded.tl) annotation (Line(
              points={{50,70},{50,50},{-50,50},{-50,34}}, color={0,0,255}));
        connect(start.y, booleanToBoolean4_1.u) annotation (Line(points={{-79,
                70},{-40,70},{-40,80},{5.6,80}}, color={217,67,180}));
        connect(booleanToBoolean4_1.y, timePeriod.u1)
          annotation (Line(points={{14.4,80},{39,80}}, color={162,29,33}));
        connect(finish.y, booleanToBoolean4_2.u) annotation (Line(points={{-79,
                -90},{-60,-90},{-60,60},{0,60},{0,72},{5.6,72}}, color={217,67,
                180}));
        connect(booleanToBoolean4_2.y, timePeriod.u2)
          annotation (Line(points={{14.4,72},{39,72}}, color={162,29,33}));
        connect(isLeftBoundaryIncluded.y, not1.u) annotation (Line(points={{
                -45.6,30},{-34.8,30}}, color={217,67,180}));
        connect(not1.y, after.strictlyBefore)
          annotation (Line(points={{-25.6,30},{-11,30}}, color={255,0,255}));
        connect(isRightBoundaryIncluded.y, not2.u) annotation (Line(points={{
                -45.6,-50},{-34.8,-50}}, color={217,67,180}));
        connect(not2.y, before.strictlyBefore)
          annotation (Line(points={{-25.6,-50},{-11,-50}}, color={255,0,255}));
        connect(timePeriod.y[1], isRightBoundaryIncluded.tl) annotation (Line(
              points={{50,70},{50,50},{-66,50},{-66,-40},{-50,-40},{-50,-46}},
              color={0,0,255}));
        connect(timePeriod.y[1], periodStart.tl) annotation (Line(points={{50,
                70},{50,50},{-80,50},{-80,42}}, color={0,0,255}));
        connect(periodStart.y, after.u1)
          annotation (Line(points={{-75.6,38},{-11,38}}, color={217,67,180}));
        connect(timePeriod.y[1], periodEnd.tl) annotation (Line(points={{50,70},
                {50,50},{-66,50},{-66,-40},{-80,-40},{-80,-54}}, color={0,0,255}));
        connect(periodEnd.y, before.u2) annotation (Line(points={{-75.6,-58},{
                -11,-58}}, color={217,67,180}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Ellipse(lineColor = {75,138,73},
                      fillColor={255,255,255},
                      fillPattern = FillPattern.Solid,
  ...
  package Tests
    ...
    model Probability1
      ...
      Blocks.Logical4.Probability unavailability(
        reset=reset,
        dirName="C:/Users/I51238/Documents/Dymola",
        fileName="probatest1.csv")                                  annotation (Placement(transformation(extent={{20,50},
                {40,70}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_1
      ...
      Blocks.Logical4.Probability unreliability(
        reset=reset,
        dirName="C:/Users/I51238/Documents/Dymola",
        fileName="probatest2.csv")                                  annotation (Placement(transformation(extent={{58,-30},{78,-10}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_3
        annotation (Placement(transformation(extent={{36,-24},{44,-16}})));
      Blocks.Events.EventPeriodic eventPeriodic(period=0.1)
    ...
    equation
      ...
      connect(randomFailure.y, heaviside.u) annotation (Line(points={{-39,-20},
              {-11,-20}},                  color={217,67,180}));
      connect(randomFailure.y, booleanToBoolean4_1.u) annotation (Line(points={{-39,-20},
              {-30,-20},{-30,60},{-24.4,60}},          color={217,67,180}));
      connect(booleanToBoolean4_3.y, unreliability.u)
        annotation (Line(points={{44.4,-20},{57,-20}}, color={162,29,33}));
      connect(heaviside.y, booleanToBoolean4_3.u) annotation (Line(points={{11,-20},
              {35.6,-20}},                        color={217,67,180}));
      connect(booleanToBoolean4_1.y, unavailability.u)
        annotation (Line(points={{-15.6,60},{19,60}}, color={162,29,33}));
      connect(eventPeriodic.y, unreliability.event) annotation (Line(points={{-39,-70},
              {40,-70},{40,-28},{57,-28}}, color={217,67,180}));
      connect(eventPeriodic.y, unavailability.event) annotation (Line(points={{-39,-70},
              {-20,-70},{-20,52},{19,52}}, color={217,67,180}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            Ellipse(lineColor = {75,138,73},
                    fillColor={255,255,255},
                    fillPattern = FillPattern.Solid,
    ...
    model Probability2
      ...
      Blocks.Logical.Heaviside heaviside
        annotation (Placement(transformation(extent={{-10,-30},{10,-10}})));
      Blocks.Logical4.Probability unavailability(reset=reset,
        fileName="probatest1.csv",
        dirName="C:/Users/I51238/Documents/Dymola")
      ...
      Blocks.Logical4.Probability unreliability(reset=reset,
        fileName="probatest2.csv",
        dirName="C:/Users/I51238/Documents/Dymola")
    ...
    model Probability3
      ...
      Blocks.Math.Constant const2(k=3)
        annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
      Blocks.Logical4.Probability probability(reset=reset,
        fileName="probatest1.csv",
        dirName="C:/Users/I51238/Documents/Dymola")
        annotation (Placement(transformation(extent={{160,20},{180,40}})));
      ETL.TimeLocators.Periods
                           timePeriod(rightBoundaryIncluded=false,
          durationSpecified=true)
        annotation (Placement(transformation(extent={{40,80},{60,100}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_2
        annotation (Placement(transformation(extent={{16,26},{24,34}})));
      Requirements.CheckCountLowerEqual checkCount(threshold=4)
        annotation (Placement(transformation(extent={{40,20},{60,40}})));
      Blocks.Math.Constant const(k=4)
        annotation (Placement(transformation(extent={{-10,72},{10,92}})));
      inner TimeLocators.Continuous.Master master
        annotation (Placement(transformation(extent={{140,138},{160,158}})));
      Blocks.Math.Greater4 greater4
        annotation (Placement(transformation(extent={{100,-60},{120,-40}})));
      Blocks.Math.Constant const3(k=0.99)
        annotation (Placement(transformation(extent={{28,-68},{48,-48}})));
      TimeLocators.Continuous.During during(rightBoundaryIncluded=false)
        annotation (Placement(transformation(extent={{100,140},{120,160}})));
      Blocks.Logical.BooleanPulse inOperation(
        width=40,
        period=50,
        startTime=2)
        annotation (Placement(transformation(extent={{-100,140},{-80,160}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_1
        annotation (Placement(transformation(extent={{-24,146},{-16,154}})));
      ...
      Requirements.CheckAtEnd checkAtEnd
      ...
      Modelica.Blocks.Logical.Edge edge1 annotation (Placement(transformation(
            ...
            origin={-30,40})));
      Modelica.Blocks.Logical.Not not1
        annotation (Placement(transformation(extent={{-34,106},{-26,114}})));
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_4
        annotation (Placement(transformation(extent={{116,-14},{124,-6}})));
      TimeLocators.Continuous.During during1
        annotation (Placement(transformation(extent={{140,-20},{160,0}})));
    equation
      connect(const1.y, randomFailure.failureRate) annotation (Line(points={{-99,30},
              {-90,30},{-90,20},{-81,20}}, color={0,0,0}));
      connect(const2.y, randomFailure.repairRate) annotation (Line(points={{-99,0},
              {-90,0},{-90,12},{-81,12}},  color={0,0,0}));
      connect(booleanToBoolean4_2.y, checkCount.u)
        annotation (Line(points={{24.4,30},{39,30}}, color={162,29,33}));
      connect(timePeriod.y, checkCount.tl)
        annotation (Line(points={{50,80},{50,40}}, color={0,0,255}));
      connect(booleanToBoolean4_2.y,timePeriod. u1) annotation (Line(points={{24.4,30},
              {30,30},{30,90},{39,90}},               color={162,29,33}));
      connect(const.y,timePeriod. continuousDuration) annotation (Line(points={{11,82},
              {39,82}},                                color={0,0,0}));
      connect(probability.y, greater4.u1) annotation (Line(points={{181,30},{
              190,30},{190,10},{60,10},{60,-50},{99,-50}}, color={0,0,0}));
      connect(const3.y, greater4.u2)
        annotation (Line(points={{49,-58},{99,-58}}, color={0,0,0}));
      connect(inOperation.y, booleanToBoolean4_1.u)
        annotation (Line(points={{-79,150},{-24.4,150}},
                                                     color={217,67,180}));
      connect(booleanToBoolean4_1.y, during.u)
        annotation (Line(points={{-15.6,150},{99,150}},
                                                     color={162,29,33}));
      connect(or1.y, booleanToBoolean4_2.u)
        annotation (Line(points={{6.6,30},{15.6,30}},   color={255,0,255}));
      connect(checkCount.y, ensure.u)
        annotation (Line(points={{61,30},{99,30}}, color={162,29,33}));
      connect(ensure.y, probability.u)
        annotation (Line(points={{121,30},{159,30}}, color={162,29,33}));
      connect(during.y, ensure.tl)
        annotation (Line(points={{110,140},{110,40}}, color={0,0,255}));
      connect(randomFailure.y, or1.u2) annotation (Line(points={{-59,20},{-20,
              20},{-20,25.2},{-7.2,25.2}},color={217,67,180}));
      connect(booleanToBoolean4_1.y, While.u) annotation (Line(points={{-15.6,
              150},{0,150},{0,130},{39,130}}, color={162,29,33}));
      connect(While.y, timePeriod.tl)
        annotation (Line(points={{50,120},{50,100}}, color={0,0,255}));
      connect(greater4.y, checkAtEnd.u)
        annotation (Line(points={{121,-50},{139,-50}}, color={162,29,33}));
      connect(edge1.y, or1.u1) annotation (Line(points={{-25.6,40},{-20,40},{
              -20,30},{-7.2,30}}, color={255,0,255}));
      connect(inOperation.y, edge1.u) annotation (Line(points={{-79,150},{-50,
              150},{-50,40},{-34.8,40}}, color={217,67,180}));
      connect(inOperation.y, not1.u) annotation (Line(points={{-79,150},{-50,
              150},{-50,110},{-34.8,110}}, color={217,67,180}));
      connect(inOperation.y, booleanToBoolean4_4.u) annotation (Line(points={{
              -79,150},{-50,150},{-50,-10},{115.6,-10}}, color={217,67,180}));
      connect(not1.y, probability.event) annotation (Line(points={{-25.6,110},{
              140,110},{140,22},{159,22}}, color={255,0,255}));
      connect(booleanToBoolean4_4.y, during1.u)
        annotation (Line(points={{124.4,-10},{139,-10}}, color={162,29,33}));
      connect(during1.y, checkAtEnd.tl)
        annotation (Line(points={{150,-20},{150,-40}}, color={0,0,255}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false, initialScale=
            ...
            Text(
              ...
              textString="1 month"),
            Text(
              extent={{-112,136},{-68,128}},
              lineColor={28,108,200},
              textString="10 months"),      Text(
              extent={{-34,-62},{134,-112}},
              lineColor={28,108,200},
              textString="While the system is in operation, 
there should not be more than 4 pump failures in a sliding time period of one month
 with a probability greater than 99 percent.")}),
    ...
    model Probability4
      ...
      Blocks.Math.Constant const1(k=0.3)
        annotation (Placement(transformation(extent={{-120,20},{-100,40}})));
      Blocks.Math.Constant const2(k=5.7)
        annotation (Placement(transformation(extent={{-120,-10},{-100,10}})));
      Blocks.Logical4.Probability probability(reset=reset,
        fileName="probatest1.csv",
        dirName="C:/Users/I51238/Documents/Dymola")
      ...
      Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4_2
        annotation (Placement(transformation(extent={{16,26},{24,34}})));
      Requirements.CheckDurationLowerEqual checkDuration(threshold=1)
        annotation (Placement(transformation(extent={{40,20},{60,40}})));
      Blocks.Math.Constant const(k=4)
        annotation (Placement(transformation(extent={{-10,72},{10,92}})));
      inner TimeLocators.Continuous.Master master
      ...
      Blocks.Math.Greater4 greater4
        annotation (Placement(transformation(extent={{100,-60},{120,-40}})));
      Blocks.Math.Constant const3(k=0.7)
        annotation (Placement(transformation(extent={{28,-68},{48,-48}})));
      TimeLocators.Continuous.During during(rightBoundaryIncluded=false)
        annotation (Placement(transformation(extent={{100,140},{120,160}})));
      Blocks.Logical.BooleanPulse inOperation(
    ...
    equation
      ...
      connect(const2.y, randomFailure.repairRate) annotation (Line(points={{-99,0},
              {-90,0},{-90,12},{-81,12}},  color={0,0,0}));
      connect(booleanToBoolean4_2.y, checkDuration.u)
        annotation (Line(points={{24.4,30},{39,30}},color={162,29,33}));
      connect(timePeriod.y, checkDuration.tl)
        annotation (Line(points={{50,80},{50,40}}, color={0,0,255}));
      connect(booleanToBoolean4_2.y,timePeriod. u1) annotation (Line(points={{24.4,30},
              {30,30},{30,90},{39,90}},               color={162,29,33}));
      connect(const.y,timePeriod. continuousDuration) annotation (Line(points={{11,82},
      ...
      connect(or1.y, booleanToBoolean4_2.u)
        annotation (Line(points={{6.6,30},{15.6,30}},   color={255,0,255}));
      connect(checkDuration.y, ensure.u)
        annotation (Line(points={{61,30},{99,30}}, color={162,29,33}));
      connect(ensure.y, probability.u)
        annotation (Line(points={{121,30},{159,30}}, color={162,29,33}));
      connect(during.y, ensure.tl)
 ...
 with a probability greater than 99 percent."),
  ...
  annotation (                         Icon(graphics={
        ...
        Rectangle(
          ...
          fillPattern=FillPattern.None,
          extent={{-100,-100},{100,100}},
          radius=25.0)}), uses(Modelica(version="4.0.0"), Complex(version="4.0.0")));
end CRML;
