...
<pre>returns z &gt; 0.5; (cf. graphics in diagram layer)</pre>
  ...
  package LTL "Linear Temporal Logic"
    package Blocks

      package Logical

        block Notc "Not operator on a Clock: new Clock (not u)"
          ETL.Connectors.ClockInput    u annotation(
            Placement(transformation(extent = {{-120, -10}, {-100, 10}})));
          ETL.Connectors.Boolean4Output y annotation(
            Placement(transformation(extent = {{100, -10}, {120, 10}})));
          ...
          CRML.Blocks.Logical4.BooleanToBoolean4 booleanToBoolean4
            annotation (Placement(transformation(extent={{20,-4},{28,4}})));
          CRML.Blocks.Logical4.Not4 not4
            annotation (Placement(transformation(extent={{40,-10},{60,10}})));
          CRML.Blocks.Logical.Hold hold1
            annotation (Placement(transformation(extent={{-14,-6},{-2,6}})));
        equation
          connect(not4.y, y)
            annotation (Line(points={{61,0},{110,0}}, color={162,29,33}));
          connect(not4.u, booleanToBoolean4.y)
            annotation (Line(points={{39,0},{28.4,0}}, color={162,29,33}));
          connect(u, clockToBoolean.u) annotation (Line(
              points={{-110,0},{-62,0}},
              color={175,175,175},
              pattern=LinePattern.Dot,
              thickness=0.5));
          connect(clockToBoolean.y, hold1.u)
            annotation (Line(points={{-38,0},{-15.2,0}}, color={217,67,180}));
          connect(booleanToBoolean4.u, hold1.y)
            annotation (Line(points={{19.6,0},{-1.4,0}}, color={217,67,180}));
          annotation(
            Icon(coordinateSystem(preserveAspectRatio = false), graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}, fillColor={0,140,72},        lineThickness = 5, fillPattern
                    = FillPattern.Solid,                                                                                                                                                                    borderPattern = BorderPattern.Raised, lineColor = {0, 0, 0}), Text(extent = {{-90, 40}, {90, -40}}, lineColor = {0, 0, 0}, textString = "not")}),
            Diagram(coordinateSystem(preserveAspectRatio = false)));
        end Notc;
      end Logical;
      ...
      annotation (Icon(graphics={
                  ...
                  -100},{100,100}},                                                                                                                                                                                                        radius = 25.0), Rectangle(origin={0,
                  35.1488},                                                                                                                                                                                                        fillColor = {255, 255, 255}, extent = {{-30.0, -20.1488}, {30.0, 20.1488}}), Rectangle(origin={0,
                  -34.851},                                                                                                                                                                                                        fillColor = {255, 255, 255}, extent = {{-30.0, -20.1488}, {30.0, 20.1488}}), Line(origin={-51.25,0},    points = {{21.25, -35.0}, {-13.75, -35.0}, {-13.75, 35.0}, {6.25, 35.0}}), Polygon(origin={-40,35},    pattern = LinePattern.None, fillPattern = FillPattern.Solid, points = {{10.0, 0.0}, {-5.0, 5.0}, {-5.0, -5.0}}), Line(origin={51.25,0},    points = {{-21.25, 35.0}, {13.75, 35.0}, {13.75, -35.0}, {-6.25, -35.0}}), Polygon(origin={40,-35},    pattern = LinePattern.None, fillPattern = FillPattern.Solid, points = {{-10.0, 0.0}, {5.0, 5.0}, {5.0, -5.0}})}));
    end Blocks;
    ...
    package Tests
      ...
      model Notc
        import CRML;
        CRML.Blocks.Logical.BooleanPulse booleanPulse(startTime=5)
          annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
        CRML.Blocks.Events.ClockEvent          clockEvent1         annotation(
          Placement(transformation(extent={{-34,-4},{-26,4}})));
        CRML.LTL.Blocks.Logical.Notc notc
          annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
      equation
        connect(booleanPulse.y, clockEvent1.u)
          annotation (Line(points={{-59,0},{-34.4,0}}, color={217,67,180}));
        connect(clockEvent1.y, notc.u) annotation (Line(
            points={{-25.6,0},{-11,0}},
            color={175,175,175},
            pattern=LinePattern.Dot,
            thickness=0.5));
