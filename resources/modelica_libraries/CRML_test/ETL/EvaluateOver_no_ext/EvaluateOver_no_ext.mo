...
equation
  ...
  connect(booleanToBoolean3_1.y,eval. a) annotation (Line(points={{220.4,20},{236,
          20},{236,8},{241,8}},   color={162,29,33}));
  connect(P1, eval.tl) annotation (Line(points={{90,-70},{166,-70},{166,40},{252,
          40},{252,10}}, color={0,0,255}));
  ...
  connect(eval[1].y, b_evaluate_over)
    annotation (Line(points={{263,0},{326,0}}, color={162,29,33}));
