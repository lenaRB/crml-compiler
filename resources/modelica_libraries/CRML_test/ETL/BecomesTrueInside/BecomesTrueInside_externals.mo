...
public
  ...
  CRML.Blocks.Logical.BooleanTable booleanTable1(
    y0=false,
    option_width=false,
    instant={2.5,5,7.5,9})
...
equation
  ...
  connect(booleanTable1.y, showEvent_b1.u) annotation (Line(points={{-39,-20},{
          -12,-20},{-12,-10},{15.6,-10}}, color={217,67,180}));
  connect(booleanTable1.y, booleanToBoolean4_3.u) annotation (Line(points={{-39,
  ...
  connect(cRMLPeriodTimePeriod.y, P1)
    annotation (Line(points={{61,-70},{110,-70}}, color={255,170,255}));
