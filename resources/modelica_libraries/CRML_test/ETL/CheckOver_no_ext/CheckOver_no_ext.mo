...
public
  ...
  CRML.ETL.Requirements.CheckOver checkOver
...
equation
  ...
  connect(checkOver.y, b_check_over)
    annotation (Line(points={{201,0},{326,0}}, color={162,29,33}));
  connect(during.y, checkOver.tl) annotation (Line(points={{50,-60},{50,-78},{
          140,-78},{140,38},{190,38},{190,10}}, color={0,0,255}));
  connect(and4_1.y, checkOver.u) annotation (Line(points={{21,42},{62,42},{62,
          40},{100,40},{100,0},{179,0}}, color={162,29,33}));
