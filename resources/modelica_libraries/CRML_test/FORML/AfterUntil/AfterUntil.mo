...
public
  CRML.ETL.Connectors.ClockInput ck2 "Boolean4 condition" annotation(
    Placement(transformation(extent = {{-120, -50}, {-100, -30}}), iconTransformation(extent={{-120,
            -50},{-100,-30}})));
  CRML.ETL.TimeLocators.Periods periods(leftBoundaryIncluded = false,
      rightBoundaryIncluded=true)                                                                    annotation(
...
equation
  ...
  connect(ck2, clockToBoolean_ck2.u) annotation(
    Line(points = {{-110, -40}, {-82, -40}}, color = {175, 175, 175}, pattern = LinePattern.Dot, thickness = 0.5));
  ...
  connect(periods.y, p_after_b1_until_b2) annotation (Line(points={{0,-10},{0,-20},
