...
public
  ...
  CRML.ETL.TimeLocators.Periods periods(leftBoundaryIncluded=true,
...
equation
  ...
  connect(periods.y, p_from_b1_until_b2) annotation (Line(points={{0,-10},{0,-20},
