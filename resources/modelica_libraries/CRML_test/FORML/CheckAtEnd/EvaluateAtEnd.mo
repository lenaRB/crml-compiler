...
public
  CRML.ETL.Connectors.Boolean4Input u "Boolean4 condition" annotation (
      Placement(transformation(extent={{-120,-10},{-100,10}}),
        iconTransformation(extent={{-120,-10},{-100,10}})));
  CRML.ETL.Connectors.TimeLocatorInput tl annotation (Placement(transformation(
  ...
  CRML.Blocks.Logical4.Boolean4Constant boolean4Constant1
...
//           textString=boxName),
  ...
  connect(boolean4Constant1.y, decideOver.u) annotation (Line(points={{-79,50},
          {-74,50},{-74,14},{-88,14},{-88,0},{-81,0}}, color={162,29,33}));
