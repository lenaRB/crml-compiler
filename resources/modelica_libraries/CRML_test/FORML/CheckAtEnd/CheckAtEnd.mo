...
public
  ...
  CRML.ETL.Connectors.TimeLocatorInput[N] tl annotation (Placement(
...
//           textString=boxName),
  connect(evaluateAtEnd.tl, tl)
    annotation (Line(points={{0,10},{0,100}}, color={0,0,255}));
  connect(evaluateAtEnd.u, boolean4Replicator.y)
    annotation (Line(points={{-11,0},{-39,0}}, color={162,29,33}));
  connect(evaluateAtEnd.y, and4.u)
    annotation (Line(points={{11,0},{39,0}}, color={162,29,33}));
