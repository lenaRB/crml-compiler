...
public
  ...
  FromBefore.FromBefore   fromBefore
...
equation
  ...
  connect(clockEvent_2.y, fromBefore.ck2) annotation (Line(
      points={{-13.4,-50},{34,-50},{34,-4},{39,-4}},
      color={175,175,175},
      pattern=LinePattern.Dot,
      thickness=0.5));
  connect(clockEvent_1.y, fromBefore.ck1) annotation (Line(
      points={{-13.4,30},{34,30},{34,4},{39,4}},
      color={175,175,175},
      pattern=LinePattern.Dot,
      thickness=0.5));
  connect(fromBefore.p_from_b1_before_b2, p_from_b1_before_b2)
    annotation (Line(points={{61,0},{102,0}}, color={0,0,255}));
end FromBefore_no_ext;
