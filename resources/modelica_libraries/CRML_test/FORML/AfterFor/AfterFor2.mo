...
public
  CRML.ETL.Connectors.RealInput d1 "Boolean4 condition" annotation (Placement(
...
equation
  ...
  connect(afterFor.y, p_after_b1_for_d1) annotation (Line(points={{0,-10},{0,-20},
          {80,-20},{80,0},{110,0}}, color={0,0,255}));
  connect(tl1, afterFor.tl)
    annotation (Line(points={{0,100},{0,10}}, color={0,0,255}));
  connect(booleanToBoolean4_ck1.y, afterFor.u) annotation (Line(points={{-35.6,
          40},{-16,40},{-16,0},{-11,0}}, color={162,29,33}));
  connect(d1, afterFor.duration) annotation (Line(points={{-110,-40},{-16,-40},
          {-16,-8},{-11,-8}}, color={0,0,0}));
