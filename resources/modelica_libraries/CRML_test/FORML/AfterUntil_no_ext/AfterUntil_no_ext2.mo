...
public
  ...
  AfterUntil.AfterUntill2 afterUntill2_1
...
equation
  ...
  connect(clockEvent_1.y, afterUntill2_1.ck1) annotation (Line(
      points={{-13.4,30},{34,30},{34,4},{39,4}},
      color={175,175,175},
      pattern=LinePattern.Dot,
      thickness=0.5));
  connect(clockEvent_2.y, afterUntill2_1.ck2) annotation (Line(
      points={{-13.4,-50},{34,-50},{34,-4},{39,-4}},
      color={175,175,175},
      pattern=LinePattern.Dot,
      thickness=0.5));
  connect(afterUntill2_1.p_after_b1_until_b2, p_after_b1_until_b2)
    annotation (Line(points={{61,0},{102,0}}, color={0,0,255}));
end AfterUntil_no_ext2;
